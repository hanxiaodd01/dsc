...
if ($_REQUEST['act'] == 'list') {
    ...
    $smarty->assign('action_link',
        array('text' => $_LANG['01_shipping_add'], 'href' => 'warehouse.php?act=freight&id=' . $regionId));
    assign_query_info();
    ...
    if ($_REQUEST['act'] == 'query') {
        ...
        make_json_result($smarty->fetch('warehouse_shipping_mode_list.dwt'), '',
        ...
        if ($_REQUEST['act'] == 'freight') {
            ...
            $smarty->assign('action_link',
                array('href' => 'warehouse.php?act=ship_list', 'text' => $_LANG['back_distribution_list']));
            ...
            if ($_REQUEST['act'] == 'update') {
                ...
                $link[] = array(
                    'text' => $_LANG['go_back'],
                    'href' => 'warehouse_shipping_mode.php?act=freight&id=' . $id
                );
