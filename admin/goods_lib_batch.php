                            ...
                            if (!empty($field_value)) {
                                if (in_array($field, array('original_img', 'goods_img', 'goods_thumb'))) {
                                    if (0 < strpos($field_value, '|;')) {
                                        ...
                                        @copy(ROOT_PATH . 'images/' . $field_value . '.tbi',
                                            ROOT_PATH . 'images/' . $field_value . '.jpg');
                                    ...
                                    if ($field == 'brand_name') {
                                        ...
                                        if (in_array($field, array('goods_weight', 'market_price', 'shop_price'))) {
                                            ...
                                            if (in_array($field, array('is_on_sale', 'is_real'))) {
