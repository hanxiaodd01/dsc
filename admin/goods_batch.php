                                ...
                                if (!empty($goods['original_img']) || !empty($goods['goods_img']) || !empty($goods['goods_thumb'])) {
                                    ...
                                    if (!empty($goods['original_img'])) {
                                        if ($_CFG['auto_generate_gallery']) {
                                            ...
                                            $goods_gallery['img_original'] = reformat_image_name('gallery',
                                                $goods_gallery['goods_id'], $img, 'source');
                                        }

                                        if ($_CFG['retain_original_img']) {
                                            $original_img = reformat_image_name('goods', $goods_gallery['goods_id'],
                                                $goods['original_img'], 'source');
                                        } else {
                                    ...
                                    if (!empty($goods['goods_img'])) {
                                        if ($_CFG['auto_generate_gallery'] && !empty($gallery_img)) {
                                            $goods_gallery['img_url'] = reformat_image_name('gallery',
                                                $goods_gallery['goods_id'], $gallery_img, 'goods');
                                        }

                                        $goods_img = reformat_image_name('goods', $goods_gallery['goods_id'],
                                            $goods['goods_img'], 'goods');
                                    }
                                    ...
                                    if (!empty($goods['goods_thumb'])) {
                                        if ($_CFG['auto_generate_gallery']) {
                                            ...
                                            $goods_gallery['thumb_url'] = reformat_image_name('gallery_thumb',
                                                $goods_gallery['goods_id'], $gallery_thumb, 'thumb');
                                        }

                                        $goods_thumb = reformat_image_name('goods_thumb', $goods_gallery['goods_id'],
