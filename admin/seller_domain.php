...
if ($_REQUEST['act'] == 'list') {
    ...
    if ($_REQUEST['act'] == 'query') {
        ...
        $smarty->assign('record_count', $domain_list['record_count']);
        $smarty->assign('page_count', $domain_list['page_count']);
        make_json_result($smarty->fetch('seller_domain.dwt'), '',
            array('filter' => $domain_list['filter'], 'page_count' => $domain_list['page_count']));
    } else {
        if ($_REQUEST['act'] == 'edit') {
            admin_priv('seller_dimain');
            $smarty->assign('ur_here', $_LANG['seller_domain_edit']);
            $smarty->assign('action_link',
                array('text' => $_LANG['seller_domain'], 'href' => 'seller_domain.php?act=list'));
