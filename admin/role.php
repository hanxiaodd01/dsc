        ...
        if ($_REQUEST['act'] == 'query') {
            ...
            if ($_REQUEST['act'] == 'add') {
                ...
                $smarty->assign('action_link',
                    array('href' => 'role.php?act=list', 'text' => $_LANG['admin_list_role']));
                ...
                if ($_REQUEST['act'] == 'insert') {
                    ...
                    if ($_REQUEST['act'] == 'edit') {
                        ...
                        if ($_REQUEST['act'] == 'update') {
                            ...
                            sys_msg($_LANG['edit'] . '&nbsp;' . $_POST['user_name'] . '&nbsp;' . $_LANG['action_succeed'],
                                0, $link);
                        } else {
                            if ($_REQUEST['act'] == 'remove') {
                                ...
                                if (0 < $remove_num) {
                                    ...
                                    $exc->drop($id);
                                    $url = 'role.php?act=query&' . str_replace('act=remove', '',
