...
if ($_REQUEST['act'] == 'list') {
    ...
    $smarty->assign('action_link2',
        array('text' => $_LANG['add_entry_criteria'], 'href' => 'entry_criteria.php?act=add'));
    ...
    if ($_REQUEST['act'] == 'query') {
        ...
        if ($_REQUEST['act'] == 'add' || $_REQUEST['act'] == 'edit') {
            ...
            $smarty->assign('action_link',
                array('text' => $_LANG['entry_criteria_list'], 'href' => 'entry_criteria.php?act=list'));
            ...
            if ($_REQUEST['act'] == 'insert' || $_REQUEST['act'] == 'update') {
                ...
                $option_value = !empty($_REQUEST['option_value']) ? implode(',',
                    array_unique($_REQUEST['option_value'])) : '';
