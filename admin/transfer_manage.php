                ...
                if ($_REQUEST['act'] == 'is_ajax') {
                    ...
                    if (isset($_GET['start'])) {
                        ...
                        if ($result['page'] <= ceil($count / $result['page_size'])) {
                            ...
                            if ($data_cat == 6) {
                                supplier_batch($table, $result['page'], $result['page_size'], $result['silent'],
                                    $s_db_retain);
                            } else {
                                process_batch($table, $result['page'], $result['page_size'], $result['silent'],
                                    $s_db_retain);
                            }
