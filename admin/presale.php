...
if ($_REQUEST['act'] == 'list') {
    ...
    if ($adminru['ru_id'] == 0) {
        $smarty->assign('presale_cat_link',
            array('href' => 'presale_cat.php?act=list', 'text' => $_LANG['presale_cat_list']));
    }
                            ...
                            if (isset($_POST['mail'])) {
                                ...
                                while ($order = $db->fetchRow($res)) {
                                    ...
                                    $smarty->assign('shop_url',
                                        $ecs->url() . 'user.php?act=order_detail&order_id=' . $order['order_id']);
                        ...
                        if ($_POST['type'] == 'batch_remove') {
                            ...
                            if ($_POST['type'] == 'review_to') {
                                ...
                                if ($db->query($sql)) {
                                    $lnk[] = array(
                                        'text' => $_LANG['back_list'],
                                        'href' => 'presale.php?act=list&seller_list=1&' . list_link_postfix()
                                    );
