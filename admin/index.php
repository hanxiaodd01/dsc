...
function get_menu_list($menus, $ru_id = 0)
{
    ...
    foreach ($menus as $key => $row) {
        ...
        if ($row['label'] == $GLOBALS['_LANG']['02_cat_and_goods']) {
            ...
            if ($row['label'] == $GLOBALS['_LANG']['03_goods_storage']) {
                $arr[$key]['href'] = 'goods_inventory_logs.php?act=list&step=put';
            } else {
                if ($row['label'] == $GLOBALS['_LANG']['05_banner']) {
                    if (0 < $ru_id) {
                    ...
                    if ($row['label'] == $GLOBALS['_LANG']['04_order']) {
                        $number = get_order_count($ru_id);
                        $arr[$key]['number'] = $number;
                        $arr[$key]['href'] = 'order.php?act=list';
                    } else {
                        if ($row['label'] == $GLOBALS['_LANG']['20_suppliers_promotion']) {
                            $arr[$key]['href'] = 'bonus.php?act=list';
                        } else {
                            if ($row['label'] == $GLOBALS['_LANG']['report_form_stats']) {
                                $arr[$key]['href'] = 'order_stats.php?act=list';
                            } else {
                                if ($row['label'] == $GLOBALS['_LANG']['07_content']) {
                                    $arr[$key]['href'] = 'articlecat.php?act=list';
                                } else {
                                    if ($row['label'] == $GLOBALS['_LANG']['user_manage']) {
                                        $arr[$key]['href'] = 'users.php?act=list';
                                    } else {
                                        if ($row['label'] == $GLOBALS['_LANG']['10_priv_admin']) {
                                            $arr[$key]['href'] = 'privilege.php?act=list';
                                        } else {
                                            if ($row['label'] == $GLOBALS['_LANG']['11_system']) {
                                                if (0 < $ru_id) {
                                                ...
                                                if ($row['label'] == $GLOBALS['_LANG']['03_template']) {
                                                    $arr[$key]['href'] = 'template.php?act=list';
                                                } else {
                                                    if ($row['label'] == $GLOBALS['_LANG']['13_backup']) {
                                                        $arr[$key]['href'] = 'sql.php?act=main';
                                                    } else {
                                                        if ($row['label'] == $GLOBALS['_LANG']['14_sms']) {
                                                            $arr[$key]['href'] = 'sms.php?act=display_send_ui';
                                                        } else {
                                                            if ($row['label'] == $GLOBALS['_LANG']['15_rec']) {
                                                                $arr[$key]['href'] = 'affiliate.php?act=list';
                                                            } else {
                                                                if ($row['label'] == $GLOBALS['_LANG']['16_email_manage']) {
                                                                    $arr[$key]['href'] = 'view_sendlist.php?act=list';
                                                                } else {
                                                                    if ($row['label'] == $GLOBALS['_LANG']['seller_apply_manage']) {
                                                                        if (0 < $ru_id) {
                                                                        ...
                                                                        if ($row['label'] == $GLOBALS['_LANG']['goods_batch_manage']) {
                                                                            $arr[$key]['href'] = 'goods_warehouse_batch.php?act=add';
                                                                        } else {
                                                                            if ($row['label'] == $GLOBALS['_LANG']['store_set_manage']) {
        ...
        if ($_REQUEST['act'] == 'calculator') {
            ...
            if ($_REQUEST['act'] == 'menu') {
                ...
                if ($_REQUEST['act'] == 'clear_cache') {
                    ...
                    if ($_REQUEST['act'] == 'set_clear_cache') {
                                ...
                                foreach ($action_code as $k => $v) {
                                    ...
                                    if ($v == 'other') {
                                        $arr = array(
                                            ...
                                            'art_cat_pid_releate',
                                            'index_goods_cat',
                                            'index_goods_cat_cache',
                                            'floor_cat_conten'
                                        );
                                        $dirName = ROOT_PATH . 'temp/static_caches';
                                        set_clear_cache($dirName, $arr, 1);
                                        $beginYesterday = local_mktime(0, 0, 0, local_date('m'), local_date('d') - 1,
                                            local_date('Y'));
                        ...
                        if ($_REQUEST['act'] == 'set_statistical_chart') {
                            ...
                            $date_end = local_mktime(0, 0, 0, local_date('m'), local_date('d') + 1,
                                    local_date('Y')) - 1;
...
');
                                ...
                                if (!empty($open_basedir)) {
                                    ...
                                    if (empty($upload_tmp_dir)) {
                                        if (stristr(PHP_OS, 'win')) {
                                            ...
                                            $upload_tmp_dir = str_replace(array('\\', '\\\\'), array('/', '/'),
                                                $upload_tmp_dir);
                                        } else {
                                ...
                                if ($result < 2) {
                                    ...
                                    if ($result < 2) {
                                        $warning[] = sprintf($_LANG['not_writable'], DATA_DIR . '/afficheimg',
                                            $_LANG['afficheimg_cannt_write']);
                                    }

                                    $result = file_mode_info('../' . DATA_DIR . '/brandlogo');

                                    if ($result < 2) {
                                        $warning[] = sprintf($_LANG['not_writable'], DATA_DIR . '/brandlogo',
                                            $_LANG['brandlogo_cannt_write']);
                                    }

                                    $result = file_mode_info('../' . DATA_DIR . '/cardimg');

                                    if ($result < 2) {
                                        $warning[] = sprintf($_LANG['not_writable'], DATA_DIR . '/cardimg',
                                            $_LANG['cardimg_cannt_write']);
                                    }

                                    $result = file_mode_info('../' . DATA_DIR . '/feedbackimg');

                                    if ($result < 2) {
                                        $warning[] = sprintf($_LANG['not_writable'], DATA_DIR . '/feedbackimg',
                                            $_LANG['feedbackimg_cannt_write']);
                                    }

                                    $result = file_mode_info('../' . DATA_DIR . '/packimg');

                                    if ($result < 2) {
                                        $warning[] = sprintf($_LANG['not_writable'], DATA_DIR . '/packimg',
                                            $_LANG['packimg_cannt_write']);
                                    }
                                }
                                ...
                                if ($result < 2) {
                                    $warning[] = sprintf($_LANG['not_writable'], 'images',
                                        $_LANG['images_cannt_write']);
                                } else {
                                    $result = file_mode_info('../' . IMAGE_DIR . '/upload');

                                    if ($result < 2) {
                                        $warning[] = sprintf($_LANG['not_writable'], IMAGE_DIR . '/upload',
                                            $_LANG['imagesupload_cannt_write']);
                                    }
                                }
                                ...
                                $today_end = local_mktime(0, 0, 0, local_date('m'), local_date('d') + 1,
                                        local_date('Y')) - 1;
                                $month_start = local_mktime(0, 0, 0, local_date('m'), 1, local_date('Y'));
                                $month_end = local_mktime(23, 59, 59, local_date('m'), local_date('t'),
                                    local_date('Y'));
                                $today = array();
                                $where_date = '';
                                $where_og = '';
                                ...
                                $sql = 'SELECT  SUM(oi.money_paid) AS sales FROM ' . $ecs->table('order_info') . ' AS oi' . ' WHERE oi.add_time BETWEEN ' . $today_start . ' AND ' . $today_end . '  AND oi.supplier_id = 0  ' . order_query_sql('queren',
                                        'oi.') . $where_date . $where_og;
                                $today['money_paid_money'] = $db->GetOne($sql);
                                $sql = 'SELECT  SUM(surplus) AS sales FROM ' . $ecs->table('order_info') . ' AS oi' . ' WHERE oi.add_time BETWEEN ' . $today_start . ' AND ' . $today_end . '  AND oi.supplier_id=0 ' . order_query_sql('queren',
                                        'oi.') . $where_date . $where_og;
                                ...
                                $today = local_getdate();
                                $today_visit_where = ' access_time > ' . (mktime(0, 0, 0, $today['mon'], $today['mday'],
                                            $today['year']) - date('Z'));
                                ...
                                $smarty->assign('user_number',
                                    $db->getOne('SELECT COUNT(*) FROM ' . $ecs->table('users')));
                                $smarty->assign('seller_num',
                                    $db->getOne('SELECT COUNT(*) FROM ' . $ecs->table('merchants_shop_information') . ' WHERE merchants_audit = 1'));
                                ...
                                $smarty->assign('install_date',
                                    local_date($_CFG['date_format'], $_CFG['install_date']));
                                $smarty->display('start.dwt');
                            } else {
                                if ($_REQUEST['act'] == 'shop_top') {
                                    $smarty->assign('menu_select',
                                        array('action' => '19_merchants_store', 'current' => '03_merchants_shop_top'));
                                    ...
                                    if (0 < $seller_shop_info['id']) {
                                        ...
                                        $lnk[] = array(
                                            'text' => $_LANG['set_store_info'],
                                            'href' => 'index.php?act=first'
                                        );
                                    ...
                                    if ($_REQUEST['act'] == 'shop_top_edit') {
                                        $preg = '/<script[\\s\\S]*?<\\/script>/i';
                                        $shop_header = !empty($_REQUEST['shop_header']) ? preg_replace($preg, '',
                                            stripslashes($_REQUEST['shop_header'])) : '';
                                        $seller_theme = !empty($_REQUEST['seller_theme']) ? preg_replace($preg, '',
                                            stripslashes($_REQUEST['seller_theme'])) : '';
                                        ...
                                        $db->query($sql);
                                        $lnk[] = array(
                                            'text' => $_LANG['return_to_superior'],
                                            'href' => 'index.php?act=shop_top'
                                        );
                                        ...
                                        if ($_REQUEST['act'] == 'main_api') {
                                            ...
                                            if ($data === false || API_TIME < date('Y-m-d H:i:s', time() - 43200)) {
                                                ...
                                                write_static_file_cache('config',
                                                    str_replace('\'API_TIME\', \'' . API_TIME . '\'',
                                                        '\'API_TIME\', \'' . date('Y-m-d H:i:s', time()) . '\'',
                                                        file_get_contents($f)), 'php', ROOT_PATH . 'data/');
                                                        ...
                                                        if (!empty($good_category)) {
                                                            ...
                                                            if (!empty($good_name)) {
                                                                if (isset($_FILES['goods_img']['error'])) {
                                                                    ...
                                                                    if ($_FILES['goods_img']['error'] == 0) {
                                                                        if (!$image->check_img_type($_FILES['goods_img']['type'])) {
                                                                            sys_msg($_LANG['invalid_goods_img'], 1,
                                                                                array(), false);
                                                                        }
                                                                    } else {
                                                                        if ($_FILES['goods_img']['error'] == 1) {
                                                                            sys_msg(sprintf($_LANG['goods_img_too_big'],
                                                                                $php_maxsize), 1, array(), false);
                                                                        } else {
                                                                            if ($_FILES['goods_img']['error'] == 2) {
                                                                                sys_msg(sprintf($_LANG['goods_img_too_big'],
                                                                                    $htm_maxsize), 1, array(), false);
                                                                            }
                                                                        }
                                                                    }
                                                                } else {
                                                                ...
                                                                if ($_FILES['goods_img']['tmp_name'] != '' && $_FILES['goods_img']['tmp_name'] != 'none') {
                                                                    ...
                                                                    if (!copy('../' . $img, '../' . $newname)) {
                                                                        sys_msg('fail to copy file: ' . realpath('../' . $img),
                                                                            1, array(), false);
                                                                    }
                                                                    ...
                                                                    if (0 < $image->gd_version() && $image->check_img_function($_FILES['goods_img']['type'])) {
                                                                        if ($_CFG['image_width'] != 0 || $_CFG['image_height'] != 0) {
                                                                            $goods_img = $image->make_thumb('../' . $goods_img,
                                                                                $GLOBALS['_CFG']['image_width'],
                                                                                $GLOBALS['_CFG']['image_height']);

                                                                            if ($goods_img === false) {
                                                                                sys_msg($image->error_msg(), 1, array(),
                                                                                    false);
                                                                            }
                                                                        }
                                                                        ...
                                                                        $pos = strpos(basename($img), '.');
                                                                        $gallery_img = dirname($img) . '/' . $image->random_filename() . substr(basename($img),
                                                                                $pos);
                                                                ...
                                                                if (!empty($original_img)) {
                                                                    if ($_CFG['thumb_width'] != 0 || $_CFG['thumb_height'] != 0) {
                                                                        $goods_thumb = $image->make_thumb('../' . $original_img,
                                                                            $GLOBALS['_CFG']['thumb_width'],
                                                                            $GLOBALS['_CFG']['thumb_height']);
                   ...
                   is_best, is_new, is_hot)' . ('VALUES(\'' . $good_name . '\', \'' . $goods_sn . '\', \'' . $good_number . '\', \'' . $cat_id . '\', \'' . $brand_id . '\', \'' . $good_brief . '\', \'' . $good_price . '\',') . (' \'' . $market_price . '\', \'' . $goods_img . '\', \'' . $goods_thumb . '\', \'' . $original_img . '\',\'') . gmtime() . '\', \'' . gmtime() . ('\', \'' . $is_best . '\', \'' . $is_new . '\', \'' . $is_hot . '\')');
                                                        ...
                                                        if ($_REQUEST['act'] == 'merchants_first') {
                                                            ...
                                                            $smarty->assign('seller_notice',
                                                                $seller_shop_info['notice']);
                                                            ...
                                                            if ($_REQUEST['act'] == 'merchants_second') {
                                                                ...
                                                                if ($adminru['ru_id'] == 0) {
                                                                    $update_arr = array(
                                                                        'service_email' => $seller_email,
                                                                        'qq' => $kf_qq,
                                                                        'ww' => $kf_ww,
                                                                        'shop_title' => $shop_title,
                                                                        'shop_keywords' => $shop_keyword,
                                                                        'shop_country' => $shop_country,
                                                                        'shop_province' => $shop_province,
                                                                        'shop_city' => $shop_city,
                                                                        'shop_address' => $shop_address,
                                                                        'service_phone' => $kf_tel,
                                                                        'shop_notice' => $notice
                                                                    );
                                                                ...
                                                                $shop_info = array(
                                                                    ...
                                                                    'kf_ww' => $kf_ww,
                                                                    'kf_appkey' => $kf_appkey,
                                                                    'kf_secretkey' => $kf_secretkey,
                                                                    'kf_touid' => $kf_touid,
                                                                    'kf_logo' => $kf_logo,
                                                                    'kf_welcomeMsg' => $kf_welcomeMsg,
                                                                    'kf_im_switch' => $kf_im_switch,
                                                                    'meiqia' => $meiqia,
                                                                    'kf_type' => $kf_type,
                                                                    'kf_tel' => $kf_tel,
                                                                    'notice' => $notice,
                                                                ...
                                                                if (isset($_FILES['shop_logo'])) {
                                                                    ...
                                                                    if (isset($file['error']) && $file['error'] == 0 || !isset($file['error']) && $file['tmp_name'] != 'none') {
                                                                        if (!check_file_type($file['tmp_name'],
                                                                            $file['name'], $allow_file_types)) {
                                                                            sys_msg(sprintf($_LANG['msg_invalid_file'],
                                                                                $file['name']));
                                                                        } else {
                                                                            if ($file['name']) {
                                                                            ...
                                                                            if (move_upload_file($file['tmp_name'],
                                                                                $file_name)) {
                                                                                $shop_info['shop_logo'] = $file_name;
                                                                            } else {
                                                                                sys_msg(sprintf($_LANG['msg_upload_failed'],
                                                                                    $file['name'],
                                                                                    '../seller_imgs/seller_' . $adminru['ru_id']));
                                                                            }
                                                                        }
                                                                    }
                                                                }
                                                                    ...
                                                                    if (isset($file['error']) && $file['error'] == 0 || !isset($file['error']) && $file['tmp_name'] != 'none') {
                                                                        if (!check_file_type($file['tmp_name'],
                                                                            ...
                                                                            if (move_upload_file($file['tmp_name'],
                                                                                ...
                                                                                include_once ROOT_PATH . '/includes/cls_image.php';
                                                                                $image = new cls_image($_CFG['bgcolor']);
                                                                                $goods_thumb = $image->make_thumb($file_name,
                                                                                    120, 120,
                                                                                    '../seller_imgs/seller_logo/logo_thumb/');
                                                                                $shop_info['logo_thumb'] = $goods_thumb;

                                                                                if (!empty($goods_thumb)) {
                                                                                    if ($store['logo_thumb']) {
                                                                                        $store['logo_thumb'] = str_replace('../',
                                                                                            '', $store['logo_thumb']);
                                                                                ...
                                                                                sys_msg(sprintf($_LANG['msg_upload_failed'],
                                                                                    $file['name'],
                                                                                    'seller_imgs/logo_thumb_' . $adminru['ru_id']));
                                                                            }
                                                                        }
                                                                    }
                                                                }
                                                                ...
                                                                if (isset($_FILES['street_thumb'])) {
                                                                    $street_thumb = $image->upload_image($_FILES['street_thumb'],
                                                                        'store_street/street_thumb');
                                                                }

                                                                $brand_thumb = '';

                                                                if (isset($_FILES['brand_thumb'])) {
                                                                    $brand_thumb = $image->upload_image($_FILES['brand_thumb'],
                                                                        'store_street/brand_thumb');
                                                                }

                                                                $domain_id = $db->getOne('SELECT id FROM ' . $ecs->table('seller_domain') . ' WHERE ru_id =\'' . $adminru['ru_id'] . '\'');

                                                                if (0 < $domain_id) {
                                                                    $db->autoExecute($ecs->table('seller_domain'),
                                                                        $seller_domain, 'UPDATE',
                                                                        'ru_id=\'' . $adminru['ru_id'] . '\'');
                                                                } else {
                                                                    $db->autoExecute($ecs->table('seller_domain'),
                                                                        $seller_domain, 'INSERT');
                                                                }
                                                                    ...
                                                                    if (isset($file['error']) && $file['error'] == 0 || !isset($file['error']) && $file['tmp_name'] != 'none') {
                                                                        if (!check_file_type($file['tmp_name'],
                                                                            ...
                                                                            if (move_upload_file($file['tmp_name'],
                                                                                ...
                                                                                include_once ROOT_PATH . '/includes/cls_image.php';
                                                                                $image = new cls_image($_CFG['bgcolor']);
                                                                                $qrcode_thumb = $image->make_thumb($file_name,
                                                                                    120, 120,
                                                                                    '../seller_imgs/seller_qrcode/qrcode_thumb/');

                                                                                if (!empty($qrcode_thumb)) {
                                                                                    if ($store['qrcode_thumb']) {
                                                                                        $store['qrcode_thumb'] = str_replace('../',
                                                                                            '', $store['qrcode_thumb']);
                                                                                ...
                                                                                if (0 < $qrcode_count) {
                                                                                    if (!empty($qrcode_thumb)) {
                                                                                        ...
                                                                                        $db->autoExecute($ecs->table('seller_qrcode'),
                                                                                            $qrcode_other, 'UPDATE',
                                                                                            'ru_id = \'' . $adminru['ru_id'] . '\'');
                                                                                    }
                                                                                } else {
                                                                                ...
                                                                                sys_msg(sprintf($_LANG['msg_upload_failed'],
                                                                                    $file['name'],
                                                                                    'seller_imgs/qrcode_thumb_' . $adminru['ru_id']));
                                                                            }
                                                                        }
                                                                    }
                                                                }
                                                                ...
                                                                if (isset($shop_info['logo_thumb'])) {
                                                                    $add_logo_thumb = str_replace('../', '',
                                                                        $shop_info['logo_thumb']);
                                                                }
                                                                ...
                                                                if ($data_op == 'add') {
                                                                    ...
                                                                    if (!$store) {
                                                                        $db->autoExecute($ecs->table('seller_shopinfo'),
                                                                            $shop_info, 'INSERT');
                                                                    }

                                                                    $lnk[] = array(
                                                                        'text' => $_LANG['go_back_step'],
                                                                        'href' => 'index.php?act=merchants_first'
                                                                    );
                                                                    ...
                                                                    sys_msg($_LANG['update_store_info_success'], 0,
                                                                        $lnk);
                                                                }
                                                            } else {
                                                                if ($_REQUEST['act'] == 'about_us') {
                                                                    ...
                                                                    if ($_REQUEST['act'] == 'drag') {
                                                                        ...
                                                                        if ($_REQUEST['act'] == 'check_order') {
                                                                            $firstSecToday = local_mktime(0, 0, 0,
                                                                                local_date('m'), local_date('d'),
                                                                                local_date('Y'));
                                                                            $lastSecToday = local_mktime(0, 0, 0,
                                                                                    local_date('m'),
                                                                                    local_date('d') + 1,
                                                                                    local_date('Y')) - 1;
                                                                            ...
                                                                            if (admin_priv('order_back_apply', '',
                                                                                false)) {
                                                                            ...
                                                                            if ($_REQUEST['act'] == 'check_bill') {
                                                                                ...
                                                                                $cfg_checkbill = read_static_cache('checkbill_number_' . $adminru['ru_id'],
                                                                                    '/data/sc_file/seller_bill/');

                                                                                if ($cfg_checkbill === false) {
                                                                                    write_static_cache('checkbill_number_' . $adminru['ru_id'],
                                                                                        $checkbil_array,
                                                                                        '/data/sc_file/seller_bill/');
                                                                                } else {
                                                                                ...
                                                                                if ($is_check_bill) {
                                                                                    ...
                                                                                    if ($seller_id) {
                                                                                        ...
                                                                                        $count = $GLOBALS['db']->getOne($sql);
                                                                                        $seller_list = read_static_cache('seller_list',
                                                                                            '/data/sc_file/');
                                                                                    ...
                                                                                    foreach ($seller_list as $key => $row) {
                                                                                        ...
                                                                                        if ($row['cycle'] == 7) {
                                                                                            $day_array = get_bill_days_number($row['seller_id'],
                                                                                                $row['cycle']);
                                                                                            ...
                                                                                            if (empty($day_array)) {
                                                                                                ...
                                                                                                $last_year_start = local_date('Y-m-d 00:00:00',
                                                                                                    $row['bill_time']);
                                                                                                $bill_time = $row['bill_time'] + ($row['day_number'] - 1) * 24 * 60 * 60;
                                                                                                $last_year_end = local_date('Y-m-d 23:59:59',
                                                                                                    $bill_time);
                                                                                                $thistime = gmtime();
                                                                                            ...
                                                                                            if ($row['cycle'] == 6) {
                                                                                                $day_array = get_bill_one_year($row['seller_id'],
                                                                                                    $row['cycle']);
                                                                                                ...
                                                                                                if ($row['cycle'] == 5) {
                                                                                                    $day_array = get_bill_half_year($row['seller_id'],
                                                                                                        $row['cycle']);
                                                                                                    ...
                                                                                                    if ($row['cycle'] == 4) {
                                                                                                        $day_array = get_bill_quarter($row['seller_id'],
                                                                                                            $row['cycle']);
                                                                                                        ...
                                                                                                        if ($row['cycle'] == 3) {
                                                                                                            $day_array = get_bill_one_month($row['seller_id'],
                                                                                                                $row['cycle']);
                                                                                                            ...
                                                                                                            if ($row['cycle'] == 2) {
                                                                                                                $day_array = get_bill_half_month($row['seller_id'],
                                                                                                                    $row['cycle']);
                                                                                                                ...
                                                                                                                if (empty($day_array)) {
                                                                                                                    ...
                                                                                                                    if ($halfDay < $nowDay) {
                                                                                                                        ...
                                                                                                                        $lastMonth_lastDay = local_date('Y-m-d',
                                                                                                                                local_strtotime($lastMonth_firstDay . ' +1 month -1 day')) . ' 23:59:59';
                                                                                                                        $lastMonth = local_date('Y-m-d',
                                                                                                                            local_strtotime($lastMonth_firstDay . ' +1 month -1 day'));
                                                                                                                        $lastMonth = explode('-',
                                                                                                                            $lastMonth);
                                                                                                                ...
                                                                                                                if ($row['cycle'] == 1) {
                                                                                                                    $day_array = get_bill_seven_day($row['seller_id'],
                                                                                                                        $row['cycle']);
                                                                                                                    ...
                                                                                                                    $day_array = get_bill_per_day($row['seller_id'],
                                                                                                                        $row['cycle']);

                                                                                                                    if (empty($day_array)) {
                                                                                                                        $last_year_start = local_date('Y-m-d 00:00:00',
                                                                                                                            local_strtotime('-1 day'));
                                                                                                                        $last_year_end = local_date('Y-m-d 23:59:59',
                                                                                                                            local_strtotime('-1 day'));
                                                                                                                        $day_array[0]['last_year_start'] = $last_year_start;
                                                                                                                        $day_array[0]['last_year_end'] = $last_year_end;
                                                                                        ...
                                                                                        if ($day_array) {
                                                                                            foreach ($day_array as $keys => $rows) {
                                                                                                ...
                                                                                                $bill_count = $GLOBALS['db']->getOne($sql,
                                                                                                    true);
                                                                                                if ($is_charge == 1 && (0 < $last_year_start && 0 < $last_year_end && $last_year_start < $last_year_end)) {
                                                                                                    if ($bill_count <= 0) {
                                                                                                        ...
                                                                                                        $GLOBALS['db']->autoExecute($GLOBALS['ecs']->table('seller_commission_bill'),
                                                                                                            $other,
                                                                                                            'INSERT');
                                                                                                    }
                                                                                                }
                                                                                        ...
                                                                                        if ($_REQUEST['act'] == 'send_mail') {
                                                                                            ...
                                                                                            if ($rt['template_id'] && $rt['template_content']) {
                                                                                                if (send_mail('',
                                                                                                    ...
                                                                                                    if (0 < $count) {
                                                                                                        $msg = sprintf($_LANG['mailsend_ok'],
                                                                                                            $row['email'],
                                                                                                            $count);
                                                                                                    } else {
                                                                                                        $msg = sprintf($_LANG['mailsend_finished'],
                                                                                                            $row['email']);
                                                                                                    }
                                                                                            ...
                                                                                            if ($_REQUEST['act'] == 'license') {
                                                                                                ...
                                                                                                if ($_REQUEST['act'] == 'cloud_services') {
...
');
                                                                                                    ...
                                                                                                    if ($_REQUEST['act'] == 'platform_recommend') {
                                                                                                        admin_priv('cloud_services');
                                                                                                        $http = $ecs->http();
...
');
                                                                                                        ...
                                                                                                        if ($_REQUEST['act'] == 'best_recommend') {
                                                                                                            admin_priv('cloud_services');
                                                                                                            $http = $ecs->http();
...
');
                                                                                                                ...
                                                                                                                if ($_REQUEST['act'] == 'upload_store_img') {
                                                                                                                    $result = array(
                                                                                                                        'error' => 0,
                                                                                                                        'message' => '',
                                                                                                                        'content' => ''
                                                                                                                    ...
                                                                                                                    if ($_FILES['img']['name']) {
                                                                                                                        $dir = 'store_user';
                                                                                                                        $img_name = $image->upload_image($_FILES['img'],
                                                                                                                            $dir);
                                                                                                                    ...
                                                                                                                    if ($_REQUEST['act'] == 'auth_menu') {
                                                                                                                        ...
                                                                                                                        if ($type == 'add') {
                                                                                                                            ...
                                                                                                                            $auth_menu = str_replace($auth_name . '|' . $auth_href . ',',
                                                                                                                                '',
                                                                                                                                $auth_menu);
                                                                                                                            setcookie('auth_menu',
                                                                                                                                $auth_menu,
                                                                                                                        ...
                                                                                                                        if ($_REQUEST['act'] == 'operation_flow') {
                                                                                                                            require_once ROOT_PATH . '/includes/cls_json.php';
                                                                                                                            $json = new JSON();
                                                                                                                            $smarty->assign('ur_here',
                                                                                                                                $_LANG['02_operation_flow']);
                                                                                                                            $smarty->display('operation_flow.dwt');
                                                                                                                        } else {
                                                                                                                            if ($_REQUEST['act'] == 'novice_guide') {
                                                                                                                                require_once ROOT_PATH . '/includes/cls_json.php';
                                                                                                                                $json = new JSON();
                                                                                                                                $smarty->assign('ur_here',
                                                                                                                                    $_LANG['03_novice_guide']);
