...
if ($_REQUEST['act'] == 'list') {
    ...
    $smarty->assign('action_link1',
        array('text' => $_LANG['goods_report_type'], 'href' => 'goods_report.php?act=type'));
    $smarty->assign('action_link2',
        array('text' => $_LANG['goods_report_title'], 'href' => 'goods_report.php?act=title'));
    $smarty->assign('action_link3',
        array('text' => $_LANG['report_conf'], 'href' => 'goods_report.php?act=report_conf'));
    ...
    if ($_REQUEST['act'] == 'query') {
        ...
        if ($_REQUEST['act'] == 'check_state') {
            ...
            $smarty->assign('action_link',
                array('text' => $_LANG['goods_report_list'], 'href' => 'goods_report.php?act=list'));
                    ...
                    if ($_REQUEST['act'] == 'remove') {
                        ...
                        if ($_REQUEST['act'] == 'type') {
                            ...
                            $smarty->assign('action_link2',
                                array('text' => $_LANG['goods_report_title'], 'href' => 'goods_report.php?act=title'));
                            $smarty->assign('action_link3',
                                array('text' => $_LANG['type_add'], 'href' => 'goods_report.php?act=type_add'));
                            $smarty->assign('action_link4',
                                array('text' => $_LANG['report_conf'], 'href' => 'goods_report.php?act=report_conf'));
                            ...
                            if ($_REQUEST['act'] == 'type_query') {
                                ...
                                if ($_REQUEST['act'] == 'toggle_show') {
                                    ...
                                    if ($_REQUEST['act'] == 'toggle_show_title') {
                                        check_authz_json('complaint');
                                        $id = intval($_POST['id']);
                                        $val = intval($_POST['val']);
                                        ...
                                        if ($_REQUEST['act'] == 'type_add' || $_REQUEST['act'] == 'type_edit') {
                                            ...
                                            $smarty->assign('action_link', array(
                                                'text' => $_LANG['goods_report_type'],
                                                'href' => 'goods_report.php?act=type'
                                            ));
                                            ...
                                            if ($_REQUEST['act'] == 'type_insert' || $_REQUEST['act'] == 'type_update') {
                                                ...
                                                if ($_REQUEST['act'] == 'type_insert') {
                                                    ...
                                                    if (!$is_only) {
                                                        sys_msg(sprintf($_LANG['title_exist'],
                                                            stripslashes($type_name)), 1);
                                                    }
                                                ...
                                                if ($_REQUEST['act'] == 'remove_type') {
                                                    check_authz_json('goods_report');
                                                    $id = intval($_GET['id']);
                                                    $exc_type->drop($id);
                                                    $url = 'goods_report.php?act=type_query&' . str_replace('act=remove_type',
                                                            '', $_SERVER['QUERY_STRING']);
                                                    ecs_header('Location: ' . $url . "\n");
                                                    exit();
                                                } else {
                                                    if ($_REQUEST['act'] == 'title') {
                                                        admin_priv('goods_report');
                                                        $smarty->assign('ur_here', $_LANG['goods_report_title']);
                                                        $smarty->assign('action_link', array(
                                                            'text' => $_LANG['goods_report_list'],
                                                            'href' => 'goods_report.php?act=list'
                                                        ));
                                                        ...
                                                        $smarty->assign('action_link2', array(
                                                            'text' => $_LANG['goods_report_title'],
                                                            'href' => 'goods_report.php?act=title'
                                                        ));
                                                        $smarty->assign('action_link3', array(
                                                            'text' => $_LANG['title_add'],
                                                            'href' => 'goods_report.php?act=title_add'
                                                        ));
                                                        $smarty->assign('action_link4', array(
                                                            'text' => $_LANG['report_conf'],
                                                        ...
                                                        if ($_REQUEST['act'] == 'title_query') {
                                                            ...
                                                            if ($_REQUEST['act'] == 'title_add' || $_REQUEST['act'] == 'title_edit') {
                                                                ...
                                                                if ($_REQUEST['act'] == 'title_add') {
                                                                    ...
                                                                    $smarty->assign('report_title_info',
                                                                        $report_title_info);
                                                                }

                                                                $smarty->assign('goods_report_type',
                                                                    $goods_report_type);
                                                                $smarty->assign('form_action', $form_action);
                                                                ...
                                                                if ($_REQUEST['act'] == 'title_insert' || $_REQUEST['act'] == 'title_update') {
                                                                    ...
                                                                    if ($_REQUEST['act'] == 'title_insert') {
                                                                        $is_only = $exc_title->is_only('title_name',
                                                                            $title_name, 0);

                                                                        if (!$is_only) {
                                                                            sys_msg(sprintf($_LANG['exist_title'],
                                                                                stripslashes($title_name)), 1);
                                                                        }
                                                                    ...
                                                                    if ($_REQUEST['act'] == 'remove_title') {
                                                                        check_authz_json('goods_report');
                                                                        $id = intval($_GET['id']);
                                                                        $exc_title->drop($id);
                                                                        $url = 'goods_report.php?act=title_query&' . str_replace('act=remove_title',
                                                                                '', $_SERVER['QUERY_STRING']);
                                                                        ecs_header('Location: ' . $url . "\n");
                                                                        exit();
                                                                    }
