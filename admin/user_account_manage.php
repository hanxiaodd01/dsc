...
if ($_REQUEST['act'] == 'list') {
    ...
    if ($_REQUEST['act'] == 'surplus') {
        ...
        $smarty->assign('action_link', array(
            'text' => $_LANG['user_account_manage'],
            'href' => 'user_account_manage.php?act=list&start_date=' . local_date('Y-m-d',
                    $start_date) . '&end_date=' . local_date('Y-m-d', $end_date)
        ));
        assign_query_info();
        ...
        if ($_REQUEST['act'] == 'query') {
            ...
            make_json_result($smarty->fetch('order_surplus_list.htm'), '',
