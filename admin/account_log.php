...
if ($_REQUEST['act'] == 'list') {
    ...
    $smarty->assign('action_link',
        array('text' => $_LANG['add_account'], 'href' => 'account_log.php?act=add&user_id=' . $user_id));
    ...
    if ($_REQUEST['act'] == 'query') {
        ...
        if ($_REQUEST['act'] == 'add') {
            ...
            if (0 < $user_id) {
                $smarty->assign('action_link',
                    array('href' => 'users.php?act=list&user_id=' . $user_id, 'text' => $_LANG['user_list']));
            }
            ...
            if ($_REQUEST['act'] == 'insert' || $_REQUEST['act'] == 'update') {
                ...
                log_account_change($user_id, $user_money, $frozen_money, $rank_points, $pay_points,
                    '【' . $_LANG['terrace_handle'] . '】' . $change_desc, ACT_ADJUSTING);
