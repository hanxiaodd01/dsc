...
if ($_REQUEST['act'] == 'list') {
    ...
    $smarty->assign('action_link',
        array('text' => $_LANG['add_store_slide_list'], 'href' => 'seller_shop_slide.php?act=add'));
    ...
    if ($_REQUEST['act'] == 'add') {
        ...
        $smarty->assign('action_link',
            array('text' => $_LANG['store_slide_list'], 'href' => 'seller_shop_slide.php?act=list'));
                    ...
                    if ($_REQUEST['act'] == 'edit_sort_order') {
                        ...
                        if ($_REQUEST['act'] == 'toggle_show') {
                            ...
                            if ($_REQUEST['act'] == 'remove') {
                                ...
                                $exc->drop($id);
                                $url = 'seller_shop_slide.php?act=query&' . str_replace('act=remove', '',
