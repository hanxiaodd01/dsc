...
if ($_REQUEST['act'] == 'list') {
    ...
    $smarty->assign('action_link',
        array('href' => 'merchants_percent.php?act=add', 'text' => $_LANG['add_suppliers_percent']));
    $smarty->assign('action_link2',
        array('href' => 'merchants_commission.php?act=list', 'text' => $_LANG['suppliers_list_server']));
                    ...
                    if ($_REQUEST['act'] == 'batch') {
                        ...
                        if (in_array($_REQUEST['act'], array('add', 'edit'))) {
                            ...
                            $smarty->assign('action_link', array(
                                'href' => 'merchants_percent.php?act=list',
                                'text' => $_LANG['suppliers_percent_list']
                            ));
                            ...
                            if (in_array($_REQUEST['act'], array('insert', 'update'))) {
                                ...
                                if ($_REQUEST['act'] == 'insert') {
                                    ...
                                    $links = array(
                                        array(
                                            'href' => 'merchants_percent.php?act=add',
                                            'text' => $_LANG['continue_add_percent']
                                        ),
                                        array(
                                            'href' => 'merchants_percent.php?act=list',
                                            'text' => $_LANG['back_percent_list']
                                        )
                                    );
                                ...
                                if ($_REQUEST['act'] == 'update') {
                                    ...
                                    $db->autoExecute($ecs->table('merchants_percent'), $percent['new'], 'UPDATE',
