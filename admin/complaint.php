...
if ($_REQUEST['act'] == 'list') {
    ...
    $smarty->assign('action_link2',
        array('text' => $_LANG['report_conf'], 'href' => 'complaint.php?act=complaint_conf'));
                ...
                if ($_REQUEST['act'] == 'talk_release') {
                    ...
                    if ($type == 0) {
                        ...
                        if ($type == 2 || $type == 3) {
                            ...
                            $db->autoExecute($ecs->table('complaint_talk'), $complaint_talk, 'UPDATE',
                                'complaint_id=\'' . $complaint_id . '\' AND talk_id =\'' . $talk_id . '\'');
                        }
                    }
                    ...
                    if ($_REQUEST['act'] == 'remove') {
                        ...
                        if ($_REQUEST['act'] == 'title') {
                            ...
                            $smarty->assign('action_link',
                                array('text' => $_LANG['13_complaint'], 'href' => 'complaint.php?act=list'));
                            $smarty->assign('action_link1',
                                array('text' => $_LANG['complain_title'], 'href' => 'complaint.php?act=title'));
                            $smarty->assign('action_link2',
                                array('text' => $_LANG['report_conf'], 'href' => 'complaint.php?act=complaint_conf'));
                            $smarty->assign('action_link3',
                                array('text' => $_LANG['title_add'], 'href' => 'complaint.php?act=add'));
                                ...
                                if ($_REQUEST['act'] == 'add' || $_REQUEST['act'] == 'edit') {
                                    ...
                                    if ($_REQUEST['act'] == 'insert' || $_REQUEST['act'] == 'update') {
                                        ...
                                        if ($_REQUEST['act'] == 'remove_title') {
                                            ...
                                            $id = intval($_GET['id']);
                                            $exc_title->drop($id);
                                            $url = 'complaint.php?act=title_query&' . str_replace('act=remove_title',
                                                    '', $_SERVER['QUERY_STRING']);
                                            ecs_header('Location: ' . $url . "\n");
                                            exit();
                                        } else {
                                            if ($_REQUEST['act'] == 'complaint_conf') {
                                                if (0 < $adminru['rs_id']) {
                                                ...
                                                $smarty->assign('action_link', array(
                                                    'text' => $_LANG['13_complaint'],
                                                    'href' => 'complaint.php?act=list'
                                                ));
                                                $smarty->assign('action_link1', array(
                                                    'text' => $_LANG['complain_title'],
                                                    'href' => 'complaint.php?act=title'
                                                ));
