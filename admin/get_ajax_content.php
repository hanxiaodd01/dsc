...
function get_brandlist($filters)
{
    ...
    if (!empty($brand_id)) {
        ...
        $where .= ' AND ' . $children . ' OR ' . 'gc.cat_id ' . db_create_in(array_unique(array_merge(array($cat_id),
                $cat_keys)));
    }
...
if ($_REQUEST['act'] == 'get_select_category') {
    ...
    if ($_REQUEST['act'] == 'filter_category') {
        ...
        if ($_REQUEST['act'] == 'search_brand_list') {
            ...
            if ($_REQUEST['act'] == 'filter_list') {
                                    ...
                                    if ($FloorBrand == 1) {
                                        if (!empty($arr)) {
                                            ...
                                            foreach ($arr as $key => $val) {
                                                ...
                                                $arr[$key]['brand_logo'] = get_image_path($val['brand_id'],
                                                    $val['brand_logo']);
                ...
                if ($_REQUEST['act'] == 'add_floor_content') {
                    ...
                    if ($_REQUEST['act'] == 'drop_floor_content') {
                        ...
                        if (0 < count($fb_id)) {
                            ...
                            $arr = get_floor_content($curr_template, $floor_info['filename'], $floor_info['id'],
                                $floor_info['region']);
                        ...
                        if ($_REQUEST['act'] == 'add_link_goods') {
                            ...
                            if ($_REQUEST['act'] == 'drop_link_goods') {
                                ...
                                if ($_REQUEST['act'] == 'add_link_artic_goods') {
                                    ...
                                    if ($_REQUEST['act'] == 'drop_link_artic_goods') {
                                        $drop_goods = empty($_REQUEST['value']) ? array() : explode(',',
                                            $_REQUEST['value']);
                                        $article_id = empty($_REQUEST['article_id']) ? 0 : intval($_REQUEST['article_id']);
                                        $result = array('error' => 0, 'message' => '', 'content' => '');
                                        ...
                                        if ($_REQUEST['act'] == 'add_group_goods') {
                                            ...
                                            if ($_REQUEST['act'] == 'add_seckill_goods') {
                                                ...
                                                if ($_REQUEST['act'] == 'drop_seckill_goods') {
                                                    $fittings = empty($_REQUEST['value']) ? array() : explode(',',
                                                        $_REQUEST['value']);
                                                    $sec_id = empty($_REQUEST['sec_id']) ? 0 : intval($_REQUEST['sec_id']);
                                                    $tb_id = empty($_REQUEST['tb_id']) ? 0 : intval($_REQUEST['tb_id']);
                                                    $result = array('error' => 0, 'message' => '', 'content' => '');
                                                    $sql = 'DELETE FROM ' . $ecs->table('seckill_goods') . ' WHERE ' . db_create_in($fittings,
                                                            'id');
                                                    $db->query($sql);
                                                    ...
                                                    if ($_REQUEST['act'] == 'add_goods_article') {
                                                        $articles = empty($_REQUEST['value']) ? array() : explode(',',
                                                            $_REQUEST['value']);
                                                        $goods_id = empty($_REQUEST['goods_id']) ? 0 : intval($_REQUEST['goods_id']);
                                                        $result = array('error' => 0, 'message' => '', 'content' => '');
                                                        ...
                                                        if ($_REQUEST['act'] == 'drop_goods_article') {
                                                            ...
                                                            $sql = 'DELETE FROM ' . $ecs->table('goods_article') . ' WHERE ' . db_create_in($articles,
                                                                    'article_id') . (' AND goods_id = \'' . $goods_id . '\'');
                                                            $db->query($sql);
                                                            $arr = get_goods_articles($goods_id);
                                                            $opt = array();
                                                            ...
                                                            if ($_REQUEST['act'] == 'add_area_goods') {
                                                                $fittings = empty($_REQUEST['value']) ? array() : explode(',',
                                                                    $_REQUEST['value']);
                                                                $goods_id = empty($_REQUEST['goods_id']) ? 0 : intval($_REQUEST['goods_id']);
                                                                $result = array(
                                                                ...
                                                                if ($_REQUEST['act'] == 'add_win_goods') {
                                                                    include_once ROOT_PATH . 'includes/cls_json.php';
                                                                    $json = new JSON();
                                                                    $linked_array = empty($_REQUEST['value']) ? array() : explode(',',
                                                                        $_REQUEST['value']);
                                                                    ...
                                                                    if ($_REQUEST['act'] == 'drop_win_goods') {
                                                                        include_once ROOT_PATH . 'includes/cls_json.php';
                                                                        $json = new JSON();
                                                                        $drop_goods = empty($_REQUEST['value']) ? array() : explode(',',
                                                                            $_REQUEST['value']);
                                                                        ...
                                                                        foreach ($drop_goods as $val) {
                                                                            if (strstr($win_goods,
                                                                                ...
                                                                                if ($key !== false) {
                                                                                    array_splice($win_goods_arr, $key,
                                                                                        1);
                                                                                }
                                                                            }
                                                                        }
                                                                        ...
                                                                        if ($_REQUEST['act'] == 'drop_area_goods') {
                                                                            $drop_goods = empty($_REQUEST['value']) ? array() : explode(',',
                                                                                $_REQUEST['value']);
                                                                            $drop_goods_ids = db_create_in($drop_goods);
                                                                            $goods_id = empty($_REQUEST['goods_id']) ? 0 : intval($_REQUEST['goods_id']);
                                                                            ...
                                                                            if ($_REQUEST['act'] == 'add_link_desc') {
                                                                                ...
                                                                                get_add_edit_link_desc($linked_array, 0,
                                                                                    $id);
                                                                                $ru_id = $adminru['ru_id'];
                                                                                ...
                                                                                $linked_goods = get_linked_goods_desc(0,
                                                                                    $ru_id);
                                                                                $options = array();
                                                                                ...
                                                                                $smarty->assign('filter_result',
                                                                                    $options);
                                                                                $content = $smarty->fetch('templates/library/move_right.lbi');
                                                                                clear_cache_files();
                                                                                make_json_result($content);
                                                                            } else {
                                                                                if ($_REQUEST['act'] == 'drop_link_desc') {
                                                                                    include_once ROOT_PATH . 'includes/cls_json.php';
                                                                                    $json = new JSON();
                                                                                    check_authz_json('goods_manage');
                                                                                    $drop_goods = empty($_REQUEST['value']) ? array() : explode(',',
                                                                                        $_REQUEST['value']);
                                                                                    $id = empty($_REQUEST['id']) ? 0 : intval($_REQUEST['id']);
                                                                                    get_add_edit_link_desc($drop_goods,
                                                                                        1, $id);
                                                                                    $ru_id = $adminru['ru_id'];
                                                                                    ...
                                                                                    if ($_REQUEST['act'] == 'upload_img') {
                                                                                        ...
                                                                                        if (isset($_POST)) {
                                                                                            ...
                                                                                            $type = strtolower(substr(strrchr($name,
                                                                                                '.'), 1));
                                                                                        ...
                                                                                        if ($act_type == 'goods_img') {
                                                                                            ...
                                                                                            if ($_FILES['goods_img']['tmp_name'] != '' && $_FILES['goods_img']['tmp_name'] != 'none') {
                                                                                                ...
                                                                                                if ($_CFG['auto_generate_gallery']) {
                                                                                                    ...
                                                                                                    $pos = strpos(basename($img),
                                                                                                        '.');
                                                                                                    $newname = dirname($img) . '/' . $image->random_filename() . substr(basename($img),
                                                                                                            $pos);
                                                                                                    copy($img,
                                                                                                        $newname);
                                                                                                    $img = $newname;
                                                                                                ...
                                                                                                if ($proc_thumb && 0 < $image->gd_version() && $image->check_img_function($_FILES['goods_img']['type']) || $is_url_goods_img) {
                                                                                                    if (empty($is_url_goods_img)) {
                                                                                                        ...
                                                                                                        if (0 < intval($_CFG['watermark_place']) && !empty($GLOBALS['_CFG']['watermark'])) {
                                                                                                            if ($image->add_watermark($goods_img,
                                                                                                                    '',
                                                                                                                    $GLOBALS['_CFG']['watermark'],
                                                                                                                    $GLOBALS['_CFG']['watermark_place'],
                                                                                                                    $GLOBALS['_CFG']['watermark_alpha']) === false) {
                                                                                                            ...
                                                                                                            if ($_CFG['auto_generate_gallery']) {
                                                                                                                if ($image->add_watermark($gallery_img,
                                                                                                                        '',
                                                                                                                        $GLOBALS['_CFG']['watermark'],
                                                                                                                        $GLOBALS['_CFG']['watermark_place'],
                                                                                                                        $GLOBALS['_CFG']['watermark_alpha']) === false) {
                                                                                                    ...
                                                                                                    if ($_CFG['auto_generate_gallery']) {
                                                                                                        if ($_CFG['thumb_width'] != 0 || $_CFG['thumb_height'] != 0) {
                                                                                                            $gallery_thumb = $image->make_thumb(array(
                                                                                                                'img' => $img,
                                                                                                                'type' => 1
                                                                                                            ),
                                                                                            ...
                                                                                            if (isset($_FILES['goods_thumb']) && $_FILES['goods_thumb']['tmp_name'] != '' && isset($_FILES['goods_thumb']['tmp_name']) && $_FILES['goods_thumb']['tmp_name'] != 'none') {
                                                                                                ...
                                                                                                if ($proc_thumb && isset($_POST['auto_thumb']) && !empty($original_img)) {
                                                                                                    if ($_CFG['thumb_width'] != 0 || $_CFG['thumb_height'] != 0) {
                                                                                                        $goods_thumb = $image->make_thumb(array(
                                                                                                            'img' => $original_img,
                                                                                                            'type' => 1
                                                                                                        ),
                                                                                                            $GLOBALS['_CFG']['thumb_width'],
                                                                                            ...
                                                                                            $original_img = reformat_image_name('goods',
                                                                                                ...
                                                                                                $original_img,
                                                                                                'source');
                                                                                            $goods_img = reformat_image_name('goods',
                                                                                                $goods_id, $goods_img,
                                                                                                'goods');
                                                                                            $goods_thumb = reformat_image_name('goods_thumb',
                                                                                                $goods_id, $goods_thumb,
                                                                                                'thumb');
                                                                                            $result['data'] = array(
                                                                                            ...
                                                                                            if (empty($goods_id)) {
                                                                                                ...
                                                                                                $db->autoExecute($ecs->table('goods'),
                                                                                                    $result['data'],
                                                                                                    'UPDATE',
                                                                                                    'goods_id = \'' . $goods_id . '\'');
                                                                                            }
                                                                                            ...
                                                                                            if ($img) {
                                                                                                if (empty($is_url_goods_img)) {
                                                                                                    $img = reformat_image_name('gallery',
                                                                                                        $goods_id, $img,
                                                                                                        'source');
                                                                                                    $gallery_img = reformat_image_name('gallery',
                                                                                                        $goods_id,
                                                                                                        $gallery_img,
                                                                                                        'goods');
                                                                                                } else {
                                                                                                ...
                                                                                                $gallery_thumb = reformat_image_name('gallery_thumb',
                                                                                                    $goods_id,
                                                                                                    $gallery_thumb,
                                                                                                    'thumb');
                                                                                            ...
                                                                                            if ($GLOBALS['_CFG']['open_oss'] == 1 && $bucket_info['is_delimg'] == 1) {
                                                                                                if ($result['data']) {
                                                                                                    $goods_images = array(
                                                                                                        $result['data']['original_img'],
                                                                                                        $result['data']['goods_img'],
                                                                                                        $result['data']['goods_thumb']
                                                                                                    );
                                                                                            ...
                                                                                            $pic_name = '';
                                                                                            $goods_img = get_image_path($goods_id,
                                                                                                $goods_img, true);
                                                                                            $pic_url = $goods_img;
                                                                                            $upload_status = 1;
                                                                                        } else {
                                                                                            if ($act_type == 'gallery_img') {
                                                                                                    ...
                                                                                                    foreach ($_FILES['img_url']['error'] as $key => $value) {
                                                                                                        if ($value == 0) {
                                                                                                            if (!$image->check_img_type($_FILES['img_url']['type'][$key])) {
                                                                                                                $result['error'] = '1';
                                                                                                                $result['massege'] = sprintf($_LANG['invalid_img_url'],
                                                                                                                    $key + 1);
                                                                                                            } else {
                                                                                                                $goods_pre = 1;
                                                                                                            }
                                                                                                            ...
                                                                                                            if ($value == 1) {
                                                                                                                $result['error'] = '1';
                                                                                                                $result['massege'] = sprintf($_LANG['img_url_too_big'],
                                                                                                                    $key + 1,
                                                                                                                    $php_maxsize);
                                                                                                            } else {
                                                                                                                if ($_FILES['img_url']['error'] == 2) {
                                                                                                                    $result['error'] = '1';
                                                                                                                    $result['massege'] = sprintf($_LANG['img_url_too_big'],
                                                                                                                        $key + 1,
                                                                                                                        $htm_maxsize);
                                                                                                ...
                                                                                                handle_gallery_image_add($goods_id,
                                                                                                    $_FILES['img_url'],
                                                                                                    $img_desc,
                                                                                                    $img_file, '', '',
                                                                                                    'ajax',
                                                                                                ...
                                                                                                $pic_name = '';
                                                                                                $this_img_info['thumb_url'] = get_image_path($goods_id,
                                                                                                    $this_img_info['thumb_url'],
                                                                                                    true);
                                                                                        ...
                                                                                        if ($_REQUEST['act'] == 'ajax_allot') {
                                                                                            ...
                                                                                            if ($priv_arr) {
                                                                                                foreach ($priv_arr as $action_id => $action_group) {
                                                                                                    if ($action_group['priv']) {
                                                                                                        ...
                                                                                                        $priv_arr[$action_id]['priv_list'] = join(',',
                                                                                                            $priv);

                                                                                                        if (!empty($action_group['priv'])) {
                                                                                                            foreach ($action_group['priv'] as $key => $val) {
                                                                                                                $priv_arr[$action_id]['priv'][$key]['cando'] = strpos($priv_str,
                                                                                                                    $val['action_code']) !== false || $priv_str == 'all' ? 1 : 0;
                                                                                                            }
                                                                                                        }
                                                                                                    }
                                                                                                }
                                                                                            ...
                                                                                            $smarty->assign('ur_here',
                                                                                                $_LANG['allot_priv']);
                                                                                            $smarty->assign('priv_arr',
                                                                                                $priv_arr);
                                                                                            $smarty->assign('form_act',
                                                                                                'update_allot');
                                                                                            $content = $smarty->fetch('templates/library/ajax_allot.lbi');
                                                                                            exit(json_encode($content));
                                                                                        } else {
                                                                                            if ($_REQUEST['act'] == 'album_move_back') {
                                                                                                include_once ROOT_PATH . 'includes/cls_json.php';
                                                                                                $json = new JSON();
                                                                                                $result = array(
                                                                                                    'content' => '',
                                                                                                ...
                                                                                                if ($_REQUEST['act'] == 'add_albun_pic') {
                                                                                                    ...
                                                                                                    $exc = new exchange($ecs->table('gallery_album'),
                                                                                                        $db, 'album_id',
                                                                                                        'album_mame');
                                                                                                    ...
                                                                                                    $is_only = $exc->is_only('album_mame',
                                                                                                        $album_mame, 0,
                                                                                                        'ru_id = ' . $adminru['ru_id']);
                                                                                                    ...
                                                                                                    if (isset($_FILES['album_cover']['error']) && $_FILES['album_cover']['error'] == 0 || !isset($_FILES['album_cover']['error']) && isset($_FILES['album_cover']['tmp_name']) && $_FILES['album_cover']['tmp_name'] != 'none') {
                                                                                                        if (!check_file_type($_FILES['album_cover']['tmp_name'],
                                                                                                            $_FILES['album_cover']['name'],
                                                                                                            $allow_file_types)) {
                                                                                                            $result['error'] = 0;
                                                                                                    ...
                                                                                                    if ($_REQUEST['act'] == 'get_albun_pic') {
                                                                                                        ...
                                                                                                        if ($_REQUEST['act'] == 'addmodule') {
                                                                                                            ...
                                                                                                            $link = isset($spec_attr['link']) && $spec_attr['link'] != ',' ? explode(',',
                                                                                                            ...
                                                                                                            if ($result['hierarchy'] == 3) {
                                                                                                                ...
                                                                                                                if ($result['activity_type'] == 'exchange') {
                                                                                                                    ...
                                                                                                                    if ($result['activity_type'] == 'presale') {
                                                                                                                ...
                                                                                                                if (!empty($goods_list)) {
                                                                                                                    ...
                                                                                                                    foreach ($goods_list as $key => $val) {
                                                                                                                        ...
                                                                                                                        $goods_list[$key]['goods_thumb'] = get_image_path($val['goods_id'],
                                                                                                                            $val['goods_thumb']);
                                                                                                                        $goods_list[$key]['original_img'] = get_image_path($val['goods_id'],
                                                                                                                            $val['original_img']);

                                                                                                                        if ($result['activity_type'] == 'snatch') {
                                                                                                                            $goods_list[$key]['url'] = build_uri('snatch',
                                                                                                                                array('sid' => $val['act_id']));
                                                                                                                        } else {
                                                                                                                            if ($result['activity_type'] == 'auction') {
                                                                                                                                $goods_list[$key]['url'] = build_uri('auction',
                                                                                                                                    array('auid' => $val['act_id']));
                                                                                                                                ...
                                                                                                                                if ($result['activity_type'] == 'group_buy') {
                                                                                                                                    ...
                                                                                                                                    $goods_list[$key]['url'] = build_uri('group_buy',
                                                                                                                                        array('gbid' => $val['act_id']));
                                                                                                                                } else {
                                                                                                                                    if ($result['activity_type'] == 'exchange') {
                                                                                                                                        ...
                                                                                                                                        if ($result['activity_type'] == 'presale') {
                                                                                                                                            $goods_list[$key]['url'] = build_uri('presale',
                                                                                                                                                array(
                                                                                                                                                    'act' => 'view',
                                                                                                                                                    'presaleid' => $val['act_id']
                                                                                                                                                ),
                                                                                                                                                $val['goods_name']);
                                                                                                                                        } else {
                                                                                                                                            $goods_list[$key]['url'] = build_uri('goods',
                                                                                                                                                array('gid' => $val['goods_id']),
                                                                                                                                                $val['goods_name']);
                                                                                                                                        }
                                                                                                                                    }
                                                                                                            ...
                                                                                                            $smarty->assign('mode',
                                                                                                                $result['mode']);
                                                                                                            $smarty->assign('homeAdvBg',
                                                                                                                $result['homeAdvBg']);
                                                                                                            $result['content'] = $GLOBALS['smarty']->fetch('library/dialog.lbi');
                                                                                                            exit(json_encode($result));
                                                                                                        } else {
                                                                                                            if ($_REQUEST['act'] == 'changedgoods') {
                                                                                                                require ROOT_PATH . '/includes/lib_goods.php';
                                                                                                                $json = new JSON();
                                                                                                                $result = array(
                                                                                                                    'error' => 0,
                                                                                                                ...
                                                                                                                $cat_id = isset($_REQUEST['cat_id']) ? explode('_',
                                                                                                                    $_REQUEST['cat_id']) : array();
                                                                                                                $brand_id = isset($_REQUEST['brand_id']) ? intval($_REQUEST['brand_id']) : 0;
                                                                                                                $keyword = isset($_REQUEST['keyword']) ? addslashes($_REQUEST['keyword']) : '';
                                                                                                                $goodsAttr = isset($spec_attr['goods_ids']) ? explode(',',
                                                                                                                    $spec_attr['goods_ids']) : '';
                                                                                                                $goods_ids = isset($_REQUEST['goods_ids']) ? explode(',',
                                                                                                                    $_REQUEST['goods_ids']) : '';
                                                                                                                ...
                                                                                                                if (!empty($goods_list)) {
                                                                                                                    foreach ($goods_list as $k => $v) {
                                                                                                                        $goods_list[$k]['goods_thumb'] = get_image_path($v['goods_id'],
                                                                                                                            $v['goods_thumb']);
                                                                                                                        $goods_list[$k]['original_img'] = get_image_path($v['goods_id'],
                                                                                                                            $v['original_img']);
                                                                                                                        $goods_list[$k]['url'] = build_uri('goods',
                                                                                                                            array('gid' => $v['goods_id']),
                                                                                                                            $v['goods_name']);
                                                                                                                        $goods_list[$k]['shop_price'] = price_format($v['shop_price']);

                                                                                                                        if (0 < $v['promote_price']) {
                                                                                                                            $goods_list[$k]['promote_price'] = bargain_price($v['promote_price'],
                                                                                                                                $v['promote_start_date'],
                                                                                                                                $v['promote_end_date']);
                                                                                                                        } else {
                                                                                                                            $goods_list[$k]['promote_price'] = 0;
                                                                                                                        }

                                                                                                                        if (0 < $v['goods_id'] && in_array($v['goods_id'],
                                                                                                                                $result['goods_ids']) && !empty($result['goods_ids'])) {
                                                                                                                            $goods_list[$k]['is_selected'] = 1;
                                                                                                                        }
                                                                                                                    }
                                                                                                                }

                                                                                                                $smarty->assign('is_title',
                                                                                                                    $result['is_title']);
                                                                                                                $smarty->assign('goods_list',
                                                                                                                    $goods_list);
                                                                                                                ...
                                                                                                                $smarty->assign('attr',
                                                                                                                    $spec_attr);
                                                                                                                $result['goods_ids'] = implode(',',
                                                                                                                    $result['goods_ids']);
                                                                                                                $result['content'] = $GLOBALS['smarty']->fetch('library/dialog.lbi');
                                                                                                                exit(json_encode($result));
                                                                                                            } else {
                                                                                                                if ($_REQUEST['act'] == 'gallery_album_list') {
                                                                                                                    $json = new JSON();
                                                                                                                    $result = array(
                                                                                                                        'error' => 0,
                                                                                                                        'message' => '',
                                                                                                                    ...
                                                                                                                    $smarty->assign('gallery_album_list',
                                                                                                                        $gallery_album_list);
                                                                                                                    $res = array();
                                                                                                                    if ($gallery_album_list || 0 < $album_id) {
                                                                                                                        ...
                                                                                                                        if (!empty($res)) {
                                                                                                                            foreach ($res as $k => $v) {
                                                                                                                                if (0 < $v['pic_size']) {
                                                                                                                                    $res[$k]['pic_size'] = number_format($v['pic_size'] / 1024,
                                                                                                                                            2) . 'k';
                                                                                                                                }
                                                                                                                            }
                                                                                                                        }
                                                                                                                    ...
                                                                                                                    $smarty->assign('pic_album_list',
                                                                                                                        $res);
                                                                                                                    $filter['page_arr'] = seller_page($filter,
                                                                                                                        $filter['page'],
                                                                                                                        14);
                                                                                                                    $smarty->assign('filter',
                                                                                                                        $filter);
                                                                                                                    ...
                                                                                                                    if ($_REQUEST['act'] == 'insert_goodsImg') {
                                                                                                                        $json = new JSON();
                                                                                                                        $result = array(
                                                                                                                            'error' => 0,
                                                                                                                            'message' => ''
                                                                                                                        ...
                                                                                                                        if ($img_list) {
                                                                                                                            ...
                                                                                                                            foreach ($img_list as $key => $val) {
                                                                                                                                ...
                                                                                                                                $val['pic_file'] = str_replace(' ',
                                                                                                                                    '',
                                                                                                                                    $val['pic_file'],
                                                                                                                                    $i);
                                                                                                                                $val['pic_image'] = str_replace(' ',
                                                                                                                                    '',
                                                                                                                                    $val['pic_image'],
                                                                                                                                    $i);
                                                                                                                                $val['pic_thumb'] = str_replace(' ',
                                                                                                                                    '',
                                                                                                                                    $val['pic_thumb'],
                                                                                                                                    $i);
                                                                                                                        ...
                                                                                                                        if (!empty($goods_gallery_list)) {
                                                                                                                            foreach ($goods_gallery_list as $key => $val) {
                                                                                                                                if ($val['thumb_url']) {
                                                                                                                                    $goods_gallery_list[$key]['thumb_url'] = get_image_path($goods_id,
                                                                                                                                        $val['thumb_url']);
                                                                                                                                }
                                                                                                                            }
                                                                                                                        }
                                                                                                                            ...
                                                                                                                            if ($_REQUEST['act'] == 'nav_mode') {
                                                                                                                                ...
                                                                                                                                if ($_REQUEST['act'] == 'insertVipEdit') {
                                                                                                                                    ...
                                                                                                                                    if (!empty($index_article_cat)) {
                                                                                                                                        ...
                                                                                                                                        $index_article_cat_arr = explode(',',
                                                                                                                                            $index_article_cat);

                                                                                                                                        foreach ($index_article_cat_arr as $key => $val) {
                                                                                                                                            $index_article_arr[] = assign_articles($val,
                                                                                                                                                3);
                                                                                                                                        }
                                                                                                                                    ...
                                                                                                                                    if ($_REQUEST['act'] == 'homeAdvInsert') {
                                                                                                                                        ...
                                                                                                                                        if ($_REQUEST['act'] == 'getChildCat') {
                                                                                                                                            ...
                                                                                                                                            if ($_REQUEST['act'] == 'homeFloor') {
                                                                                                                                                ...
                                                                                                                                                if (0 < $result['cat_id']) {
                                                                                                                                                    $cat_info = get_cat_info($result['cat_id'],
                                                                                                                                                        array(
                                                                                                                                                            'cat_id',
                                                                                                                                                            'cat_name',
                                                                                                                                                            'cat_alias_name',
                                                                                                                                                ...
                                                                                                                                                if (!empty($result['cateValue'])) {
                                                                                                                                                    ...
                                                                                                                                                    foreach ($result['cateValue'] as $k => $v) {
                                                                                                                                                        ...
                                                                                                                                                        if (0 < $v) {
                                                                                                                                                            ...
                                                                                                                                                            $arr['url'] = build_uri('category',
                                                                                                                                                                array('cid' => $arr['cat_id']),
                                                                                                                                                                $arr['cat_name']);
                                                                                                                                                            $cat_tow[] = $arr;
                                                                                                                                                        }
                                                                                                                                                    }
                                                                                                                                                    ...
                                                                                                                                                    if (!empty($brand_list)) {
                                                                                                                                                        foreach ($brand_list as $key => $val) {
                                                                                                                                                            if ($val['site_url'] && 8 < strlen($val['site_url'])) {
                                                                                                                                                                ...
                                                                                                                                                                $brand_list[$key]['url'] = build_uri('brandn',
                                                                                                                                                                    array('bid' => $val['brand_id']),
                                                                                                                                                                    $val['brand_name']);
                                                                                                                                                            }

                                                                                                                                                            $val['brand_logo'] = DATA_DIR . '/brandlogo/' . $val['brand_logo'];
                                                                                                                                                            $brand_list[$key]['brand_logo'] = get_image_path($val['brand_id'],
                                                                                                                                                                $val['brand_logo']);
                                                                                                                                                        }
                                                                                                                                                    }

                                                                                                                                                    $smarty->assign('brand_list',
                                                                                                                                                        $brand_list);
                                                                                                                                                }
                                                                                                                                                ...
                                                                                                                                                if ($result['moded'] == 'homeFloorFour' || $result['moded'] == 'homeFloorFive' || $result['moded'] == 'homeFloorSeven' || $result['moded'] == 'homeFloorEight' || $result['moded'] == 'homeFloorTen' || $result['moded'] == 'storeOneFloor1' || $result['moded'] == 'storeTwoFloor1' || $result['moded'] == 'storeThreeFloor1' || $result['moded'] == 'storeFourFloor1' || $result['moded'] == 'storeFiveFloor1' || $result['moded'] == 'topicOneFloor' || $result['moded'] == 'topicTwoFloor' || $result['moded'] == 'topicThreeFloor' || $result['moded'] == 'homeFloorSix' && $result['floorMode'] != 1) {
                                                                                                                                                    ...
                                                                                                                                                    if (0 < $adminru['rs_id']) {
                                                                                                                                                        $where_goods .= get_rs_goods_where('g.user_id',
                                                                                                                                                            $adminru['rs_id']);
                                                                                                                                                    }
                                                                                                                                                    ...
                                                                                                                                                    if ($result['moded'] == 'homeFloorFour') {
                                                                                                                                                        ...
                                                                                                                                                        if ($result['moded'] == 'homeFloorSix') {
                                                                                                                                                            ...
                                                                                                                                                            if ($result['moded'] == 'homeFloorSeven') {
                                                                                                                                                                $limit = ' LIMIT 6';
                                                                                                                                                            } else {
                                                                                                                                                                if ($result['moded'] == 'homeFloorEight') {
                                                                                                                                                                    if ($result['floorMode'] == 2) {
                                                                                                                                                                        $limit = ' LIMIT 6';
                                                                                                                                                                    } else {
                                                                                                                                                                        if ($result['floorMode'] == 3) {
                                                                                                                                                                    ...
                                                                                                                                                                    if ($result['moded'] == 'homeFloorTen') {
                                                                                                                                                                        ...
                                                                                                                                                                        if ($result['moded'] == 'storeOneFloor1') {
                                                                                                                                                                            $limit = 'LIMIT 6';
                                                                                                                                                                            ...
                                                                                                                                                                            if ($result['moded'] == 'storeTwoFloor1') {
                                                                                                                                                                                if ($result['floorMode'] == 2) {
                                                                                                                                                                                    $limit = ' LIMIT 6';
                                                                                                                                                                                } else {
                                                                                                                                                                                    if ($result['floorMode'] == 3) {
                                                                                                                                                                                ...
                                                                                                                                                                                if ($result['moded'] == 'storeThreeFloor1') {
                                                                                                                                                                                    if ($result['floorMode'] == 2) {
                                                                                                                                                                                        $limit = ' LIMIT 6';
                                                                                                                                                                                    } else {
                                                                                                                                                                                        if ($result['floorMode'] == 3) {
                                                                                                                                                                                    ...
                                                                                                                                                                                    if ($result['moded'] == 'storeFourFloor1') {
                                                                                                                                                                                        if ($result['floorMode'] == 3) {
                                                                                                                                                                                            $limit = ' LIMIT 6';
                                                                                                                                                                                        } else {
                                                                                                                                                                                            if ($result['floorMode'] == 4) {
                                                                                                                                                                                        ...
                                                                                                                                                                                        if ($result['moded'] == 'storeFiveFloor1') {
                                                                                                                                                                                            if ($result['floorMode'] == 1) {
                                                                                                                                                                                                $limit = ' LIMIT 6';
                                                                                                                                                                                            } else {
                                                                                                                                                                                                $limit = ' LIMIT 8';
                                                                                                                                                                                            ...
                                                                                                                                                                                            if ($result['moded'] == 'topicOneFloor') {
                                                                                                                                                                                                ...
                                                                                                                                                                                                if ($result['moded'] == 'topicTwoFloor') {
                                                                                                                                                                                                    $limit = ' LIMIT 10';
                                                                                                                                                                                                } else {
                                                                                                                                                                                                    if ($result['moded'] == 'topicThreeFloor') {
                                                                                                                                                                                                        if ($result['floorMode'] == 1) {
                                                                                                                                                                                                            $limit = ' LIMIT 8';
                                                                                                                                                                                                        } else {
                                                                                                                                                                                                            if ($result['floorMode'] == 3) {
                                                                                                                                                    ...
                                                                                                                                                    if (!empty($goods_list)) {
                                                                                                                                                        foreach ($goods_list as $key => $val) {
                                                                                                                                                            ...
                                                                                                                                                            $goods_list[$key]['original_img'] = get_image_path($val['goods_id'],
                                                                                                                                                                $val['original_img']);
                                                                                                                                                            if (strpos($goods_list[$key]['goods_thumb'],
                                                                                                                                                                    'http://') === false && strpos($goods_list[$key]['goods_thumb'],
                                                                                                                                                                    'https://') === false) {
                                                                                                                                                                $goods_list[$key]['goods_thumb'] = $ecs->url() . $goods_list[$key]['goods_thumb'];
                                                                                                                                                            }

                                                                                                                                                            if (strpos($goods_list[$key]['original_img'],
                                                                                                                                                                    'http://') === false && strpos($goods_list[$key]['original_img'],
                                                                                                                                                                    'https://') === false) {
                                                                                                                                                    ...
                                                                                                                                                    $smarty->assign('goods_list',
                                                                                                                                                        $goods_list);
                                                                                                                                                    $smarty->assign('goods_num',
                                                                                                                                                        $goods_num);
                                                                                                                                                }

                                                                                                                                                $smarty->assign('advNumber',
                                                                                                                                                    $advNumber);
                                                                                                                                                $smarty->assign('spec_attr',
                                                                                                                                                    $spec_attr);
                                                                                                                                                $smarty->assign('temp',
                                                                                                                                                ...
                                                                                                                                                if ($_REQUEST['act'] == 'edit_cmsarti') {
                                                                                                                                                        ...
                                                                                                                                                        foreach ($result['sort'] as $k => $v) {
                                                                                                                                                            ...
                                                                                                                                                            if ($article_list) {
                                                                                                                                                                foreach ($article_list as $key => $val) {
                                                                                                                                                                    if ($val['file_url']) {
                                                                                                                                                                        $article_list[$key]['file_url'] = get_image_path($k,
                                                                                                                                                                            $val['file_url']);
                                                                                                                                                                    } else {
                                                                                                                                                                        $article_list[$key]['file_url'] = get_image_path($k,
                                                                                                                                                                            'images/article_default.jpg');
                                                                                                                                                                    }

                                                                                                                                                                    $article_list[$key]['add_time'] = local_date('Y.m.d',
                                                                                                                                                                        $val['add_time']);
                                                                                                                                                                    $article_list[$key]['url'] = $val['open_type'] != 1 ? build_uri('article',
                                                                                                                                                                        array('aid' => $val['article_id']),
                                                                                                                                                                        $val['title']) : trim($val['file_url']);
                                                                                                                                                    ...
                                                                                                                                                    if ($_REQUEST['act'] == 'edit_cmsgoods') {
                                                                                                                                                        ...
                                                                                                                                                        $smarty->assign('def_article_list',
                                                                                                                                                            $def_article_list);
                                                                                                                                                        $smarty->assign('article_list',
                                                                                                                                                            $article_list);
                                                                                                                                                        $smarty->assign('temp',
                                                                                                                                                            $result['moded']);
                                                                                                                                                        $smarty->assign('spec_attr',
                                                                                                                                                            ...
                                                                                                                                                            if ($_REQUEST['act'] == 'get_childcat') {
                                                                                                                                                                ...
                                                                                                                                                                if ($_REQUEST['act'] == 'getcat_atr') {
                                                                                                                                                                    ...
                                                                                                                                                                    if ($type == 0 || $old_article && $type == 1) {
                                                                                                                                                                        $article_list = getcat_atr($cat_id,
                                                                                                                                                                            $where);
                                                                                                                                                                    }
                                                                                                                                                                    ...
                                                                                                                                                                    if ($old_article && !empty($article)) {
                                                                                                                                                                        $old_article_arr = explode(',',
                                                                                                                                                                            $old_article);

                                                                                                                                                                        foreach ($article as $k => $v) {
                                                                                                                                                                            if (in_array($v['article_id'],
                                                                                                                                                                                $old_article_arr)) {
                                                                                                                                                                    ...
                                                                                                                                                                    if ($_REQUEST['act'] == 'homeBrand') {
                                                                                                                                                                        ...
                                                                                                                                                                        $smarty->assign('brand_list',
                                                                                                                                                                            $brand_list);
                                                                                                                                                                        $smarty->assign('barndAdv',
                                                                                                                                                                            $adv);
                                                                                                                                                                        $smarty->assign('brand_ids',
                                                                                                                                                                            $spec_attr['brand_ids']);
                                                                                                                                                                        $smarty->assign('temp',
                                                                                                                                                                            $result['moded']);
                                                                                                                                                                        $smarty->assign('suffix',
                                                                                                                                                                        ...
                                                                                                                                                                        if ($_REQUEST['act'] == 'honePromo') {
                                                                                                                                                                                ...
                                                                                                                                                                                if (!empty($PromotionType)) {
                                                                                                                                                                                    ...
                                                                                                                                                                                    if ($spec_attr['moded'] == 'h-seckill') {
                                                                                                                                                                                        ...
                                                                                                                                                                                        if (0 < $time_bucket) {
                                                                                                                                                                                            ...
                                                                                                                                                                                            $time_bucket = array_search($goods_id,
                                                                                                                                                                                                $spec_attr['goods_ids']);
                                                                                                                                                                                        }
                                                                                                                                                                                ...
                                                                                                                                                                                if (!empty($goods_list)) {
                                                                                                                                                                                    ...
                                                                                                                                                                                    foreach ($goods_list as $key => $val) {
                                                                                                                                                                                        ...
                                                                                                                                                                                        if (!empty($PromotionType)) {
                                                                                                                                                                                            ...
                                                                                                                                                                                            if ($spec_attr['moded'] == 'h-seckill') {
                                                                                                                                                                                                $goods_list[$key]['url'] = build_uri('seckill',
                                                                                                                                                                                                    array(
                                                                                                                                                                                                        'act' => 'view',
                                                                                                                                                                                                        'secid' => $val['id']
                                                                                                                                                                                                    ),
                                                                                                                                                                                                    $val['goods_name']);
                                                                                                                                                                                                $goods_list[$key]['list_url'] = build_uri('seckill',
                                                                                                                                                                                                    array(
                                                                                                                                                                                                        'act' => 'list',
                                                                                                                                                                                                        'secid' => $val['id']
                                                                                                                                                                                                    ),
                                                                                                                                                                                                ...
                                                                                                                                                                                                $goods_list[$key]['url'] = build_uri('goods',
                                                                                                                                                                                                    array('gid' => $val['goods_id']),
                                                                                                                                                                                                    $val['goods_name']);
                                                                                                                                                                                                $goods_list[$key]['formated_end_date'] = local_date($GLOBALS['_CFG']['time_format'],
                                                                                                                                                                                                    $val['promote_end_date']);
                                                                                                                                                                                            }
                                                                                                                                                                                        }
                                                                                                                                                                                    }
                                                                                                                                                                            ...
                                                                                                                                                                            if ($_REQUEST['act'] == 'navInsert') {
                                                                                                                                                                                ...
                                                                                                                                                                                if ($_REQUEST['act'] == 'lib_upload_img') {
                                                                                                                                                                                    include_once ROOT_PATH . '/includes/cls_image.php';
                                                                                                                                                                                    $image = new cls_image($_CFG['bgcolor']);
                                                                                                                                                                                    require_once ROOT_PATH . '/' . ADMIN_PATH . '/includes/lib_goods.php';
                                                                                                                                                                                    $act_type = empty($_REQUEST['type']) ? '' : trim($_REQUEST['type']);
                                                                                                                                                                                    ...
                                                                                                                                                                                    if ($act_type == 'goods_img') {
                                                                                                                                                                                        ...
                                                                                                                                                                                        if (empty($goods_id)) {
                                                                                                                                                                                            ...
                                                                                                                                                                                            $db->autoExecute($ecs->table('goods_lib'),
                                                                                                                                                                                                $result['data'],
                                                                                                                                                                                                'UPDATE',
                                                                                                                                                                                                'goods_id = \'' . $goods_id . '\'');
                                                                                                                                                                                        }
                                                                                                                                                                                    ...
                                                                                                                                                                                    if ($_REQUEST['act'] == 'getsearchgoodsDiv') {
                                                                                                                                                                                        $json = new JSON();
                                                                                                                                                                                        $result = array();
                                                                                                                                                                                        $goods_ids = !empty($_REQUEST['goods_ids']) ? trim($_REQUEST['goods_ids']) : '';
                                                                                                                                                                                        ...
                                                                                                                                                                                        if ($_REQUEST['act'] == 'add_goods_type_cat') {
                                                                                                                                                                                            $exc_cat = new exchange($ecs->table('goods_type_cat'),
                                                                                                                                                                                                $db,
                                                                                                                                                                                                'cat_id',
                                                                                                                                                                                                'cat_name');
                                                                                                                                                                                            $json = new JSON();
                                                                                                                                                                                            ...
                                                                                                                                                                                            $is_only = $exc_cat->is_only('cat_name',
                                                                                                                                                                                                $cat_name,
                                                                                                                                                                                                0,
                                                                                                                                                                                                $where);
                                                                                                                                                                                            ...
                                                                                                                                                                                            if (!$is_only) {
                                                                                                                                                                                                $result['error'] = 1;
                                                                                                                                                                                                $result['message'] = sprintf($_LANG['exist_cat'],
                                                                                                                                                                                                    stripslashes($cat_name));
                                                                                                                                                                                                exit(json_encode($result));
                                                                                                                                                                                            }

                                                                                                                                                                                            $db->autoExecute($ecs->table('goods_type_cat'),
                                                                                                                                                                                                $cat_info,
                                                                                                                                                                                                'INSERT');
                                                                                                                                                                                            $cat_id = $db->insert_id();
                                                                                                                                                                                            ...
                                                                                                                                                                                            $smarty->assign('type_level',
                                                                                                                                                                                                $type_level);
                                                                                                                                                                                            $cat_tree = get_type_cat_arr($cat_id,
                                                                                                                                                                                                2,
                                                                                                                                                                                                0,
                                                                                                                                                                                                $user_id);
                                                                                                                                                                                            ...
                                                                                                                                                                                            if (0 < $cat_tree['checked_id']) {
                                                                                                                                                                                                $cat_tree1 = get_type_cat_arr($cat_tree['checked_id'],
                                                                                                                                                                                                    2,
                                                                                                                                                                                                    0,
                                                                                                                                                                                                    $user_id);
                                                                                                                                                                                            }

                                                                                                                                                                                            $smarty->assign('type_c_id',
                                                                                                                                                                                                $cat_id);
                                                                                                                                                                                            $smarty->assign('cat_tree',
                                                                                                                                                                                                $cat_tree);
                                                                                                                                                                                            $smarty->assign('cat_tree1',
                                                                                                                                                                                                $cat_tree1);
                                                                                                                                                                                            $result['cat_id'] = $cat_id;
                                                                                                                                                                                            $result['content'] = $GLOBALS['smarty']->fetch('library/type_cat_list.lbi');
                                                                                                                                                                                            exit(json_encode($result));
                                                                                                                                                                                        } else {
                                                                                                                                                                                            if ($_REQUEST['act'] == 'add_goods_type') {
                                                                                                                                                                                                $json = new JSON();
                                                                                                                                                                                                $result = array(
                                                                                                                                                                                                    'error' => 0,
                                                                                                                                                                                                    'message' => '',
                                                                                                                                                                                                ...
                                                                                                                                                                                                $goods_id = !empty($_REQUEST['goods_id']) ? intval($_REQUEST['goods_id']) : 0;
                                                                                                                                                                                                $parent_id = !empty($_REQUEST['attr_parent_id']) ? intval($_REQUEST['attr_parent_id']) : 0;
                                                                                                                                                                                                $goods_type['cat_name'] = sub_str($_POST['cat_name'],
                                                                                                                                                                                                    60);
                                                                                                                                                                                                $goods_type['attr_group'] = sub_str($_POST['attr_group'],
                                                                                                                                                                                                    255);
                                                                                                                                                                                                $goods_type['user_id'] = !empty($_REQUEST['user_id']) ? intval($_REQUEST['user_id']) : $adminru['ru_id'];
                                                                                                                                                                                                $goods_type['c_id'] = $parent_id;
                                                                                                                                                                                                $db->autoExecute($ecs->table('goods_type'),
                                                                                                                                                                                                    $goods_type);
                                                                                                                                                                                                ...
                                                                                                                                                                                                $smarty->assign('type_level',
                                                                                                                                                                                                    $type_level);
                                                                                                                                                                                                $cat_tree = get_type_cat_arr($parent_id,
                                                                                                                                                                                                    2,
                                                                                                                                                                                                    0,
                                                                                                                                                                                                    $goods_type['user_id']);
                                                                                                                                                                                                $cat_tree1 = array('checked_id' => $cat_tree['checked_id']);
                                                                                                                                                                                                ...
                                                                                                                                                                                                if ($_REQUEST['act'] == 'attribute_add') {
                                                                                                                                                                                                    ...
                                                                                                                                                                                                    $exc = new exchange($ecs->table('attribute'),
                                                                                                                                                                                                        $db,
                                                                                                                                                                                                        'attr_id',
                                                                                                                                                                                                        'attr_name');
                                                                                                                                                                                                    $exclude = empty($_POST['attr_id']) ? 0 : intval($_POST['attr_id']);

                                                                                                                                                                                                    if (!$exc->is_only('attr_name',
                                                                                                                                                                                                        $_POST['attr_name'],
                                                                                                                                                                                                        $exclude,
                                                                                                                                                                                                        ' cat_id = \'' . $cat_id . '\'')) {
                                                                                                                                                                                                        $result['error'] = 1;
                                                                                                                                                                                                    ...
                                                                                                                                                                                                    $attr = array(
                                                                                                                                                                                                        ...
                                                                                                                                                                                                        'attr_cat_type' => $_POST['attr_cat_type'],
                                                                                                                                                                                                    ...
                                                                                                                                                                                                    $db->autoExecute($ecs->table('attribute'),
                                                                                                                                                                                                        $attr,
                                                                                                                                                                                                        'INSERT');
