...
if ($_REQUEST['act'] == 'list') {
    ...
    $smarty->assign('action_link',
        array('text' => $_LANG['exchange_goods_add'], 'href' => 'exchange_goods.php?act=add'));
...
if ($_REQUEST['act'] == 'add') {
    ...
    $smarty->assign('action_link',
        array('text' => $_LANG['15_exchange_goods_list'], 'href' => 'exchange_goods.php?act=list'));
...
if ($_REQUEST['act'] == 'edit') {
    ...
    $smarty->assign('action_link', array(
        'text' => $_LANG['15_exchange_goods_list'],
        'href' => 'exchange_goods.php?act=list&' . list_link_postfix()
    ));
                ...
                if ($_REQUEST['act'] == 'toggle_best') {
                    ...
                    if ($_REQUEST['act'] == 'batch') {
                                ...
                                if ($_POST['type'] == 'review_to') {
                                    ...
                                    if ($db->query($sql)) {
                                        $lnk[] = array(
                                            ...
                                            'href' => 'exchange_goods.php?act=list&seller_list=1&' . list_link_postfix()
                                        );
                        ...
                        if ($_REQUEST['act'] == 'remove') {
                            ...
                            $url = 'exchange_goods.php?act=query&' . str_replace('act=remove', '',
