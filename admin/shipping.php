                                            ...
                                            if ($_REQUEST['act'] == 'print_upload') {
                                                ...
                                                if (!empty($_FILES['bg']['name'])) {
                                                    if (!get_file_suffix($_FILES['bg']['name'], $allow_suffix)) {
                                                        ...
                                                        echo 'parent.alert("' . sprintf($_LANG['js_languages']['upload_falid'],
                                                                implode('，', $allow_suffix)) . '");';
                                                        echo '</script>';
                                                        exit();
                                                    }
                                                ...
                                                if ($_REQUEST['act'] == 'print_del') {
                                                    ...
                                                    if ($_REQUEST['act'] == 'edit_name') {
                                                        ...
                                                        if (!$exc->is_only('shipping_name', $val, $id, '', 'shipping',
                                                            'shipping_code')) {
                                                            make_json_error($_LANG['repeat_shipping_name']);
                                                        }

                                                        $exc->edit('shipping_name = \'' . $val . '\'', $id, 'shipping',
                                                            'shipping_code');
                                                        ...
                                                        if ($_REQUEST['act'] == 'edit_desc') {
                                                            ...
                                                            if ($_REQUEST['act'] == 'edit_insure') {
                                                                ...
                                                                $exc->edit('insure = \'' . $val . '\'', $id, 'shipping',
                                                                    'shipping_code');
                                                                make_json_result(stripcslashes($val));
                                                            } else {
                                                                if ($_REQUEST['act'] == 'edit_order') {
                                                                    ...
                                                                    $exc->edit('shipping_order = \'' . $order . '\'',
                                                                        $code, 'shipping', 'shipping_code');
                                                                    ...
                                                                    if ($_REQUEST['act'] == 'edit_print_template') {
                                                                        ...
                                                                        if ($row) {
                                                                            ...
                                                                            $lnk[] = array(
                                                                                'text' => $_LANG['go_back'],
                                                                                'href' => 'shipping.php?act=list'
                                                                            );
                                                                            sys_msg($_LANG['no_shipping_install'], 0,
                                                                                $lnk);
                                                                        }

                                                                        $smarty->assign('ur_here',
                                                                            $_LANG['03_shipping_list'] . ' - ' . $row['shipping_name'] . ' - ' . $_LANG['shipping_print_template']);
                                                                        ...
                                                                        if ($_REQUEST['act'] == 'do_edit_print_template') {
                                                                            ...
                                                                            admin_log(addslashes($_POST['shipping_name']),
                                                                                'edit', 'shipping');
                                                                            $lnk[] = array(
                                                                                'text' => $_LANG['go_back'],
                                                                                'href' => 'shipping.php?act=list'
                                                                            );
                                                                            sys_msg($_LANG['edit_template_success'], 0,
                                                                                $lnk);
                                                                        } else {
                                                                            if ($_REQUEST['act'] == 'shipping_priv') {
                                                                                ...
                                                                                if ($_REQUEST['act'] == 'account_setting') {
                                                                                    ...
                                                                                    if ($_REQUEST['act'] == 'account_save') {
                                                                                        ...
                                                                                        if (get_shipping_conf($data['shipping_id'],
                                                                                            $data['ru_id'])) {
                                                                                            $db->autoExecute($ecs->table('kdniao_eorder_config'),
                                                                                                $data, 'UPDATE',
                                                                                                'shipping_id = \'' . $data['shipping_id'] . ' \' and ru_id = \'' . $data['ru_id'] . '\'');
                                                                                        } else {
                                                                                            $db->autoExecute($ecs->table('kdniao_eorder_config'),
                                                                                                $data, 'INSERT');
                                                                                        }
                                                                                        ...
                                                                                        if ($_REQUEST['act'] == 'account_apply') {
                                                                                            check_authz_json('ship_manage');
                                                                                            $shipping_id = empty($_REQUEST['id']) ? 0 : intval($_REQUEST['id']);
                                                                                            $shipping_info = get_shipping_info($shipping_id,
                                                                                                $adminru['ru_id']);
                                                                                            $shipping_spec = get_shipping_spec($shipping_info['shipping_code']);
                                                                                            $customer_account = get_kdniao_customer_account($shipping_id,
                                                                                                $adminru['ru_id']);
                                                                                            $smarty->assign('shipping_info',
                                                                                                $shipping_info);
                                                                                            $smarty->assign('shipping_spec',
                                                                                                $shipping_spec);
                                                                                            $smarty->assign('customer_account',
                                                                                                $customer_account);
                                                                                            $province_list = get_regions(1,
                                                                                                1);
                                                                                            ...
                                                                                            if ($_REQUEST['act'] == 'account_submit') {
                                                                                                check_authz_json('ship_manage');
                                                                                                $data = array();
                                                                                                $data['shipping_id'] = empty($_REQUEST['shipping_id']) ? 0 : intval($_REQUEST['shipping_id']);
                                                                                                ...
                                                                                                if (get_kdniao_customer_account($data['shipping_id'],
                                                                                                    $data['ru_id'])) {
                                                                                                    $db->autoExecute($ecs->table('kdniao_customer_account'),
                                                                                                        $data, 'UPDATE',
                                                                                                        'shipping_id = \'' . $data['shipping_id'] . ' \' and ru_id = \'' . $data['ru_id'] . '\'');
                                                                                                } else {
                                                                                                    $db->autoExecute($ecs->table('kdniao_customer_account'),
