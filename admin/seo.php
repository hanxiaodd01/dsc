                                ...
                                if ($_REQUEST['act'] == 'setting') {
                                    ...
                                    if (is_array($seo)) {
                                        foreach ($seo as $key => $value) {
                                            $GLOBALS['db']->autoExecute($GLOBALS['ecs']->table('seo'), $value, 'UPDATE',
                                                'type=\'' . $key . '\'');
                                    ...
                                    if ($_REQUEST['act'] == 'cate_setting') {
                                        ...
                                        $result = $GLOBALS['db']->autoExecute($GLOBALS['ecs']->table('category'),
                                            $categroy, 'UPDATE', 'cat_id=' . $categroy['category_id']);
                                        $links = array(
