    ...
    if ($_REQUEST['act'] == 'query') {
        ...
        if ($_REQUEST['act'] == 'add') {
            ...
            $smarty->assign('action_link',
                array('text' => $_LANG['16_reg_fields'], 'href' => 'reg_fields.php?act=list'));
            ...
            if ($_REQUEST['act'] == 'insert') {
                ...
                if ($_REQUEST['act'] == 'edit') {
                    ...
                    if ($_REQUEST['act'] == 'update') {
                        admin_priv('reg_fields');
                        if (($_POST['reg_field_name'] != $_POST['old_field_name']) && !$exc->is_only('reg_field_name',
                                trim($_POST['reg_field_name']))) {
                            sys_msg(sprintf($_LANG['field_name_exist'], trim($_POST['reg_field_name'])), 1);
                        }
                        ...
                        if ($_REQUEST['act'] == 'remove') {
                            ...
                            $url = 'reg_fields.php?act=query&' . str_replace('act=remove', '',
