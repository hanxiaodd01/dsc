...
if ($_REQUEST['act'] == 'list') {
    $smarty->assign('action_link',
        array('text' => $_LANG['alidayu_add'], 'href' => 'alitongxin_configure.php?act=add'));
    $smarty->assign('action_link2',
        array('text2' => $_LANG['alidayu_set'], 'href' => 'alitongxin_configure.php?act=set_up'));
    ...
    if ($_REQUEST['act'] == 'query') {
        ...
        make_json_result($smarty->fetch('alitongxin_configure_list.dwt'), '',
            array('filter' => $note_list['filter'], 'page_count' => $note_list['page_count']));
    }
}

if ($_REQUEST['act'] == 'add') {
    $smarty->assign('action_link',
        array('text' => $_LANG['alidayu_list'], 'href' => 'alitongxin_configure.php?act=list'));
    $smarty->assign('ur_here', $_LANG['alitongxin_configure']);
    $smarty->assign('form_act', 'insert');
