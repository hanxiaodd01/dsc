...
if ($act == 'list') {
    ...
    $smarty->assign('action_link',
        array('text' => $_LANG['floor_content_add'], 'href' => 'set_floor_brand.php?act=add&filename=' . $filename));
    ...
    if ($act == 'add') {
        ...
        $smarty->assign('action_link', array(
            'text' => $_LANG['floor_content_list'],
            'href' => 'set_floor_brand.php?act=list&filename=' . $filename
        ));
        $curr_template = $_CFG['template'];
        ...
        if ($act == 'edit') {
            ...
            $smarty->assign('action_link',
                array('text' => $_LANG['floor_content_list'], 'href' => 'set_floor_brand.php?act=list'));
