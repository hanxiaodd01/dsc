...
if ($_REQUEST['act'] == 'query') {
    ...
    make_json_result($smarty->fetch('industry_analysis.dwt'), '',
    ...
    if ($_REQUEST['act'] == 'get_chart_data') {
        ...
        if ($_REQUEST['act'] == 'download') {
            ...
            $thead = array(
                $_LANG['03_category_manage'],
                $_LANG['sale_money'],
                $_LANG['effective_sale_money'],
                $_LANG['total_quantity'],
                $_LANG['effective_quantity'],
                $_LANG['goods_total_num'],
                $_LANG['effective_goods_num'],
                $_LANG['not_sale_money_goods_num'],
                $_LANG['order_user_total']
            );
            $tbody = array(
                'cat_name',
                'goods_amount',
