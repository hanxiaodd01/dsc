...
if ($_REQUEST['act'] == 'tpl_list') {
    ...
    $smarty->assign('action_link',
        array('href' => 'warehouse.php?act=ship_list', 'text' => $_LANG['back_dispatching_llist']));
    $smarty->assign('full_page', 1);
    assign_query_info();
    ...
    if ($_REQUEST['act'] == 'ship_tpl') {
        ...
        $smarty->assign('action_link2', array(
            ...
            'text' => $_LANG['back_template_llist']
        ));
        ...
        if ($_REQUEST['act'] == 'freight_tpl_insert') {
            ...
            if ($_REQUEST['act'] == 'add_area') {
                ...
                if ($_REQUEST['act'] == 'edit_area_name') {
                    ...
                    if ($_REQUEST['act'] == 'edit_region_code') {
                        check_authz_json('warehouse_manage');
                        $id = intval($_POST['id']);
                        ...
                        if ($_REQUEST['act'] == 'drop_area') {
                            ...
                            if ($_REQUEST['act'] == 'freight') {
                                ...
                                $smarty->assign('seller_shopinfo', $seller_shopinfo);
                                $smarty->assign('action_link',
                                    array('href' => 'warehouse.php?act=list', 'text' => '返回仓库列表'));
                                $id = isset($_REQUEST['id']) ? $_REQUEST['id'] : 0;
                                $region_id = $id;
