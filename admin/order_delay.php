...
if ($_REQUEST['act'] == 'list') {
    ...
    if ($_REQUEST['act'] == 'query') {
        ...
        make_json_result($smarty->fetch('order_delayed_list.dwt'), '',
            array('filter' => $order_delay_list['filter'], 'page_count' => $order_delay_list['page_count']));
    } else {
        if ($_REQUEST['act'] == 'batch') {
            ...
            if ($_REQUEST['act'] == 'edit_apply_day') {
                check_authz_json('order_delayed');
                $id = intval($_POST['id']);
                ...
                if ($_REQUEST['act'] == 'complaint_conf') {
                    ...
                    $smarty->assign('action_link',
                        array('text' => $_LANG['order_delay_apply'], 'href' => 'order_delay.php?act=list'));
                    $smarty->assign('action_link2',
                        array('text' => $_LANG['order_delay_conf'], 'href' => 'order_delay.php?act=complaint_conf'));
