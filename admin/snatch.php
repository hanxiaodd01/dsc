    ...
    if ($_REQUEST['act'] == 'query') {
        ...
        if ($_REQUEST['act'] == 'add') {
            ...
            $snatch = array(
                ...
                'end_time' => $end_time,
                'option' => '<option value="0">' . $_LANG['make_option'] . '</option>'
            );
                                ...
                                if ($_REQUEST['act'] == 'update') {
                                    ...
                                    if ($_REQUEST['act'] == 'view') {
                                        ...
                                        $smarty->assign('action_link',
                                            array('text' => $_LANG['02_snatch_list'], 'href' => 'snatch.php?act=list'));
                                        ...
                                        if ($_REQUEST['act'] == 'query_bid') {
                                            ...
                                            $sort_flag = sort_flag($bid_list['filter']);
                                            $smarty->assign($sort_flag['tag'], $sort_flag['img']);
                                            make_json_result($smarty->fetch('snatch_view.dwt'), '', array(
                                                ...
                                                if (isset($_POST['type'])) {
                                                    if ($_POST['type'] == 'batch_remove') {
                                                        ...
                                                        if ($db->query($sql)) {
                                                            ...
                                                            sys_msg(sprintf($_LANG['batch_drop_success'], $del_count),
                                                                0, $links);
                                                        }
                                                        ...
                                                        if ($_POST['type'] == 'review_to') {
                                                            ...
                                                            if ($db->query($sql)) {
                                                                $lnk[] = array(
                                                                    'text' => $_LANG['back_list'],
                                                                    'href' => 'snatch.php?act=list&seller_list=1&' . list_link_postfix()
                                                                );
