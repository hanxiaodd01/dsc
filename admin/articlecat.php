...
function cat_update($cat_id, $args)
{
    ...
    return $GLOBALS['db']->autoExecute($GLOBALS['ecs']->table('article_cat'), $args, 'update',
        'cat_id=\'' . $cat_id . '\'');
}
...
if ($_REQUEST['act'] == 'list') {
    ...
    if (0 < $cat_id) {
        ...
        $smarty->assign('action_link1',
            array('text' => $_LANG['return_to_superior'], 'href' => 'articlecat.php?act=list&cat_id=' . $parent_id));
    }
    ...
    if ($_REQUEST['act'] == 'query') {
        ...
        if ($_REQUEST['act'] == 'add') {
            ...
            $smarty->assign('action_link',
                array('text' => $_LANG['02_articlecat_list'], 'href' => 'articlecat.php?act=list'));
            ...
            if ($_REQUEST['act'] == 'insert') {
                ...
                if ($_POST['show_in_nav'] == 1) {
                    ...
                    $vieworder += 2;
                    $sql = 'INSERT INTO ' . $ecs->table('nav') . ' (name,ctype,cid,ifshow,vieworder,opennew,url,type) VALUES(\'' . $_POST['cat_name'] . '\', \'a\', \'' . $db->insert_id() . ('\',\'1\',\'' . $vieworder . '\',\'0\', \'') . build_uri('article_cat',
                            array('acid' => $db->insert_id()), $_POST['cat_name']) . '\',\'middle\')';
                    $db->query($sql);
                }
                    ...
                    if ($_REQUEST['act'] == 'update') {
                        ...
                        if ($_REQUEST['act'] == 'edit_sort_order') {
                            ...
                            if ($_REQUEST['act'] == 'remove') {
                                ...
                                $url = 'articlecat.php?act=query&' . str_replace('act=remove', '',
