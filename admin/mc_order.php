    ...
    for ($i = 0; $i < $comment_num; $i++) {
        ...
        for ($k = 0; $k < $rand_num; $k++) {
            ...
            $other = array(
                ...
                'pay_id' => $pay_id,
                'pay_name' => $arr[$i][8],
                'goods_amount' => $goodsCnt['goods_amount'],
                'shipping_fee' => $arr[$i][9],
                'order_amount' => $goodsCnt['goods_amount'] + $arr[$i][9],
                'add_time' => $time,
...
if ($_REQUEST['act'] == 'mc_add') {
    ...
    if ($file_chk) {
        ...
        if (!empty($user_str)) {
            mc_new_order($user_str, $goods, $goods_number, $comment_num, $start_time, $end_time, $order_status,
