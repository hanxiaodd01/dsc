            ...
            if ($_REQUEST['act'] == 'batch') {
                ...
                if (isset($_POST['type'])) {
                    if ($_POST['type'] == 'batch_remove') {
                        ...
                        $links[] = array(
                            'text' => $_LANG['back_auction_list'],
                            'href' => 'auction.php?act=list&' . list_link_postfix()
                        );
                        ...
                        if ($_POST['type'] == 'review_to') {
                            ...
                            if ($db->query($sql)) {
                                $lnk[] = array(
                                    'text' => $_LANG['back_auction_list'],
                                    'href' => 'auction.php?act=list&seller_list=1&' . list_link_postfix()
                                );
                ...
                if ($_REQUEST['act'] == 'view_log') {
                    ...
                    if ($_REQUEST['act'] == 'add' || $_REQUEST['act'] == 'edit') {
                        ...
                        if ($is_add) {
                            ...
                            $smarty->assign('bid_user_count',
                                sprintf($_LANG['bid_user_count'], $auction['bid_user_count']));
                        }
                        ...
                        if ($_REQUEST['act'] == 'insert' || $_REQUEST['act'] == 'update') {
                            ...
                            $act_desc = isset($_POST['act_desc']) ? preg_replace($preg, '',
                                stripslashes(trim($_POST['act_desc']))) : '';
                            $act_promise = isset($_POST['act_promise']) ? preg_replace($preg, '',
                                stripslashes(trim($_POST['act_promise']))) : '';
                            $dact_ensure = isset($_POST['act_ensure']) ? preg_replace($preg, '',
                                stripslashes(trim($_POST['act_ensure']))) : '';
                            ...
                            $auction = array(
                                ...
                                'act_name' => empty($_POST['act_name']) ? $goods_name : sub_str($_POST['act_name'], 255,
                                    false),
                                'act_desc' => $act_desc,
                                ...
                                'ext_info' => serialize(array(
                                    ...
                                    'end_price' => empty($_POST['no_top']) ? round(floatval($_POST['end_price']),
                                        2) : 0,
                            ...
                            if ($is_add) {
                                ...
                                $db->autoExecute($ecs->table('goods_activity'), $auction, 'UPDATE',
                            ...
                            if ($_REQUEST['act'] == 'toggle_hot') {
                                ...
                                if ($_REQUEST['act'] == 'settle_money') {
                                    ...
                                    $link[] = array(
                                        'text' => $_LANG['go_back'],
                                        'href' => 'auction.php?act=edit&id=' . $id
                                    );
