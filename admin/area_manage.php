...
if ($_REQUEST['act'] == 'list') {
    ...
    if (0 < $region_id) {
        ...
        $action_link = array(
            ...
            'href' => 'area_manage.php?act=list&&pid=' . $parent_id,
            'type' => 1
        );
    } else {
        $action_link = array(
            'text' => $_LANG['create_region_initial'],
            'href' => 'area_manage.php?act=create_region_initial'
        );
    }
    ...
    if ($_REQUEST['act'] == 'restore_region') {
        admin_priv('area_list');
        ...
        if ($_REQUEST['act'] == 'create_region_initial') {
            admin_priv('area_list');
            ...
            if ($_REQUEST['act'] == 'ajax_region_initial') {
