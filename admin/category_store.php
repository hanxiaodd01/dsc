...
if ($_REQUEST['act'] == 'edit') {
    ...
    $smarty->assign('action_link',
        array('text' => $_LANG['03_category_list'], 'href' => 'category_store.php?act=list'));
    ...
    if ($_REQUEST['act'] == 'category_separate') {
        ...
        if ($_REQUEST['act'] == 'category_separate_initial') {
            ...
            if ($result['list']) {
                ...
                $db->autoExecute($ecs->table('merchants_category'), $other, 'UPDATE',
                    'cat_id = \'' . $result['list']['cat_id'] . '\'');
