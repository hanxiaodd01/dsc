...
');
            ...
            if ($_REQUEST['act'] == 'updata') {
                ...
                $temp['config'] = array(
                    ...
                    'level_point_all' => $_POST['level_point_all'],
                    'level_money_all' => $_POST['level_money_all'],
                    'level_register_all' => $_POST['level_register_all'],
                    'level_register_up' => $_POST['level_register_up']
                );
