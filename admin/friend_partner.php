...
function get_links_list()
{
    ...
    while ($rows = $GLOBALS['db']->fetchRow($res)) {
        if (empty($rows['link_logo'])) {
            ...
            if ((strpos($rows['link_logo'], 'http://') === false) && (strpos($rows['link_logo'],
                        'https://') === false)) {
    ...
    if ($_REQUEST['act'] == 'query') {
        ...
        if ($_REQUEST['act'] == 'add') {
            ...
            $smarty->assign('action_link',
                array('href' => 'friend_partner.php?act=list', 'text' => $_LANG['list_link']));
            ...
            if ($_REQUEST['act'] == 'insert') {
                ...
                if ($exc->num('link_name', $link_name) == 0) {
                    ...
                    if (!empty($_POST['url_logo'])) {
                        if ((strpos($_POST['url_logo'], 'http://') === false) && (strpos($_POST['url_logo'],
                                    'https://') === false)) {
                    ...
                    if ((strpos($_POST['link_url'], 'http://') === false) && (strpos($_POST['link_url'],
                                'https://') === false)) {
                    ...
                    sys_msg($_LANG['add'] . '&nbsp;' . stripcslashes($_POST['link_name']) . ' ' . $_LANG['attradd_succed'],
                        0, $link);
                } else {
                ...
                if ($_REQUEST['act'] == 'edit') {
                    ...
                    $smarty->assign('action_link', array(
                        'href' => 'friend_partner.php?act=list&' . list_link_postfix(),
                        'text' => $_LANG['list_link']
                    ));
                    ...
                    if ($_REQUEST['act'] == 'update') {
                        ...
                        sys_msg($_LANG['edit'] . '&nbsp;' . stripcslashes($_POST['link_name']) . '&nbsp;' . $_LANG['attradd_succed'],
                            0, $link);
                    } else {
                        if ($_REQUEST['act'] == 'delPic') {
                            ...
                            if ($_REQUEST['act'] == 'edit_show_order') {
                                ...
                                if ($_REQUEST['act'] == 'remove') {
                                    ...
                                    $url = 'friend_partner.php?act=query&' . str_replace('act=remove', '',
