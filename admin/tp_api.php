...
if (empty($_REQUEST['act'])) {
    ...
    if ($_REQUEST['act'] == 'kdniao') {
        ...
        $api_config['kdniao_account_use'] = get_table_date('shop_config', 'code=\'kdniao_account_use\'', array('value'),
            2);
        $smarty->assign('api_config', $api_config);
        assign_query_info();
        $smarty->display('tp_api.dwt');
    } else {
        if ($_REQUEST['act'] == 'kdniao_update') {
            admin_priv('shop_config');
            ...
            if ($_REQUEST['act'] == 'kdniao_print') {
                ...
                $smarty->assign('kdniao_printer',
                    get_table_date('seller_shopinfo', 'ru_id=\'' . $adminru['ru_id'] . '\'', array('kdniao_printer'),
                        2));
