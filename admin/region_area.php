...
if ($_REQUEST['act'] == 'list') {
    ...
    if ($_REQUEST['act'] == 'query') {
        ...
        make_json_result($smarty->fetch('region_area_list.dwt'), '',
            array('filter' => $region_list['filter'], 'page_count' => $region_list['page_count']));
    } else {
        if ($_REQUEST['act'] == 'add') {
            admin_priv('region_area');
            ...
            $smarty->assign('action_link',
                array('text' => $_LANG['region_list'], 'href' => 'region_area.php?act=list'));
            ...
            if ($_REQUEST['act'] == 'insert') {
                ...
                if ($_REQUEST['act'] == 'edit') {
                    ...
                    $smarty->assign('action_link', array(
                        'text' => $_LANG['region_list'],
                        'href' => 'region_area.php?act=list&' . list_link_postfix()
                    ));
                    ...
                    if ($_REQUEST['act'] == 'update') {
                        ...
                        if (0 < $ra_id || empty($ra_name)) {
                            ...
                            $db->autoExecute($ecs->table('merchants_region_area'), $other, 'UPDATE',
                                'ra_id = \'' . $_POST['id'] . '\'');
