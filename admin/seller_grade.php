...
if ($_REQUEST['act'] == 'list') {
    ...
    if ($_REQUEST['act'] == 'query') {
        ...
        $smarty->assign('record_count', $seller_garde['record_count']);
        $smarty->assign('page_count', $seller_garde['page_count']);
        make_json_result($smarty->fetch('seller_grade_list.dwt'), '',
        ...
        if (($_REQUEST['act'] == 'add') || ($_REQUEST['act'] == 'edit')) {
            ...
            $smarty->assign('action_link',
                array('text' => $_LANG['seller_garde_list'], 'href' => 'seller_grade.php?act=list'));
            ...
            if (($_REQUEST['act'] == 'insert') || ($_REQUEST['act'] == 'update')) {
                ...
                if ($_REQUEST['act'] == 'edit_grade_introduce') {
                    $id = intval($_POST['id']);
                    ...
                    if ($_REQUEST['act'] == 'edit_favorable_rate') {
                        ...
                        if ($_REQUEST['act'] == 'toggle_show') {
                            ...
                            if ($_REQUEST['act'] == 'edit_goods_sun') {
                                check_authz_json('seller_grade');
                                $id = intval($_POST['id']);
                                $order = json_str_iconv(trim($_POST['val']));
                                ...
                                if ($_REQUEST['act'] == 'edit_seller_temp') {
                                    check_authz_json('seller_grade');
                                    $id = intval($_POST['id']);
                                    $order = json_str_iconv(trim($_POST['val']));
                                    ...
                                    if ($_REQUEST['act'] == 'remove') {
                                        ...
                                        $url = 'seller_grade.php?act=query&' . str_replace('act=remove', '',
