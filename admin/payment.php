        ...
        if ($_REQUEST['act'] == 'get_config') {
            ...
            foreach ($data as $key => $value) {
                ...
                if ($data[$key]['type'] == 'text') {
                    if ($data[$key]['name'] == 'alipay_account') {
                        ...
                        if ($data[$key]['name'] == 'tenpay_account') {
            ...
            if ($_REQUEST['act'] == 'edit') {
                ...
                $smarty->assign('action_link',
                    array('text' => $_LANG['02_payment_list'], 'href' => 'payment.php?act=list'));
                ...
                if (isset($_POST['Submit'])) {
                        ...
                        foreach ($pay_config as $k => $v) {
                            ...
                            if (!empty($wxpay_appsecret)) {
                                if ($v['name'] == 'sslcert' && $v['value'] != '') {
                                    file_write_mobile($file_path, md5($wxpay_appsecret) . '_apiclient_cert.pem',
                                        $v['value']);
                                }

                                if ($v['name'] == 'sslkey' && $v['value'] != '') {
                                    file_write_mobile($file_path, md5($wxpay_appsecret) . '_apiclient_key.pem',
                                        $v['value']);
                                }
                            }
                        }
                    ...
                    if ($_REQUEST['act'] == 'uninstall') {
                        ...
                        if ($_REQUEST['act'] == 'edit_desc') {
                            ...
                            if ($_REQUEST['act'] == 'edit_pay_order') {
                                check_authz_json('payment');
                                $code = json_str_iconv(trim($_POST['id']));
