...
if ($_REQUEST['act'] == 'list') {
    ...
    if ($_REQUEST['act'] == 'query') {
        ...
        make_json_result($smarty->fetch('user_address_list_log.dwt'), '',
        ...
        if ($_REQUEST['act'] == 'edit') {
            ...
            $smarty->assign('action_link',
                array('text' => $_LANG['03_users_list'], 'href' => 'user_address_log.php?act=list'));
            ...
            if ($_REQUEST['act'] == 'update') {
                ...
                $db->autoExecute($ecs->table('user_address'), $other, 'UPDATE',
