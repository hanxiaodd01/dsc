...
if ($_REQUEST['act'] == 'shipping_type') {
    ...
    if (empty($cart_goods) || !check_consignee_info($consignee, $flow_type)) {
        ...
        setcookie('done_cookie', $account_cookie, gmtime() + 3600 * 24 * 30, $GLOBALS['cookie_path'],
    ...
    if ($_REQUEST['act'] == 'edit_invoice') {
        ...
        if ($_REQUEST['act'] == 'update_invoicename') {
            ...
            if ($_REQUEST['act'] == 'del_invoicename') {
                ...
                if ($_REQUEST['act'] == 'gotoInvoice') {
                    ...
                    $consignee = get_consignee($user_id);
                    $cart_goods = cart_goods($flow_type, $_SESSION['cart_value']);
                    if (empty($cart_goods) && empty($from) || !check_consignee_info($consignee,
                            $flow_type) && empty($from)) {
                        ...
                        $total = order_fee($order, $cart_goods, $consignee, 0, $_SESSION['cart_value'], 0,
                            $cart_goods_list);
                        $smarty->assign('total', $total);
                    ...
                    if ($_REQUEST['act'] == 'delete_cart_goods') {
                        ...
                        if ($_REQUEST['act'] == 'drop_to_collect') {
                            if (0 < $user_id) {
                                $cart_value = isset($_REQUEST['cart_value']) ? json_str_iconv($_REQUEST['cart_value']) : '';
                            ...
                            if ($_REQUEST['act'] == 'user_order_gotopage') {
                                ...
                                if ($_REQUEST['act'] == 'user_auction_order_gotopage') {
                                    require_once ROOT_PATH . 'languages/' . $_CFG['lang'] . '/user.php';
                                    include_once ROOT_PATH . 'includes/lib_transaction.php';
                                    $id = !empty($_GET['id']) ? json_str_iconv($_GET['id']) : array();
                                    $page = isset($_GET['page']) && 0 < intval($_GET['page']) ? intval($_GET['page']) : 1;
                                    ...
                                    if ($_REQUEST['act'] == 'user_auction_gotopage') {
                                        require_once ROOT_PATH . 'languages/' . $_CFG['lang'] . '/user.php';
                                        include_once ROOT_PATH . 'includes/lib_transaction.php';
                                        $id = !empty($_GET['id']) ? json_str_iconv($_GET['id']) : array();
                                        $page = isset($_GET['page']) && 0 < intval($_GET['page']) ? intval($_GET['page']) : 1;
                                        ...
                                        $auction_list = get_auction_list($user_id, $all_auction, $page, $where,
                                            $auction);
                                        $smarty->assign('lang', $_LANG);
                                        ...
                                        if ($_REQUEST['act'] == 'user_snatch_gotopage') {
                                            require_once ROOT_PATH . 'languages/' . $_CFG['lang'] . '/user.php';
                                            include_once ROOT_PATH . 'includes/lib_transaction.php';
                                            $id = !empty($_GET['id']) ? json_str_iconv($_GET['id']) : array();
                                            $page = isset($_GET['page']) && 0 < intval($_GET['page']) ? intval($_GET['page']) : 1;
                                            ...
                                            $snatch_list = get_snatch_list($user_id, $all_snatch, $page, $where,
                                                $snatch);
                                            $smarty->assign('lang', $_LANG);
                                            ...
                                            if ($_REQUEST['act'] == 'user_inv_gotopage') {
                                                require_once ROOT_PATH . 'languages/' . $_CFG['lang'] . '/user.php';
                                                include_once ROOT_PATH . 'includes/lib_transaction.php';
                                                $id = !empty($_GET['id']) ? json_str_iconv($_GET['id']) : array();
                                                $page = isset($_GET['page']) && 0 < intval($_GET['page']) ? intval($_GET['page']) : 1;
                                                ...
                                                $smarty->assign('action', $order->action);
                                                $smarty->assign('open_delivery_time',
                                                    $GLOBALS['_CFG']['open_delivery_time']);
                                                $result['content'] = $smarty->fetch('library/user_inv_list.lbi');
                                            } else {
                                                if ($_REQUEST['act'] == 'store_shop_gotoPage') {
                                                    ...
                                                    if ($id) {
                                                        ...
                                                        $count = get_store_shop_count($keywords, $sort, $store_province,
                                                            $store_city, $store_district, $store_user, $libType);
                                                        $store_shop_list = get_store_shop_list($libType, $keywords,
                                                            $count, $size, $page, $sort, $order, $region_id, $area_id,
                                                            $area_city, $store_province, $store_city, $store_district,
                                                            $store_user);
                                                    ...
                                                    if ($_REQUEST['act'] == 'wholesale_order_gotopage') {
                                                        ...
                                                        $wholesale_orders = get_wholesale_orders($user_id,
                                                            $record_count, $page);
                                                        $smarty->assign('lang', $_LANG);
                                                        ...
                                                        if ($_REQUEST['act'] == 'getCategoryCallback') {
                                                            ...
                                                            if ($category_topic === false) {
                                                                ...
                                                                if ($category_topic) {
                                                                    write_static_cache($cat_topic_file,
                                                                        $category_topic);
                                                                }
                                                            }
                                                            ...
                                                            if ($_REQUEST['act'] == 'goods_stock_exhausted') {
                                                                $flow_type = isset($_SESSION['flow_type']) ? intval($_SESSION['flow_type']) : CART_GENERAL_GOODS;
                                                                ...
                                                                if (!empty($rec_number)) {
                                                                    $cart_value = get_sc_str_replace($_SESSION['cart_value'],
                                                                        $rec_number, 1);
                                                                    $cart_goods_list = cart_goods($flow_type,
                                                                        $rec_number, 1, $warehouse_id, $area_id,
                                                                        $area_city);
                                                                    $cart_goods_list_new = cart_by_favourable($cart_goods_list);
                                                                    $GLOBALS['smarty']->assign('goods_list',
                                                                        $cart_goods_list_new);
                                                                    $GLOBALS['smarty']->assign('cart_value',
                                                                        $cart_value);
                                                                    $GLOBALS['smarty']->assign('store_seller',
                                                                        $store_seller);
                                                                ...
                                                                if ($_REQUEST['act'] == 'shipping_prompt') {
                                                                    $flow_type = isset($_SESSION['flow_type']) ? intval($_SESSION['flow_type']) : CART_GENERAL_GOODS;
                                                                    ...
                                                                    if ($shipping_prompt) {
                                                                        $cart_value = get_sc_str_replace($_SESSION['cart_value'],
                                                                            $shipping_prompt, 1);
                                                                        $cart_goods_list = cart_goods($flow_type,
                                                                            $shipping_prompt, 1, $warehouse_id,
                                                                            $area_id, $area_city);
                                                                        $cart_goods_list_new = cart_by_favourable($cart_goods_list);
                                                                        $GLOBALS['smarty']->assign('goods_list',
                                                                            $cart_goods_list_new);
                                                                        ...
                                                                        $GLOBALS['smarty']->assign('store_seller',
                                                                            $store_seller);
                                                                        $GLOBALS['smarty']->assign('store_id',
                                                                            $store_id);
                                                                        $result['error'] = 1;
                                                                        $result['cart_value'] = $cart_value;
                                                                    ...
                                                                    if ($_REQUEST['act'] == 'ajax_get_spec') {
                                                                        ...
                                                                        if ($rec_id == 0 || $g_id == 0) {
                                                                            ...
                                                                            $properties = get_goods_properties($g_id,
                                                                                $order_goods['warehouse_id'],
                                                                                $order_goods['area_id'],
                                                                                $order_goods['area_city']);
                                                                            $spec = $properties['spe'];
                                                                                ...
                                                                                foreach ($spec as $key => $value) {
                                                                                    if ($value['values']) {
                                                                                        ...
                                                                                        foreach ($value['values'] as $k => $v) {
                                                                                            $arr_class = get_user_attr_checked($goods_attr,
                                                                                                $v['id']);
                                                                            ...
                                                                            if (!empty($result['attr_val'])) {
                                                                                $result['attr_val'] = substr($result['attr_val'],
                                                                                    0, -1);
                                                                            }
                                                                        }
                                                                    } else {
                                                                        if ($_REQUEST['act'] == 'goods_delivery_area') {
                                                                            ...
                                                                            $GLOBALS['smarty']->assign('province_list',
                                                                                $province_list);
                                                                            $GLOBALS['smarty']->assign('city_list',
                                                                                $city_list);
                                                                            $GLOBALS['smarty']->assign('district_list',
                                                                                $district_list);
                                                                            $GLOBALS['smarty']->assign('goods_id',
                                                                                $goods_id);
                                                                            $GLOBALS['smarty']->assign('warehouse_list',
                                                                                $warehouse_list);
                                                                            $GLOBALS['smarty']->assign('warehouse_name',
                                                                                $warehouse_name);
                                                                            $GLOBALS['smarty']->assign('region_id',
                                                                                $region_id);
                                                                            $GLOBALS['smarty']->assign('user_id',
                                                                                $user_id);
                                                                            $GLOBALS['smarty']->assign('area_id',
                                                                                $area_id);
                                                                            $GLOBALS['smarty']->assign('area_city',
                                                                                $area_city);
                                                                            $GLOBALS['smarty']->assign('merchant_id',
                                                                                $merchant_id);
                                                                            $GLOBALS['smarty']->assign('warehouse_type',
                                                                                $warehouse_type);
                                                                            $consignee_list = get_new_consignee_list($user_id);
                                                                            $GLOBALS['smarty']->assign('consignee_list',
                                                                                $consignee_list);
                                                                            $address_id = $db->getOne('SELECT address_id FROM ' . $ecs->table('users') . (' WHERE user_id = \'' . $user_id . '\''));
                                                                            $GLOBALS['smarty']->assign('address_id',
                                                                                $address_id);
                                                                            $province_row = get_region_info($province_id);
                                                                            $city_row = get_region_info($city_id);
                                                                            $district_row = get_region_info($district_id);
                                                                            $GLOBALS['smarty']->assign('province_row',
                                                                                $province_row);
                                                                            $GLOBALS['smarty']->assign('city_row',
                                                                                $city_row);
                                                                            $GLOBALS['smarty']->assign('district_row',
                                                                                $district_row);
                                                                            $GLOBALS['smarty']->assign('show_warehouse',
                                                                                $GLOBALS['_CFG']['show_warehouse']);
                                                                            ...
                                                                            if ($_REQUEST['act'] == 'user_area_shipping') {
                                                                                $_POST['area'] = strip_tags(urldecode($_POST['area']));
                                                                                $_POST['area'] = json_str_iconv($_POST['area']);
                                                                                ...
                                                                                if ($_REQUEST['act'] == 'get_store_list') {
                                                                                    ...
                                                                                    if (!empty($seller_store)) {
                                                                                        foreach ($seller_store as $k => $v) {
                                                                                            if (is_spec($is_spec) == true) {
                                                                                                $products = get_warehouse_id_attr_number($v['goods_id'],
                                                                                                    $spec_arr,
                                                                                                    $v['ru_id'], 0, 0,
                                                                                                    0, '', $v['id']);
                                                                                    ...
                                                                                    if ($type == 'flow') {
                                                                                        ...
                                                                                        if ($type == 'store_select_shop') {
                                                                                            $smarty->assign('area_position_list',
                                                                                                $seller_store);
                                                                                    ...
                                                                                    if ($_REQUEST['act'] == 'all_stores_list') {
                                                                                        $goods_id = !empty($_REQUEST['goods_id']) ? intval($_REQUEST['goods_id']) : 0;
                                                                                        ...
                                                                                        if ($_REQUEST['act'] == 'getInfo') {
                                                                                            ...
                                                                                            $row = $db->getRow($sql);
                                                                                            $result['t_img'] = !empty($row['attr_gallery_flie']) ? get_image_path(0,
                                                                                                $row['attr_gallery_flie']) : '';
                                                                                        } else {
                                                                                            if ($_REQUEST['act'] == 'price_notice') {
                                                                                                $result = array(
                                                                                                    'msg' => '',
                                                                                                    'status' => ''
                                                                                                );
                                                                                                ...
                                                                                                if ($_REQUEST['act'] == 'getguessYouLike') {
                                                                                                    $result = array(
                                                                                                        'error' => 0,
                                                                                                        'content' => '',
                                                                                                        'message' => ''
                                                                                                    );
                                                                                                    $goods_ids = isset($_REQUEST['goods_ids']) && !empty($_REQUEST['goods_ids']) ? dsc_addslashes(trim($_REQUEST['goods_ids']),
                                                                                                        0) : '';
                                                                                                    $warehouse_id = isset($_REQUEST['warehouse_id']) && !empty($_REQUEST['warehouse_id']) ? intval($_REQUEST['warehouse_id']) : 0;
                                                                                                    $area_id = isset($_REQUEST['area_id']) && !empty($_REQUEST['area_id']) ? intval($_REQUEST['area_id']) : 0;
                                                                                                    $area_city = isset($_REQUEST['area_city']) && !empty($_REQUEST['area_city']) ? intval($_REQUEST['area_city']) : 0;
                                                                                                    ...
                                                                                                    if ($goods_ids) {
                                                                                                        $goods_list = get_floor_ajax_goods(0,
                                                                                                            0,
                                                                                                            $warehouse_id,
                                                                                                            $area_id,
                                                                                                            $area_city,
                                                                                                    ...
                                                                                                    if ($_REQUEST['act'] == 'checked_article_cat') {
                                                                                                        $result = array(
                                                                                                            'error' => 0,
                                                                                                            'content' => '',
                                                                                                            'message' => ''
...
if (!empty($_REQUEST['act']) && $_REQUEST['act'] == 'in_stock') {
    ...
    setcookie('flow_region', $flow_warehouse['region_id'], gmtime() + 3600 * 24 * 30, $GLOBALS['cookie_path'],
        $GLOBALS['cookie_domain']);
    exit($json->encode($res));
} else {
    if ($_REQUEST['act'] == 'cat_store_list') {
        ...
        if ($_REQUEST['act'] == 'merchants_article') {
            ...
            if ($_REQUEST['act'] == 'getUserInfo') {
                ...
                if ($_REQUEST['act'] == 'flow_shipping') {
                        ...
                        foreach ($arr as $key => $row) {
                            ...
                            foreach ($row as $rckey => $rcrow) {
                                ...
                                if ($list && $list[3]) {
                                    ...
                                    if ($list[2] == 2) {
                                        $shipping_code = get_table_date('shipping',
                                            'shipping_id=\'' . $shipping_id . '\'', array('shipping_code'), 2);
                    ...
                    if ($_REQUEST['act'] == 'sdt_place') {
                        $cart_value = isset($_REQUEST['cart_value']) && !empty($_REQUEST['cart_value']) ? dsc_addslashes($_REQUEST['cart_value'],
                            0) : 0;
                        $warehouse_id = isset($_REQUEST['warehouse_id']) && !empty($_REQUEST['warehouse_id']) ? intval($_REQUEST['warehouse_id']) : 0;
                        $area_id = isset($_REQUEST['area_id']) && !empty($_REQUEST['area_id']) ? intval($_REQUEST['area_id']) : 0;
                        $store_id = isset($_REQUEST['store_id']) && !empty($_REQUEST['store_id']) ? intval($_REQUEST['store_id']) : 0;
                        ...
                        if ($_REQUEST['act'] == 'get_login_dialog') {
                            require_once ROOT_PATH . 'languages/' . $_CFG['lang'] . '/user.php';
                                ...
                                if ($_REQUEST['act'] == 'del_topictemplates') {
                                    ...
                                    if ($_REQUEST['act'] == 'del_sellertemplates') {
                                        ...
                                        if ($_REQUEST['act'] == 'goods_collection') {
                                            ...
                                            if ($_REQUEST['act'] == 'goods_collect_store') {
                                                ...
                                                if ($_REQUEST['act'] == 'ajax_send_mail') {
                                                    ...
                                                    if (!empty($auto_sms)) {
                                                        ...
                                                        $smarty->assign('send_date',
                                                            local_date($_CFG['time_format'], gmtime()));
                                                        $content = $smarty->fetch('str:' . $tpl['template_content']);
                                                        send_mail($_CFG['shop_name'], $service_email,
                                                            $tpl['template_subject'], $content, $tpl['is_html']);
                                                    }
                                                } else {
                                                    if ($_REQUEST['act'] == 'ajax_captcha') {
                                                        $result = true;
                                                        $captcha_str = isset($_REQUEST['captcha']) ? trim($_REQUEST['captcha']) : '';
                                                        $seKey = !empty($_GET['seKey']) ? $_GET['seKey'] : '';
                                                        $verify = new Verify();
                                                        $captcha_code = $verify->check($captcha_str, $seKey, '',
                                                            'ajax');
                                                        ...
                                                        if ($_REQUEST['act'] == 'see_more_goods') {
                                                            $goods_id = isset($_REQUEST['goods_id']) && !empty($_REQUEST['goods_id']) ? intval($_REQUEST['goods_id']) : 0;
                                                            $seller_id = isset($_REQUEST['seller_id']) && !empty($_REQUEST['seller_id']) ? intval($_REQUEST['seller_id']) : 0;
                                                            ...
                                                            $area_id = isset($_REQUEST['area_id']) && !empty($_REQUEST['area_id']) ? intval($_REQUEST['area_id']) : 0;
                                                            $area_city = isset($_REQUEST['area_city']) && !empty($_REQUEST['area_city']) ? intval($_REQUEST['area_city']) : 0;
                                                            $see_more_goods = read_static_cache('see_more_goods_' . $cat_id . '_' . $warehouse_id . '_' . $area_id,
                                                                '/temp/static_caches/');

                                                            if ($see_more_goods === false) {
                                                                $top_cat = get_topparent_cat($cat_id);
                                                                $see_more_goods = get_filter_goods_list(array('cat_ids' => $top_cat['cat_id']),
                                                                    5, 1, 'click_count', 'DESC', $warehouse_id,
                                                                    $area_id, $area_city, 'goods');
                                                                write_static_cache('see_more_goods_' . $cat_id . '_' . $warehouse_id . '_' . $area_id,
                                                                    $see_more_goods, '/temp/static_caches/');
                                                            }

                                                            $smarty->assign('see_more_goods', $see_more_goods);
                                                            $result['content'] = $GLOBALS['smarty']->fetch('library/see_more_goods.lbi');
                                                        } else {
                                                            if ($_REQUEST['act'] == 'see_more_presale') {
                                                                $goods_id = isset($_REQUEST['goods_id']) && !empty($_REQUEST['goods_id']) ? intval($_REQUEST['goods_id']) : 0;
                                                                $cat_id = isset($_REQUEST['cat_id']) && !empty($_REQUEST['cat_id']) ? intval($_REQUEST['cat_id']) : 0;
                                                                ...
                                                                if ($_REQUEST['act'] == 'guess_goods_love') {
                                                                    $warehouse_id = isset($_REQUEST['warehouse_id']) && !empty($_REQUEST['warehouse_id']) ? intval($_REQUEST['warehouse_id']) : 0;
                                                                    $area_id = isset($_REQUEST['area_id']) && !empty($_REQUEST['area_id']) ? intval($_REQUEST['area_id']) : 0;
                                                                    $area_city = isset($_REQUEST['area_city']) && !empty($_REQUEST['area_city']) ? intval($_REQUEST['area_city']) : 0;
                                                                    $guess_goods = get_guess_goods($user_id, 1, 1, 7,
                                                                        $warehouse_id, $area_id, $area_city);
                                                                    $smarty->assign('guess_goods', $guess_goods);
                                                                    $result['content'] = $GLOBALS['smarty']->fetch('library/guess_goods_love.lbi');
                                                                } else {
                                                                    if ($_REQUEST['act'] == 'ajax_Homeindex_Bonusadv') {
                                                                        ...
                                                                        $bonusadv = getleft_attr('bonusadv', 0, $suffix,
                                                                            $GLOBALS['_CFG']['template']);

                                                                        if ($bonusadv['img_file']) {
                                                                            $bonusadv['img_file'] = get_image_path(0,
                                                                                $bonusadv['img_file']);

                                                                            if (strpos($bonusadv['img_file'],
                                                                                    $_COOKIE['index_img_file']) !== false) {
                                                                                if ($_COOKIE['bonusadv'] == 1) {
                                                                                    $bonusadv['img_file'] = '';
                                                                                } else {
                                                                                    if ($bonusadv['img_file']) {
                                                                                        setcookie('bonusadv', 1,
                                                                                            gmtime() + 3600 * 10,
                                                                                            $GLOBALS['cookie_path'],
                                                                                            $GLOBALS['cookie_domain']);
                                                                                        setcookie('index_img_file',
                                                                                            $bonusadv['img_file'],
                                                                                            gmtime() + 3600 * 10,
                                                                                            $GLOBALS['cookie_path'],
                                                                                            $GLOBALS['cookie_domain']);
                                                                        ...
                                                                        if ($_REQUEST['act'] == 'checked_home_rank') {
                                                                            ...
                                                                            if ($activitytype == 'is_new' || $activitytype == 'is_best' || $activitytype == 'is_hot') {
                                                                                $goods_list = $goods_list = get_floor_ajax_goods(0,
                                                                                    6, $warehouse_id, $area_id,
                                                                                    $area_city, $goodsids, 0,
                                                                                    $activitytype);
                                                                            } else {
                                                                                $where = ' WHERE 1 ';
                                                                                $leftjoin = '';
                                                                                ...
                                                                                if ($activitytype == 'exchange') {
                                                                                    ...
                                                                                    if ($activitytype == 'presale') {
                                                                                        ...
                                                                                        if ($activitytype == 'snatch') {
                                                                                            ...
                                                                                            if ($activitytype == 'auction') {
                                                                                                $act_type = GAT_AUCTION;
                                                                                            } else {
                                                                                                if ($activitytype == 'group_buy') {
                                                                            ...
                                                                            $smarty->assign('goods_list', $goods_list);
                                                                            $smarty->assign('activitytype',
                                                                                $activitytype);
                                                                            $smarty->assign('type', 'home_rank');
                                                                            $result['content'] = $GLOBALS['smarty']->fetch('library/guessYouLike_list.lbi');
                                                                        } else {
                                                                            if ($_REQUEST['act'] == 'check_kefu') {
                                                                                $result['content'] = is_dir(__DIR__ . '/kefu') ? 1 : 0;
                                                                            } else {
                                                                                if ($_REQUEST['act'] == 'edit_wholesale_invoice') {
                                                                                    ...
                                                                                    $flow_type = isset($_SESSION['flow_type']) ? intval($_SESSION['flow_type']) : CART_GENERAL_GOODS;
                                                                                    $consignee = get_consignee($user_id);
                                                                                    $cart_goods = wholesale_cart_goods(0,
                                                                                        $_SESSION['cart_value']);
                                                                                    if (empty($cart_goods) && empty($from) || !check_consignee_info($consignee,
                                                                                            $flow_type) && empty($from)) {
                                                                                        $result['error'] = 1;
                                                                                        ...
                                                                                        if ((!isset($_CFG['can_invoice']) || $_CFG['can_invoice'] == '1') && isset($_CFG['invoice_content']) && trim($_CFG['invoice_content']) != '' && $flow_type != CART_EXCHANGE_GOODS) {
                                                                                            ...
                                                                                            $smarty->assign('inv_content_list',
                                                                                                $inv_content_list);
                                                                                            $inv_type_list = array();
                                                                                            ...
                                                                                            $sql = 'SELECT * FROM ' . $ecs->table('order_invoice') . (' WHERE user_id=\'' . $user_id . '\' LIMIT 10');
                                                                                            $order_invoice = $db->getAll($sql);
                                                                                            $smarty->assign('order_invoice',
                                                                                                $order_invoice);
                                                                                            $smarty->assign('inv_type_list',
                                                                                                $inv_type_list);
                                                                                            ...
                                                                                            if ($vat_info = $db->getRow($sql)) {
                                                                                                $smarty->assign('vat_info',
                                                                                                    $vat_info);
                                                                                                $smarty->assign('audit_status',
                                                                                                    $vat_info['audit_status']);
                                                                                            }
                                                                                        }

                                                                                        $smarty->assign('invoice_type',
                                                                                            $invoice_type);
                                                                                    ...
                                                                                    if ($_REQUEST['act'] == 'wholesale_gotoInvoice') {
                                                                                        require_once 'includes/lib_wholesale.php';
                                                                                        require_once 'includes/lib_suppliers.php';
                                                                                        $result = array(
                                                                                            'error' => '',
                                                                                        ...
                                                                                        if ($_REQUEST['act'] == 'wholesale_order_gotopage') {
                                                                                            ...
                                                                                            $order->action = 'order_list';
                                                                                            $orders = get_wholesale_orders($user_id,
                                                                                                $record_count, $page,
                                                                                                $where, $order);
                                                                                            $smarty->assign('lang',
                                                                                                $_LANG);
