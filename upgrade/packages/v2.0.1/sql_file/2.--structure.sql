ALTER TABLE  `dsc_merchants_shop_information` ADD  `self_run` TINYINT( 1 ) UNSIGNED NOT NULL DEFAULT  '0' COMMENT  '��Ӫ����';

ALTER TABLE `dsc_goods` ADD `goods_unit` VARCHAR( 15 ) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '��';
...
CREATE TABLE IF NOT EXISTS `dsc_source_ip` (
  ...
  `ipdata` varchar(16) NOT NULL COMMENT '�����ߵ�IP',
  `iptime` varchar(30) NOT NULL COMMENT '����ʱ��',
  PRIMARY KEY (`ipid`)
