    ...
    foreach ($arr as $key => $val) {
        ...
        if (0 < intval($GLOBALS['_CFG']['use_storage']) && $goods['extension_code'] != 'package_buy') {
            if ($row['goods_number'] < $val) {
                show_message(sprintf($GLOBALS['_LANG']['stock_insufficiency'], $row['goods_name'], $row['goods_number'],
                    $row['goods_number']));
                exit();
            }
            ...
            if (!empty($goods['product_id'])) {
                ...
                if ($product_number < $val) {
                    show_message(sprintf($GLOBALS['_LANG']['stock_insufficiency'], $row['goods_name'], $product_number,
                        $product_number));
                    exit();
                }
            }
    ...
    foreach ($arr as $key => $val) {
        ...
        if (0 < intval($GLOBALS['_CFG']['use_storage']) && $goods['extension_code'] != 'package_buy' && $store_id == 0 && $row['cloud_id'] == 0) {
            ...
            if (0 < intval($GLOBALS['_CFG']['use_storage']) && 0 < $store_id && $row['cloud_id'] == 0) {
                ...
                $products = get_warehouse_id_attr_number($row['goods_id'], $row['goods_attr_id'], $goodsInfo['ru_id'],
                    0, 0, 0, '', $store_id);
    ...
    foreach ($merchant_goods as $key => $row) {
        ...
        if ($row['ru_id'] == $ru_id) {
            foreach ($user_cart_goods as $key1 => $row1) {
                ...
                if (!empty($act_sel_id)) {
                    $row1['sel_checked'] = strstr(',' . $act_sel_id['act_sel_id'] . ',',
                        ',' . $row1['rec_id'] . ',') ? 1 : 0;
                }
                        ...
                        if ($row1 && $favourable_activity['act_id'] == $row1['act_id']) {
                            ...
                            switch ($favourable_activity['act_type']) {
                                ...
                                case 1:
                                    ...
                                    $favourable_box['act_type_ext_format'] = number_format($favourable_activity['act_type_ext'],
                                        2);
                                    break;
                            ...
                            $favourable_box['favourable_used'] = favourable_used($favourable_activity,
                                $cart_favourable);
                ...
                if ($favourable_activity['act_range'] == FAR_CATEGORY && $row1['extension_code'] != 'package_buy') {
                    ...
                    $list_array = !empty($list_array) ? array_merge($get_act_range_ext,
                        $list_array) : $get_act_range_ext;
                    $id_list = arr_foreach($list_array);
                    $id_list = array_unique($id_list);
                    $cat_id = $row1['cat_id'];
                    if (in_array(trim($cat_id),
                            $id_list) && $row1['is_gift'] == 0 || $row1['is_gift'] == $favourable_activity['act_id']) {
                        if ($row1) {
                            $fav_act_range_ext = !empty($favourable_activity['act_range_ext']) ? explode(',',
                                $favourable_activity['act_range_ext']) : array();
                            ...
                            if ($row1['is_gift'] == 0 && in_array($cat_id,
                                    $fav_act_range_ext) && $favourable_activity['act_id'] == $row1['act_id']) {
                                $favourable_box['act_id'] = $favourable_activity['act_id'];
                                $favourable_box['act_name'] = $favourable_activity['act_name'];
                                $favourable_box['act_type'] = $favourable_activity['act_type'];
                                ...
                                $row1['favourable_list'] = get_favourable_info($row1['goods_id'], $row1['ru_id'],
                                    $row1);
                                $favourable_box['act_goods_list'][$row1['rec_id']] = $row1;
                ...
                if ($favourable_activity['act_range'] == FAR_BRAND && $row1['extension_code'] != 'package_buy') {
                    ...
                    if (in_array(trim($brand_id),
                            $get_act_range_ext) && $row1['is_gift'] == 0 || $row1['is_gift'] == $favourable_activity['act_id']) {
                        if ($row1) {
                            $act_range_ext_str = ',' . $favourable_activity['act_range_ext'] . ',';
                            $brand_id_str = ',' . $brand_id . ',';
                            if ($row1['is_gift'] == 0 && strstr($act_range_ext_str,
                                    trim($brand_id_str)) && $favourable_activity['act_id'] == $row1['act_id']) {
                                $favourable_box['act_id'] = $favourable_activity['act_id'];
                                $favourable_box['act_name'] = $favourable_activity['act_name'];
                                $favourable_box['act_type'] = $favourable_activity['act_type'];
                ...
                if ($favourable_activity['act_range'] == FAR_GOODS && $row1['extension_code'] != 'package_buy') {
                    ...
                    if (in_array($row1['goods_id'],
                            $get_act_range_ext) || $row1['is_gift'] == $favourable_activity['act_id']) {
                        if ($row1) {
                            $act_range_ext_str = ',' . $favourable_activity['act_range_ext'] . ',';
                            $goods_id_str = ',' . $row1['goods_id'] . ',';
                            if (strstr($act_range_ext_str,
                                    trim($goods_id_str)) && $row1['is_gift'] == 0 && $favourable_activity['act_id'] == $row1['act_id']) {
                                $favourable_box['act_id'] = $favourable_activity['act_id'];
                                $favourable_box['act_name'] = $favourable_activity['act_name'];
                                $favourable_box['act_type'] = $favourable_activity['act_type'];
            ...
            foreach ($row as $k => $v) {
                if (1 < $v) {
                    ...
                    if (!empty($ogoods_attr_id)) {
                        $products = get_warehouse_id_attr_number($ogoods_id, $ogoods_attr_id, 0, $owarehouse_id,
                            $oarea_id);
...
');
    ...
    if (empty($goods->spec) && empty($goods->quick)) {
        ...
        if (!empty($res)) {
            ...
            $shop_price = get_final_price($goods->goods_id, 1, true, $attr_id, $warehouse_id, $area_id, $area_city, 0,
                0, $add_tocart);
            ...
            $goods = get_goods_info($goods->goods_id, $warehouse_id, $area_id, $area_city,
                array('is_xiangou', 'xiangou_num', 'xiangou_start_date', 'xiangou_end_date'));
            $user_id = !empty($_SESSION['user_id']) ? $_SESSION['user_id'] : 0;
    ...
    if (!is_numeric($goods->number) || intval($goods->number) <= 0) {
        ...
        if (addto_cart($goods->goods_id, $goods->number, $goods->spec, $goods->parent, $warehouse_id, $area_id,
            $area_city, $goods->stages_qishu, $goods->store_id, $goods->end_time, $goods->store_mobile)) {
            if (!empty($goods->divId)) {
                $result['divId'] = $goods->divId;
            }
    ...
    if ($_REQUEST['step'] == 'add_to_cart_showDiv') {
        include_once 'includes/cls_json.php';
        $_POST['goods'] = strip_tags(urldecode($_POST['goods']));
        $_POST['goods'] = json_str_iconv($_POST['goods']);
        if (!empty($_REQUEST['goods_id']) && empty($_POST['goods'])) {
...
');
        ...
        if (!is_numeric($goods->number) || intval($goods->number) <= 0) {
            ...
            if ($xiangouInfo['is_xiangou'] == 1 && $start_date < $nowTime && $nowTime < $end_date) {
                ...
                if ($xiangouInfo['xiangou_num'] <= $orderGoods['goods_number']) {
                    $result['error'] = 1;
                    $max_num = $xiangouInfo['xiangou_num'] - $orderGoods['goods_number'];
                    $result['message'] = sprintf($_LANG['purchasing_prompt'],
                        get_table_date('goods', 'goods_id=\'' . $goods->goods_id . '\'', array('goods_name'), 2));
                    $result['show_info'] = '';
                    exit($json->encode($result));
                } else {
                    if (0 < $xiangouInfo['xiangou_num']) {
            ...
            if (addto_cart($goods->goods_id, $goods->number, $goods->spec, $goods->parent, $goods->warehouse_id,
                $goods->area_id, $area_city, $goods->stages_qishu)) {
                if (2 < $_CFG['cart_confirm']) {
                    $result['message'] = '';
                } else {
                    $result['message'] = $_CFG['cart_confirm'] == 1 ? $_LANG['addto_cart_success_1'] : $_LANG['addto_cart_success_2'];
        ...
        $result['show_info'] = insert_show_div_info($result['goods_number'], $result['script_name'],
            $result['goods_id'], $result['goods_recommend'], $cart_goods['total']['goods_amount'],
            $cart_goods['total']['real_goods_count']);
        ...
        if ($_REQUEST['step'] == 'add_to_cart_combo') {
            include_once 'includes/cls_json.php';
            $_POST['goods'] = strip_tags(urldecode($_POST['goods']));
            $_POST['goods'] = json_str_iconv($_POST['goods']);
            if (!empty($_REQUEST['goods_id']) && empty($_POST['goods'])) {
...
');
            ...
            if (!is_numeric($goods->number) || intval($goods->number) <= 0) {
                ...
                if (addto_cart_combo($goods->goods_id, $goods->number, $goods->spec, $goods->parent, $goods->group,
                    $goods->warehouse_id, $goods->area_id, $goods->area_city, $goods->goods_attr)) {
                    if (2 < $_CFG['cart_confirm']) {
                        $result['message'] = '';
                    } else {
                        $result['message'] = $_CFG['cart_confirm'] == 1 ? $_LANG['addto_cart_success_1'] : $_LANG['addto_cart_success_2'];
                    ...
                    $combo_goods_info = get_combo_goods_info($goods->goods_id, $goods->number, $goods->spec,
                        $goods->parent, $warehouse_area);
            ...
            if ($fittings_interval['return_attr'] < 1) {
                ...
                $result['fittings_minMax'] = price_format($fittings_interval['fittings_min']) . '-' . number_format($fittings_interval['fittings_max'],
                        2, '.', '');
                $result['market_minMax'] = price_format($fittings_interval['market_min']) . '-' . number_format($fittings_interval['market_max'],
                        2, '.', '');
                ...
                if ($fittings_interval['save_minPrice'] == $fittings_interval['save_maxPrice']) {
                    ...
                    $result['save_minMaxPrice'] = price_format($fittings_interval['save_minPrice']) . '-' . number_format($fittings_interval['save_maxPrice'],
                            2, '.', '');
                }
            }
            ...
            if ($_REQUEST['step'] == 'del_in_cart_combo') {
                include_once 'includes/cls_json.php';
                $_POST['goods'] = strip_tags(urldecode($_POST['goods']));
                $_POST['goods'] = json_str_iconv($_POST['goods']);
                if (!empty($_REQUEST['goods_id']) && empty($_POST['goods'])) {
...
');
                ...
                if (empty($combo_goods['shop_price'])) {
                    $shop_price = get_final_price($goods->parent, 1, true, $goods->goods_attr, $goods->warehouse_id,
                ...
                if ($_REQUEST['step'] == 'add_to_cart_group') {
                    include_once 'includes/cls_json.php';
                    $_POST['goods'] = strip_tags(urldecode($_POST['goods']));
                    $_POST['goods'] = json_str_iconv($_POST['goods']);
                    $result = array('error' => 0, 'message' => '');
                    ...
                    if ($_REQUEST['step'] == 'add_cart_combo_list') {
                        include_once 'includes/cls_json.php';
                        ...
                        $fittings_top = get_goods_fittings(array($goods_id), $warehouse_id, $area_id, $area_city,
                            $goods[2], 2);
                        ...
                        if ($goodSEqual) {
                            ...
                            $fittings = get_goods_fittings(array($goods_id), $warehouse_id, $area_id, $area_city, $rev,
                                1, $goodSEqual);
                            $fittings = array_merge($goods_info, $fittings);
                            $fittings = array_values($fittings);
                            ...
                            if ($list_select == 1) {
                                ...
                                $result['goods_amount'] = price_format($fittings_interval['fittings_min']) . '-' . number_format($fittings_interval['fittings_max'],
                                        2, '.', '');

                                if ($fittings_interval['save_minPrice'] == $fittings_interval['save_maxPrice']) {
                                    $result['save_amount'] = price_format($fittings_interval['save_minPrice']);
                                } else {
                                    $result['save_amount'] = price_format($fittings_interval['save_minPrice']) . '-' . number_format($fittings_interval['save_maxPrice'],
                                            2, '.', '');
                                }

                                $result['goods_market_amount'] = price_format($fittings_interval['market_min']) . '-' . number_format($fittings_interval['market_max'],
                                        2, '.', '');
                            }
                            ...
                            if (0 < $combo_goods['combo_number']) {
                                $goods_info = get_goods_fittings_info($goods_id, $warehouse_id, $area_id, $area_city,
                                    $rev);
...
if ($_REQUEST['step'] == 'add_cart_combo_goodsAttr') {
    ...
    if ($goods_id == 0) {
        ...
        $shop_price = get_final_price($goods_id, $number, true, $attr_id, $warehouse_id, $area_id, $area_city, 0, 0,
            $add_tocart);
        $prod_attr = array();
        ...
        $GLOBALS['db']->autoExecute($GLOBALS['ecs']->table('cart_combo'), $parent, 'UPDATE',
            'group_id = \'' . $group_id . '\' AND goods_id = \'' . $goods_id . '\' AND ' . $sess_id);
        ...
        $goods_info = get_goods_fittings_info($goodsRow[3], $warehouse_id, $area_id, $area_city, $group_id, 0,
            $fittings_goods, $fittings_attr);
        $fittings = get_goods_fittings(array($goodsRow[3]), $warehouse_id, $area_id, $area_city, $group_id, 1,
            $goodSEqual);
        $fittings = array_merge($goods_info, $fittings);
        $fittings = array_values($fittings);
        $fittings_interval = get_choose_goods_combo_cart($fittings);
    ...
    if ($_REQUEST['step'] == 'add_del_cart_combo_list') {
        include_once 'includes/cls_json.php';
        $_POST['group'] = strip_tags(urldecode($_POST['group']));
        $_POST['group'] = json_str_iconv($_POST['group']);
        $result = array('error' => 0, 'message' => '', 'content' => '', 'goods_id' => '');
...
');
                        ...
                        if ($_REQUEST['step'] == 'checkout') {
                            ...
                            setcookie('done_cookie', $account_cookie, gmtime() + 3600 * 24 * 30,
                            ...
                            if ($store_order) {
                                ...
                                foreach ($cart_value_array as $key => $val) {
                                    $cart_goods_info = get_table_date('cart', 'rec_id=\'' . $val . '\'',
                                        array('goods_id'));
                                ...
                                if (!empty($store_ids_set)) {
                                    ...
                                    $db->autoExecute($ecs->table('cart'), array('store_id' => $store_id), 'UPDATE',
                                        'rec_id' . db_create_in($cart_value));
                                } else {
...
');
                            ...
                            if ($consignee) {
                                ...
                                setcookie('district', $consignee['district'], gmtime() + 3600 * 24 * 30,
                                    $GLOBALS['cookie_path'], $GLOBALS['cookie_domain']);
                                setcookie('street', $consignee['street'], gmtime() + 3600 * 24 * 30,
                                    $GLOBALS['cookie_path'], $GLOBALS['cookie_domain']);
                                setcookie('street_area', '', gmtime() + 3600 * 24 * 30, $GLOBALS['cookie_path'],
                            ...
                            $cart_goods_list = cart_goods($flow_type, $cart_value, 1, $region_id,
                                $area_info['region_id'], $area_city['region_id'], $consignee, $store_id);
...
', '', $_CFG['invoice_content']));
                            ...
                            if ($flow_type != CART_EXCHANGE_GOODS && $flow_type != CART_GROUP_BUY_GOODS) {
                                ...
                                $smarty->assign('your_discount', sprintf($_LANG['your_discount'], $favour_name,
                                    price_format($discount['discount'])));
                            }
                            ...
                            $total = order_fee($order, $cart_goods, $consignee, 0, $cart_value, 0, $cart_goods_list, 0,
                                0, $store_id, $store_seller);
                            $smarty->assign('total', $total);
                            $smarty->assign('shopping_money',
                                sprintf($_LANG['shopping_money'], $total['formated_goods_price']));
                            $smarty->assign('market_price_desc',
                                sprintf($_LANG['than_market_price'], $total['formated_market_price'],
                                    $total['formated_saving'], $total['save_rate']));
                            ...
                            if ((!isset($_CFG['use_integral']) || $_CFG['use_integral'] == '1') && 0 < $_SESSION['user_id'] && 0 < $user_info['pay_points'] && ($flow_type != CART_GROUP_BUY_GOODS && $flow_type != CART_EXCHANGE_GOODS)) {
                                ...
                                $smarty->assign('order_max_integral',
                                    flow_available_points($cart_value, $region_id, $area_id, $area_city));
                            ...
                            if ((!isset($_CFG['use_bonus']) || $_CFG['use_bonus'] == '1') && ($flow_type != CART_GROUP_BUY_GOODS && $flow_type != CART_EXCHANGE_GOODS)) {
                                $user_bonus = user_bonus($_SESSION['user_id'], $total['goods_price'], $cart_value,
                                    $total['seller_amount'], $cart_ru_id);

                                if (!empty($user_bonus)) {
                                    foreach ($user_bonus as $key => $val) {
                                        $user_bonus[$key]['bonus_money_formated'] = price_format($val['type_money'],
                                            false);

                                        if (defined('THEME_EXTENSION')) {
                                            $bonus_ids[] = $val['bonus_id'];
                                            $user_bonus[$key]['use_end_date'] = local_date('Y-m-d',
                                                $val['use_end_date']);
                                        }
                                    }
                                ...
                                if (defined('THEME_EXTENSION')) {
                                    $bonus = get_user_bouns_new_list($_SESSION['user_id'], 1, 0,
                                        'bouns_available_gotoPage', 0, 20, $cart_ru_id);
                            ...
                            if ($_CFG['use_value_card'] == '1' && $flow_type != CART_EXCHANGE_GOODS) {
                                ...
                                if (!empty($value_card)) {
                                    foreach ($value_card as $key => $val) {
                                        $value_card[$key]['card_money_formated'] = price_format($val['card_money'],
                                            false);
                                    }
                            ...
                            if ($_CFG['use_coupons'] == 1 && $flow_type == CART_GENERAL_GOODS) {
                                $user_coupons = get_user_coupons_list($_SESSION['user_id'], true, $total['goods_price'],
                                    $cart_goods, true, $cart_ru_id, '', $consignee['province']);

                                if (defined('THEME_EXTENSION')) {
                                    $coupons_list = get_user_coupons_list($_SESSION['user_id'], true, '', false, true,
                                        $cart_ru_id, 'cart');
                            ...
                            if ($_REQUEST['step'] == 'select_shipping') {
                                ...
                                if (empty($cart_goods) || !check_consignee_info($consignee, $flow_type)) {
                                    ...
                                    $smarty->assign('total', $total);
                                    $smarty->assign('total_integral', cart_amount(false, $flow_type,
                                            $_SESSION['cart_value']) - $total['bonus'] - $total['integral_money']);
                                ...
                                if ($_REQUEST['step'] == 'select_insure') {
                                    ...
                                    if (empty($cart_goods) || !check_consignee_info($consignee, $flow_type)) {
                                        ...
                                        $_SESSION['flow_order'] = $order;
                                        $cart_goods_number = get_buy_cart_goods_number($flow_type,
                                            $_SESSION['cart_value']);
                                        $smarty->assign('cart_goods_number', $cart_goods_number);
                                        $consignee['province_name'] = get_goods_region_name($consignee['province']);
                                        $consignee['city_name'] = get_goods_region_name($consignee['city']);
                                        ...
                                        $total = order_fee($order, $cart_goods, $consignee, 0, $_SESSION['cart_value'],
                                            0, $cart_goods_list);
                                        $smarty->assign('total', $total);
                                        $smarty->assign('total_integral', cart_amount(false, $flow_type,
                                                $_SESSION['cart_value']) - $total['bonus'] - $total['integral_money']);
                                    ...
                                    if ($_REQUEST['step'] == 'pickSite') {
                                        ...
                                        if ($mark == 1) {
                                            ...
                                            for ($i = 0; $i <= 6; $i++) {
                                                $days[$i]['shipping_date'] = date('Y-m-d',
                                                    strtotime(' +' . $i . 'day'));
                                        ...
                                        if ($_REQUEST['step'] == 'getPickSiteList') {
                                            include_once 'includes/cls_json.php';
                ...
                LEFT JOIN ' . $GLOBALS['ecs']->table('region') . ' AS b ON a.region_id=b.region_id  LEFT JOIN ' . $GLOBALS['ecs']->table('shipping_point') . ' AS c ON c.shipping_area_id=a.shipping_area_id ' . 'WHERE c.name != \'\' AND a.region_id IN (SELECT region_id FROM ' . $ecs->table('region') . (' WHERE parent_id=\'' . $_SESSION[flow_consignee][city] . '\')');
                                            ...
                                            if ($_REQUEST['step'] == 'select_picksite') {
                                                include 'includes/cls_json.php';
                                                $json = new JSON();
                                                ...
                                                if ($mark == 0) {
                                                    ...
                                                    $shipping_dateStr = date('m',
                                                            strtotime($shipping_date)) . '月' . date('d',
                                                            strtotime($shipping_date)) . '日【' . $week . '】' . $time_range;
                                                ...
                                                $cart_goods_list_new = cart_by_favourable($cart_goods_list);
                                                $cart_goods = get_new_group_cart_goods($cart_goods_list_new);
                                                if (empty($cart_goods) || !check_consignee_info($consignee,
                                                        $flow_type)) {
                                                    if (empty($cart_goods)) {
                                                        $result['error'] = 1;
                                                ...
                                                if ($_REQUEST['step'] == 'pay_pwd') {
                                                    ...
                                                    if (empty($pay_pwd)) {
                                                        ...
                                                        if ($new_password != $pay['pay_password']) {
                                                            $res['error'] = 2;
                                                        }
                                                    }
                                                    ...
                                                    if ($_REQUEST['step'] == 'checkorder') {
                                                        ...
                                                        if ($_REQUEST['step'] == 'select_payment') {
                                                            ...
                                                            if (0 < $store_id) {
                                                                $cart_goods_list = cart_goods($flow_type,
                                                                    $_SESSION['cart_value'], 1, $region_id, $area_id,
                                                                    $area_city, '', $store_id);
                                                                $cart_goods_list_new = cart_by_favourable($cart_goods_list);
                                                                $cart_goods = get_new_group_cart_goods($cart_goods_list_new);
                                                                ...
                                                                if (empty($cart_goods)) {
                                                                    ...
                                                                    $cart_goods_number = get_buy_cart_goods_number($flow_type,
                                                                        $_SESSION['cart_value']);
                                                                    $smarty->assign('cart_goods_number',
                                                                        $cart_goods_number);
                                                                    $smarty->assign('goods_list', $cart_goods_list_new);
                                                                    $cart_goods_list = get_flowdone_goods_list($cart_goods_list,
                                                                        $tmp_shipping_id_arr);
                                                                    $total = order_fee($order, $cart_goods, '', 0,
                                                                        $_SESSION['cart_value'], 0, $cart_goods_list, 0,
                                                                        0, $store_id, $store_seller);
                                                                    $smarty->assign('total', $total);
                                                                    $smarty->assign('total_integral',
                                                                        cart_amount(false, $flow_type,
                                                                            $_SESSION['cart_value']) - $total['bonus'] - $total['integral_money']);
                                                                    $smarty->assign('total_bonus',
                                                                        price_format(get_total_bonus(), false));
                                                                    get_goods_flow_type($_SESSION['cart_value']);
                                                                    $sc_rand = rand(1000, 9999);
                                                                    $sc_guid = sc_guid();
                                                                    $account_cookie = MD5($sc_guid . '-' . $sc_rand);
                                                                    setcookie('done_cookie', $account_cookie,
                                                                        gmtime() + 3600 * 24 * 30,
                                                                        $GLOBALS['cookie_path'],
                                                                        $GLOBALS['cookie_domain']);
                                                                    $smarty->assign('sc_guid', $sc_guid);
                                                                ...
                                                                if (empty($cart_goods) || !check_consignee_info($consignee,
                                                                    ...
                                                                    $cart_goods_list = get_flowdone_goods_list($cart_goods_list,
                                                                        $tmp_shipping_id_arr);
                                                                    $total = order_fee($order, $cart_goods, $consignee,
                                                                        0, $_SESSION['cart_value'], 0, $cart_goods_list,
                                                                        0, 0, $store_id, $store_seller);
                                                                    $smarty->assign('total', $total);
                                                                    $smarty->assign('total_integral',
                                                                        cart_amount(false, $flow_type,
                                                                            $_SESSION['cart_value']) - $total['bonus'] - $total['integral_money']);
                                                            ...
                                                            if ($_REQUEST['step'] == 'select_pack') {
                                                                ...
                                                                if (empty($cart_goods) || !check_consignee_info($consignee,
                                                                    ...
                                                                    $smarty->assign('consignee', $consignee);
                                                                    $cart_goods_list = cart_goods($flow_type,
                                                                        $_SESSION['cart_value'], 1);
                                                                    $smarty->assign('goods_list', $cart_goods_list);
                                                                    $total = order_fee($order, $cart_goods, $consignee,
                                                                        0, $_SESSION['cart_value'], 0,
                                                                        $cart_goods_list);
                                                                    $smarty->assign('total', $total);
                                                                    $smarty->assign('total_integral',
                                                                        cart_amount(false, $flow_type,
                                                                ...
                                                                if ($_REQUEST['step'] == 'select_card') {
                                                                    ...
                                                                    if (empty($cart_goods) || !check_consignee_info($consignee,
                                                                        ...
                                                                        $total = order_fee($order, $cart_goods,
                                                                            $consignee, 0, $_SESSION['cart_value'], 0,
                                                                            $cart_goods_list);
                                                                        $smarty->assign('total', $total);
                                                                        $smarty->assign('total_integral',
                                                                            cart_amount(false, $flow_type,
                                                                                $_SESSION['cart_value']) - $order['bonus'] - $total['integral_money']);
                                                                        $smarty->assign('total_bonus',
                                                                            price_format(get_total_bonus(), false));
                                                                    ...
                                                                    if ($_REQUEST['step'] == 'change_surplus') {
                                                                        ...
                                                                        if ($user_info['user_money'] + $user_info['credit_line'] < $surplus) {
                                                                            ...
                                                                            if (empty($cart_goods)) {
                                                                                ...
                                                                                if (!check_consignee_info($consignee,
                                                                                    ...
                                                                                    $consignee['street_name'] = get_goods_region_name($consignee['street']);
                                                                                    $consignee['consignee_address'] = $consignee['province_name'] . $consignee['city_name'] . $consignee['district_name'] . $consignee['street_name'] . $consignee['address'];
                                                                                    $smarty->assign('consignee',
                                                                                        $consignee);
                                                                                    $cart_goods_list = cart_goods($flow_type,
                                                                                        $_SESSION['cart_value'], 1, 0,
                                                                                        0, '', $store_id);
                                                                                    $smarty->assign('goods_list',
                                                                                        $cart_goods_list);
                                                                                    $cart_goods_list = get_flowdone_goods_list($cart_goods_list,
                                                                                        $tmp_shipping_id_arr);
                                                                                    $total = order_fee($order,
                                                                                        $cart_goods, $consignee, 0,
                                                                                    ...
                                                                                    if ($flow_type == CART_GROUP_BUY_GOODS) {
                                                                                        $smarty->assign('is_group_buy',
                                                                                            1);
                                                                                    } else {
                                                                                        if ($flow_type == CART_EXCHANGE_GOODS) {
                                                                                            $smarty->assign('is_exchange_goods',
                                                                                                1);
                                                                                        }
                                                                                    }
                                                                                    ...
                                                                                    $sc_guid = sc_guid();
                                                                                    $account_cookie = MD5($sc_guid . '-' . $sc_rand);
                                                                                    setcookie('done_cookie',
                                                                                        $account_cookie,
                                                                                        gmtime() + 3600 * 24 * 30,
                                                                                        $GLOBALS['cookie_path'],
                                                                                        $GLOBALS['cookie_domain']);
                                                                                    $smarty->assign('sc_guid',
                                                                                        $sc_guid);
                                                                                    $smarty->assign('sc_rand',
                                                                                        $sc_rand);
                                                                                    $result['content'] = $smarty->fetch('library/order_total.lbi');
                                                                                }
                                                                            }
                                                                        ...
                                                                        if ($_REQUEST['step'] == 'change_integral') {
                                                                            ...
                                                                            $flow_points = flow_available_points($_SESSION['cart_value'],
                                                                                $region_id, $area_id, $area_city);
                                                                            $user_points = $user_info['pay_points'];
                                                                            $warehouse_id = isset($_REQUEST['warehouse_id']) ? intval($_REQUEST['warehouse_id']) : 0;
                                                                            $area_id = isset($_REQUEST['area_id']) ? intval($_REQUEST['area_id']) : 0;
                                                                            $store_id = isset($_REQUEST['store_id']) ? intval($_REQUEST['store_id']) : 0;
                                                                            $smarty->assign('warehouse_id',
                                                                                $warehouse_id);
                                                                            $smarty->assign('area_id', $area_id);
                                                                            $smarty->assign('store_id', $store_id);
                                                                            ...
                                                                            if ($user_points < $points) {
                                                                                ...
                                                                                if ($flow_points < $points) {
                                                                                    $result['error'] = sprintf($_LANG['integral_too_much'],
                                                                                        $flow_points);
                                                                                } else {
                                                                                    $flow_type = isset($_SESSION['flow_type']) ? intval($_SESSION['flow_type']) : CART_GENERAL_GOODS;
                                                                            ...
                                                                            if ($_REQUEST['step'] == 'change_bonus') {
                                                                                ...
                                                                                if ($_REQUEST['step'] == 'change_value_card') {
                                                                                    include_once 'includes/cls_json.php';
                                                                                    $result = array(
                                                                                        'error' => '',
                                                                                        'content' => ''
                                                                                    ...
                                                                                    if ($_REQUEST['step'] == 'change_coupons') {
                                                                                        include_once 'includes/cls_json.php';
                                                                                        $result = array(
                                                                                            'error' => 0,
                                                                                            'content' => ''
                                                                                        ...
                                                                                        if (empty($cart_goods) || !check_consignee_info($consignee,
                                                                                            ...
                                                                                            $coupons_info = get_coupons($uc_id,
                                                                                                array(
                                                                                                    'c.cou_id',
                                                                                                    'c.cou_man',
                                                                                                    'c.cou_type',
                                                                                            ...
                                                                                            if (!empty($coupons_info) && $cart_goods_list) {
                                                                                                if ($coupons_info['cou_type'] == 5) {
                                                                                                    ...
                                                                                                    if ($coupons_info['cou_man'] <= $goods_amount || $coupons_info['cou_man'] == 0) {
                                                                                                        ...
                                                                                                        $cou_region = !empty($cou_region) ? explode(',',
                                                                                                            $cou_region) : array();
                                                                                                        if ($cou_region && in_array($consignee['province'],
                                                                                                                $cou_region)) {
                                                                                                            $not_freightfree = 1;
                                                                                                        }
                                                                                                    }
                                                                                            ...
                                                                                            if ($_REQUEST['step'] == 'change_oos') {
                                                                                                ...
                                                                                                if ($_REQUEST['step'] == 'check_surplus') {
                                                                                                    ...
                                                                                                    if ($_REQUEST['step'] == 'check_integral') {
                                                                                                        ...
                                                                                                        if ($flow_points < $points) {
                                                                                                            exit(sprintf($_LANG['integral_too_much'],
                                                                                                                $flow_points));
                                                                                                        }
                                                                                                            ...
                                                                                                            if ($_REQUEST['act'] == 'balance') {
                                                                                                                ...
                                                                                                                if ($order_info && $order_amount <= $user_money) {
                                                                                                                    if (0 < $order_info['order_id']) {
                                                                                                                        ...
                                                                                                                        $child_sn = isset($child_info['order_sn']) && !empty($child_info['order_sn']) ? explode(',',
                                                                                                                            $child_info['order_sn']) : '';
                                                                                                                    } else {
                                                                                                                        $child_ids = array();
                                                                                                                        $child_sn = array();
                                                                                                                    ...
                                                                                                                    if (0 < $order_info['user_id']) {
                                                                                                                        log_account_change($order_info['user_id'],
                                                                                                                            $order_amount * -1,
                                                                                                                            0,
                                                                                                                            0,
                                                                                                                            0,
                                                                                                                            sprintf($_LANG['pay_order'],
                                                                                                                                $order_info['order_sn']));
                                                                                                                        ...
                                                                                                                        order_action($order_sn,
                                                                                                                            OS_CONFIRMED,
                                                                                                                            SS_UNSHIPPED,
                                                                                                                            PS_PAYED,
                                                                                                                            $GLOBALS['_LANG']['flow_surplus_pay'],
                                                                                                                            $GLOBALS['_LANG']['buyer']);
                                                                                                                        ...
                                                                                                                        if (!empty($child_ids)) {
                                                                                                                            ...
                                                                                                                            foreach ($child_order_amounts as $k => $v) {
                                                                                                                                ...
                                                                                                                                $re = $db->autoExecute($ecs->table('order_info'),
                                                                                                                                    $order,
                                                                                                                                    'UPDATE',
                                                                                                                                    'order_id = \'' . $v['order_id'] . '\'');
                                                                                                                            }
                                                                                                                            ...
                                                                                                                            if ($order['order_amount'] <= 0) {
                                                                                                                                ...
                                                                                                                                if ($virtual_goods && $flow_type != CART_GROUP_BUY_GOODS) {
                                                                                                                                    if (virtual_goods_ship($virtual_goods,
                                                                                                                                        ...
                                                                                                                                        if ($db->getOne($sql) <= 0) {
                                                                                                                                            update_order($orderInfo['order_id'],
                                                                                                                                                array(
                                                                                                                                            ...
                                                                                                                                            if (0 < $orderInfo['user_id']) {
                                                                                                                                                ...
                                                                                                                                                log_account_change($orderInfo['user_id'],
                                                                                                                                                    0,
                                                                                                                                                    0,
                                                                                                                                                    intval($integral['rank_points']),
                                                                                                                                                    intval($integral['custom_points']),
                                                                                                                                                    sprintf($_LANG['order_gift_integral'],
                                                                                                                                                        $orderInfo['order_sn']));
                                                                                                                        ...
                                                                                                                        if ($GLOBALS['_CFG']['sms_order_payed'] == '1' && $sms_shop_mobile) {
                                                                                                                            ...
                                                                                                                            if ($GLOBALS['_CFG']['sms_type'] == 0) {
                                                                                                                                ...
                                                                                                                                if (1 <= $GLOBALS['_CFG']['sms_type']) {
                                                                                                                                    $order_result = sms_ali($smsParams,
                                                                                                                                        'sms_order_payed');
                                                                                                                                }
                                                                                                                            }
                                                                                                                        }
                                                                                                                        ...
                                                                                                                        if ($stores_order && 0 < $stores_order['store_id']) {
                                                                                                                            if ($order_info['mobile']) {
                                                                                                                                ...
                                                                                                                                $user_mobile_phone = $GLOBALS['db']->getOne($sql,
                                                                                                                                    true);
                                                                                                                            }

                                                                                                                            if ($user_mobile_phone) {
                                                                                                                                $pick_code = substr($order['order_sn'],
                                                                                                                                        -3) . rand(0,
                                                                                                                                        9) . rand(0,
                                                                                                                                        9) . rand(0,
                                                                                                                                        9);
                                                                                                                                ...
                                                                                                                                if ($GLOBALS['_CFG']['sms_type'] == 0) {
                                                                                                                                    if (0 < $stores_order['store_id'] && !empty($store_smsParams)) {
                                                                                                                                        huyi_sms($store_smsParams,
                                                                                                                                            'store_order_code');
                                                                                                                                    }
                                                                                                                                } else {
                                                                                                                                    if (1 <= $GLOBALS['_CFG']['sms_type']) {
                                                                                                                                        if (0 < $stores_order['store_id'] && !empty($store_smsParams)) {
                                                                                                                                            $store_result = sms_ali($store_smsParams,
                                                                                                                                                'store_order_code');
                                                                                                                                        }
                                                                                                                                    }
                                                                                                                                }
                                                                                                                        ...
                                                                                                                        if (1 <= $GLOBALS['_CFG']['sms_type']) {
                                                                                                                            ...
                                                                                                                            $resp = $GLOBALS['ecs']->ali_yu($sms_send,
                                                                                                                                1);
                                                                                                                        }
                                                                                                                    ...
                                                                                                                    show_message($GLOBALS['_LANG']['balance_not_enough'],
                                                                                                                        $GLOBALS['_LANG']['go_pay'],
                                                                                                                        '');
                                                                                                                    exit();
                                                                                                                }
                                                                                                            } else {
                                                                                                                if ($_REQUEST['act'] == 'chunsejinrong') {
                                                                                                                    ...
                                                                                                                    if (!$bt_info) {
                                                                                                                        show_message($_LANG['Ious_error_one'],
                                                                                                                            $_LANG['back_up_page'],
                                                                                                                            '');
                                                                                                                    }
                                                                                                                    ...
                                                                                                                    if ($remain_amount < $order_info['order_amount']) {
                                                                                                                        show_message($_LANG['Ious_error_two'],
                                                                                                                            $_LANG['back_up_page'],
                                                                                                                            '');
                                                                                                                    } else {
                                                                                                                        if ($order_info && 0 < $order_info['order_id']) {
                                                                                                                            ...
                                                                                                                            foreach ($user_baitiao_info as $k => $v) {
                                                                                                                                ...
                                                                                                                                if ($over_date[$k] <= gmtime()) {
                                                                                                                                    show_message($_LANG['Ious_error_Three'],
                                                                                                                                        $_LANG['back_up_page'],
                                                                                                                                        '');
                                                                                                                                }
                                                                                                                            }
                                                                                                                            ...
                                                                                                                            $GLOBALS['db']->autoExecute($GLOBALS['ecs']->table('baitiao_log'),
                                                                                                                                $bt_insert_other,
                                                                                                                                'INSERT');
                                                                                                                            ...
                                                                                                                            if (0 < $stages_total && $is_stages == 1) {
                                                                                                                                for ($i = 1; $i <= $stages_total; $i++) {
                                                                                                                                    ...
                                                                                                                                    if (!$GLOBALS['db']->getOne($sql,
                                                                                                                                        ...
                                                                                                                                        $GLOBALS['db']->autoExecute($GLOBALS['ecs']->table('baitiao_pay_log'),
                                                                                                                                            $pay_log_other,
                                                                                                                                            'INSERT');
                                                                                                                                    }
                                                                                                                                }
                                                                                                                            ...
                                                                                                                            if ($_CFG['use_storage'] == '1' && $_CFG['stock_dec_time'] == SDT_PAID && $order['order_amount'] <= 0) {
                                                                                                                                change_order_goods_storage($order_info['order_id'],
                                                                                                                                    true,
                                                                                                                                    SDT_PAID,
                                                                                                                                    15,
                                                                                                                                    0,
                                                                                                                    ...
                                                                                                                    $done_cart_value = isset($_POST['done_cart_value']) ? dsc_addslashes($_POST['done_cart_value'],
                                                                                                                        0) : 0;
...
');
                                                                                                                    ...
                                                                                                                    if (!$db->getOne($sql)) {
                                                                                                                        ...
                                                                                                                        if ($sse_order_id == 0) {
                                                                                                                            $order_goods = get_order_cart_value($user_id,
                                                                                                                                $done_cart_value);
...
');
                                                                                                                    ...
                                                                                                                    $GLOBALS['db']->autoExecute($GLOBALS['ecs']->table('solve_dealconcurrent'),
                                                                                                                        $solve_order,
                                                                                                                        'INSERT');
                                                                                                                    if ($done_cart_value && $GLOBALS['_CFG']['stock_dec_time'] == SDT_PLACE) {
                                                                                                                        ...
                                                                                                                        if ($solve_info) {
                                                                                                                            if (1 < $solve_info['solve_num']) {
                                                                                                                                $ogoods_list = array();
                                                                                                                                $goods_orec = array();
                                                                                                                                $sql = 'SELECT rec_id, goods_number, user_id, goods_id, CONCAT(goods_id, \'|\', model_attr, \'|\', goods_attr_id) AS cart_info, CONCAT(goods_id, \'|\', model_attr, \'|\', goods_attr_id, \'|\', warehouse_id, \'|\', area_id) AS warehouse_area FROM ' . $GLOBALS['ecs']->table('cart') . ' WHERE rec_id ' . db_create_in($solve_info['orec_id']) . ' AND is_real = 1' . ' AND rec_type ' . db_create_in(array(
                                                                                                                                        CART_GENERAL_GOODS,
                                                                                                                                        CART_GROUP_BUY_GOODS,
                                                                                                                                        CART_EXCHANGE_GOODS,
                                                                                                                                        CART_AUCTION_GOODS,
                                                                                                                                        CART_SNATCH_GOODS,
                                                                                                                                        CART_SECKILL_GOODS
                                                                                                                                ...
                                                                                                                                if ($orec_goods) {
                                                                                                                                    ...
                                                                                                                                    $ordinary_orec_list = get_cart_goods_salve($goods_orec['cart_info'],
                                                                                                                                        $orec_goods);
                                                                                                                                    ...
                                                                                                                                    $db->query($sql);
                                                                                                                                    if ($ordinary_solve_user && in_array($user_id,
                                                                                                                                            $ordinary_solve_user)) {
                                                                                                                                        show_message($_LANG['flow_salve_error'],
                                                                                                                                            $_LANG['back_cart'],
                                                                                                                                            'flow.php');
                                                                                                                                        exit();
                                                                                                                                    }

                                                                                                                                    $warehouse_orec_list = get_cart_goods_salve($goods_orec['warehouse_area'],
                                                                                                                                        $orec_goods);
                                                                                                                                    $warehouse_solve_user = arr_foreach($warehouse_orec_list['no_solve']);
                                                                                                                                    if ($warehouse_solve_user && in_array($user_id,
                                                                                                                                            $warehouse_solve_user)) {
                                                                                                                                        show_message($_LANG['flow_salve_error'],
                                                                                                                                            $_LANG['back_cart'],
                                                                                                                                            'flow.php');
                                                                                                                                        exit();
...
');
                                                                                                                    ...
                                                                                                                    if (count($_POST['shipping']) == 1) {
                                                                                                                        ...
                                                                                                                        $shipping = get_order_post_shipping($_POST['shipping'],
                                                                                                                            $_POST['shipping_code'],
                                                                                                                            $_POST['shipping_type'],
                                                                                                                            $_POST['ru_id']);
                                                                                                                    }
                                                                                                                    ...
                                                                                                                    $order = array(
                                                                                                                        ...
                                                                                                                        'uc_id' => isset($_POST['uc_id']) ? intval($_POST['uc_id']) : 0,
                                                                                                                        'not_freightfree' => isset($_POST['not_freightfree']) ? intval($_POST['not_freightfree']) : 0,
                                                                                                                        ...
                                                                                                                        if ($order['pay_code'] == 'onlinepay' || 0 < $pay_surplus || 0 < $pay_integral) {
                                                                                                                            if ($pay_pwd_error == 0 && !empty($pay_pwd)) {
                                                                                                                                ...
                                                                                                                                if (!empty($pay_pwd) && $new_password != $pay_online['pay_password']) {
                                                                                                                                    show_message($_LANG['pay_password_packup_error'],
                                                                                                                                        $_LANG['back'],
                                                                                                                                        '',
                                                                                                                                        'error');
                                                                                                                                }
                                                                                                                    ...
                                                                                                                    if (0 < $user_id) {
                                                                                                                        ...
                                                                                                                        $order['surplus'] = min($order['surplus'],
                                                                                                                            $user_info['user_money'] + $user_info['credit_line']);
                                                                                                                        ...
                                                                                                                        $flow_points = flow_available_points($done_cart_value,
                                                                                                                            ...
                                                                                                                            $area_city);
                                                                                                                        $user_points = $user_info['pay_points'];
                                                                                                                        $order['integral'] = min($order['integral'],
                                                                                                                            $user_points,
                                                                                                                            $flow_points);
                                                                                                                    ...
                                                                                                                    if (0 < $order['bonus_id']) {
                                                                                                                        ...
                                                                                                                        if (empty($bonus) || $bonus['user_id'] != $user_id || 0 < $bonus['order_id'] || cart_amount(true,
                                                                                                                                $flow_type,
                                                                                                                                $done_cart_value) < $bonus['min_goods_amount']) {
                                                                                                                            $order['bonus_id'] = 0;
                                                                                                                        }
                                                                                                                    } else {
                                                                                                                        if (isset($_POST['bonus_psd'])) {
                                                                                                                            $bonus_psd = trim($_POST['bonus_psd']);
                                                                                                                            $bonus = bonus_info(0,
                                                                                                                                $bonus_psd);
                                                                                                                            $now = gmtime();
                                                                                                                            if (empty($bonus) || 0 < $bonus['user_id'] || 0 < $bonus['order_id'] || cart_amount(true,
                                                                                                                                    $flow_type,
                                                                                                                                    $done_cart_value) < $bonus['min_goods_amount'] || $bonus['use_end_date'] < $now) {
                                                                                                                            } else {
                                                                                                                                if (0 < $user_id) {
                                                                                                                    ...
                                                                                                                    if (0 < $order['vc_id']) {
                                                                                                                        ...
                                                                                                                        if (isset($_POST['value_card_psd'])) {
                                                                                                                            $value_card_psd = trim($_POST['value_card_psd']);
                                                                                                                            $value_card = value_card_info(0,
                                                                                                                                $value_card_psd);
                                                                                                                            $now = gmtime();
                                                                                                                    ...
                                                                                                                    if (0 < $order['uc_id']) {
                                                                                                                        ...
                                                                                                                        if (empty($coupons) || $coupons['user_id'] != $user_id || $coupons['is_use'] == 1 || cart_amount(true,
                                                                                                                                $flow_type,
                                                                                                                                $done_cart_value) < $coupons['cou_man']) {
                                                                                                                            $order['uc_id'] = 0;
                                                                                                                        }
                                                                                                                    }
                                                                                                                    ...
                                                                                                                    if ($flow_type == CART_GENERAL_GOODS && cart_amount(true,
                                                                                                                            CART_GENERAL_GOODS,
                                                                                                                            $done_cart_value) < $_CFG['min_goods_amount']) {
                                                                                                                        show_message(sprintf($_LANG['goods_amount_not_enough'],
                                                                                                                            price_format($_CFG['min_goods_amount'],
                                                                                                                                false)));
                                                                                                                    }
                                                                                                                    ...
                                                                                                                    if (!empty($order['shipping_id'])) {
                                                                                                                        ...
                                                                                                                        $shipping_name = !empty($order['shipping_name']) ? explode(',',
                                                                                                                            $order['shipping_name']) : '';
                                                                                                                    ...
                                                                                                                    $order['order_amount'] = number_format($total['amount'],
                                                                                                                        2,
                                                                                                                        '.',
                                                                                                                        '');
                                                                                                                    ...
                                                                                                                    if ($payment['pay_code'] == 'balance' && 0 < $order['order_amount']) {
                                                                                                                        ...
                                                                                                                        if ($user_info['user_money'] + $user_info['credit_line'] < $order['order_amount']) {
                                                                                                                            ...
                                                                                                                            if ($_SESSION['flow_type'] == CART_PRESALE_GOODS) {
                                                                                                                                ...
                                                                                                                                if ($_SESSION['flow_type'] == CART_GROUP_BUY_GOODS) {
                                                                                                                    ...
                                                                                                                    $parentordersn = '';
                                                                                                                    $requ = set_cloud_order_goods($cart_goods,
                                                                                                                        $order);
                                                                                                                    ...
                                                                                                                    if ($cartValue) {
                                                                                                                        $is_cart = get_is_cart_goods($user_id,
                                                                                                                            $cartValue);
                                                                                                                    ...
                                                                                                                    if (!empty($cloud_order_list)) {
                                                                                                                        foreach ($cloud_order_list as $k => $v) {
                                                                                                                            ...
                                                                                                                            $GLOBALS['db']->autoExecute($GLOBALS['ecs']->table('order_cloud'),
                                                                                                                                $cloud_order,
                                                                                                                                'INSERT');
                                                                                                                        }
                                                                                                                    }
                                                                                                                    ...
                                                                                                                    $order['log_id'] = insert_pay_log($new_order_id,
                                                                                                                        $order['order_amount'],
                                                                                                                        PAY_ORDER);
                                                                                                                    $good_ru_id = !empty($_REQUEST['ru_id']) ? dsc_addslashes($_REQUEST['ru_id'],
                                                                                                                        1) : 0;
                                                                                                                    ...
                                                                                                                    if (0 < $new_order_id && 0 < $order['bonus_id'] && 0 < $temp_amout) {
                                                                                                                        use_bonus($order['bonus_id'],
                                                                                                                            $new_order_id);
                                                                                                                    }

                                                                                                                    if (0 < $new_order_id && 0 < $order['vc_id']) {
                                                                                                                        use_value_card($order['vc_id'],
                                                                                                                            $new_order_id,
                                                                                                                            $order['use_value_card']);
                                                                                                                    }

                                                                                                                    if (0 < $new_order_id && 0 < $order['uc_id']) {
                                                                                                                        use_coupons($order['uc_id'],
                                                                                                                            $new_order_id);
                                                                                                                    }

                                                                                                                    if ($_CFG['use_storage'] == '1' && $_CFG['stock_dec_time'] == SDT_PLACE) {
                                                                                                                        change_order_goods_storage($new_order_id,
                                                                                                                            true,
                                                                                                                            SDT_PLACE,
                                                                                                                            $_CFG['stock_dec_time'],
                                                                                                                            0,
                                                                                                                    ...
                                                                                                                    $order_info = get_main_order_info($order['order_id'],
                                                                                                                        1);
                                                                                                                    $ru_id = explode(',',
                                                                                                                        $order_info['all_ruId']['ru_id']);
                                                                                                                    ...
                                                                                                                    if (0 < $new_order_id && 0 < $order['order_amount']) {
                                                                                                                        ...
                                                                                                                        if ($order['pay_id'] == $onlinepay_pay_id) {
                                                                                                                            ...
                                                                                                                            foreach ($payment_list as $K => $v) {
                                                                                                                                if ($v['is_online'] == 1) {
                                                                                                                                    ...
                                                                                                                                    if (file_exists($payment_file)) {
                                                                                                                                        ...
                                                                                                                                        $pay_online_button[$v['pay_code']] = '      ' . $pay_obj->get_code($par_order,
                                                                                                                                                unserialize_config($v['pay_config']));

                                                                                                                                        if ($v['pay_code'] == 'alipay_bank') {
                                                                                                                                            $smarty->assign('is_alipay_bank',
                                                                                                                                                $pay_online_button['alipay_bank']);
                                                                                                                                        ...
                                                                                                                                        if ($baitiao_balance && 0 < $baitiao_balance['balance']) {
                                                                                                                                            $smarty->assign('is_chunsejinrong',
                                                                                                                                                true);
                                                                                                                            ...
                                                                                                                            $smarty->assign('pay_online_button',
                                                                                                                                $pay_online_button);
                                                                                                                            $smarty->assign('is_onlinepay',
                                                                                                                                true);
                                                                                                                        } else {
                                                                                                                            $payment = payment_info($order['pay_id']);
                                                                                                                        ...
                                                                                                                        if ($_SESSION['flow_type'] == 5) {
                                                                                                                            $smarty->assign('is_presale_goods',
                                                                                                                                true);
                                                                                                                        }
                                                                                                                        ...
                                                                                                                        if (0 < $cart_info['stages_qishu']) {
                                                                                                                            $stages_rate = $db->getOne('SELECT stages_rate FROM ' . $ecs->table('goods') . ' WHERE goods_id = \'' . $cart_info['goods_id'] . '\'',
                                                                                                                                true);
                                                                                                                            $order_sn = $order['order_sn'];
                                                                                                                            $stages_qishu = $cart_info['stages_qishu'];
                                                                                                                            $goods_number = $cart_info['goods_number'];
                                                                                                                            $shop_price_total = $order['order_amount'];
                                                                                                                            $stages_one_price = round($shop_price_total * ($stages_rate / 100) + $shop_price_total / $stages_qishu,
                                                                                                                                2);

                                                                                                                            if ($stages_qishu == 1) {
                                                                                                                                $repay_datee[1] = local_date('Y-m-d',
                                                                                                                                    local_strtotime('+1 month'));
                                                                                                                                $stages_one_price = round($shop_price_total,
                                                                                                                                    2);
                                                                                                                            } else {
                                                                                                                                $bt_other = array('user_id' => $user_id);
                                                                                                                                $bt_info = get_baitiao_info($bt_other);
                                                                                                                                ...
                                                                                                                                for ($i = 1; $i <= $stages_qishu; $i++) {
                                                                                                                                    ...
                                                                                                                                    $repay_datee[$i] = local_date('Y-m-d',
                                                                                                                                        local_strtotime('+' . $value . ' day'));
                                                                                                                                }
                                                                                                                            }
                                                                                                                            ...
                                                                                                                            $GLOBALS['db']->autoExecute($GLOBALS['ecs']->table('stages'),
                                                                                                                                $stages_other,
                                                                                                                                'INSERT');
                                                                                                                            $stages_intro = array(
                                                                                                                    ...
                                                                                                                    $smarty->assign('order_submit_back',
                                                                                                                        sprintf($_LANG['order_submit_back'],
                                                                                                                            $_LANG['back_home'],
                                                                                                                            $_LANG['goto_user_center']));
                                                                                                                    user_uc_call('add_feed',
                                                                                                                        array(
                                                                                                                            $order['order_id'],
                                                                                                                            BUY_GOODS
                                                                                                                        ));
                                                                                                                    ...
                                                                                                                    $order_info = get_main_order_info($order_id,
                                                                                                                        1);
                                                                                                                    $ru_id = explode(',',
                                                                                                                        $order_info['all_ruId']['ru_id']);
                                                                                                                    $seller_grade = 1;
                                                                                                                    ...
                                                                                                                    if (1 < count($ru_id)) {
                                                                                                                        ...
                                                                                                                        if ($is_payment) {
                                                                                                                            $sg_ru_id = get_array_flip(0,
                                                                                                                                $ru_id);
                                                                                                                            $seller_grade = get_seller_grade($sg_ru_id,
                                                                                                                                1);
                                                                                                                        }

                                                                                                                        $smarty->assign('seller_grade',
                                                                                                                            $seller_grade);
                                                                                                                    } else {
                                                                                                                        if ($ru_id[0] == 0) {
                                                                                                                            $smarty->assign('seller_grade',
                                                                                                                    ...
                                                                                                                    if (0 < $order_id && 1 < $ru_number) {
                                                                                                                        get_insert_order_goods_single($order_info,
                                                                                                                            $row,
                                                                                                                            $order_id,
                                                                                                                            $ru_number);
                                                                                                                    } else {
                                                                                                                    ...
                                                                                                                    if (0 < $order_id || !isset($_SESSION['order_reload'])) {
                                                                                                                        ...
                                                                                                                        if (1 < $child_order) {
                                                                                                                            ...
                                                                                                                            $smarty->assign('child_order_info',
                                                                                                                                $child_order_info);
                                                                                                                        }

                                                                                                                        $smarty->assign('pay_type',
                                                                                                                            $pay_type);
                                                                                                                        $smarty->assign('child_order',
                                                                                                                            $child_order);
                                                                                                                        $goods_buy_list = get_order_goods_buy_list($region_id,
                                                                                                                            $area_id);
                                                                                                                        $smarty->assign('goods_buy_list',
                                                                                                                            $goods_buy_list);
                                                                                                                        if ($stores_sms == 1 && 0 < $store_id) {
                                                                                                                            ...
                                                                                                                            if ($store_id) {
                                                                                                                                if ($order['mobile']) {
                                                                                                                                    ...
                                                                                                                                    $sql = 'SELECT mobile_phone FROM ' . $ecs->table('users') . ' WHERE user_id = \'' . $_SESSION['user_id'] . '\'';
                                                                                                                                    $user_mobile_phone = $db->getOne($sql,
                                                                                                                                        true);
                                                                                                                                }
                                                                                                                        ...
                                                                                                                        if (count($ru_id) == 1) {
                                                                                                                            $sellerId = $ru_id[0];
                                                                                                                            $shop_name = get_shop_name($sellerId,
                                                                                                                                1);
                                                                                                                            ...
                                                                                                                            if ($_CFG['sms_order_placed'] == '1' && $sms_shop_mobile) {
                                                                                                                                if (!empty($auto_sms)) {
                                                                                                                                    ...
                                                                                                                                    if ($GLOBALS['_CFG']['sms_type'] == 0) {
                                                                                                                                        huyi_sms($pt_smsParams,
                                                                                                                                            'sms_order_placed');
                                                                                                                                    } else {
                                                                                                                                        if (1 <= $GLOBALS['_CFG']['sms_type']) {
                                                                                                                                            $pt_result = sms_ali($pt_smsParams,
                                                                                                                                                'sms_order_placed');
                                                                                                                            ...
                                                                                                                            if ($_CFG['send_service_email'] == '1' && $service_email) {
                                                                                                                                $smarty->assign('done_cart_value',
                                                                                                                                    $cartValue);
                                                                                                                                $smarty->assign('order_id',
                                                                                                                                    $order_id);
                                                                                                                                $smarty->assign('ajax_send_mail',
                                                                                                                                    true);
                                                                                                                                $smarty->assign('send_time',
                                                                                                                                    'send_service_email');
                                                                                                                            }
                                                                                                                        }
                                                                                                                    } else {
...
');
                                                                                                            ...
                                                                                                            if ($_REQUEST['step'] == 'ajax_update_cart') {
                                                                                                                ...
                                                                                                                if (isset($_POST['rec_id']) && isset($_POST['goods_number'])) {
                                                                                                                    ...
                                                                                                                    if ($xiangouInfo['is_xiangou'] == 1 && $start_date < $nowTime && $nowTime < $end_date) {
                                                                                                                        $user_id = !empty($_SESSION['user_id']) ? $_SESSION['user_id'] : 0;
                                                                                                                        $orderGoods = get_for_purchasing_goods($start_date,
                                                                                                                            $end_date,
                                                                                                                            $row['goods_id'],
                                                                                                                            $user_id);
                                                                                                                        ...
                                                                                                                        if ($xiangouInfo['xiangou_num'] <= $orderGoods['goods_number']) {
                                                                                                                            $max_num = $xiangouInfo['xiangou_num'] - $orderGoods['goods_number'];
                                                                                                                            $result['message'] = sprintf($_LANG['purchase_Prompt'],
                                                                                                                                $row['goods_name']);
                                                                                                                            $sql = 'UPDATE ' . $GLOBALS['ecs']->table('cart') . (' SET goods_number = 0 WHERE rec_id=\'' . $key . '\'');
                                                                                                                            $GLOBALS['db']->query($sql);
                                                                                                                            $result['error'] = 1;
                                                                                                                    ...
                                                                                                                    if (0 < intval($GLOBALS['_CFG']['use_storage']) && $row['extension_code'] != 'package_buy') {
                                                                                                                        ...
                                                                                                                        if (!empty($row['product_id'])) {
                                                                                                                            ...
                                                                                                                            if (0 < $row['cloud_id']) {
                                                                                                                                ...
                                                                                                                                if (file_exists($plugin_file)) {
                                                                                                                                    ...
                                                                                                                                    $cloud = new cloud();
                                                                                                                                    $cloud_prod = $cloud->queryInventoryNum($productIds);
                                                                                                                                    $cloud_prod = json_decode($cloud_prod,
                                                                                                                                        true);
                                                                                                                            ...
                                                                                                                            if ($product_number < $val) {
                                                                                                                                $result['error'] = 2;
                                                                                                                                $result['message'] = sprintf($GLOBALS['_LANG']['stock_insufficiency'],
                                                                                                                                    $row['goods_name'],
                                                                                                                                    $product_number,
                                                                                                                                    $product_number);
                                                                                                                                exit($json->encode($result));
                                                                                                                        ...
                                                                                                                        if (0 < intval($GLOBALS['_CFG']['use_storage']) && $row['extension_code'] == 'package_buy') {
                                                                                                                            if (judge_package_stock($row['goods_id'],
                                                                                                                                $val)) {
                                                                                                                                $result['error'] = 3;
                ...
                AND ' . $b_sess;
                                                                                                                    ...
                                                                                                                    if (0 < $val) {
                                                                                                                        if (0 < $row['group_number'] && $row['group_number'] < $val && !empty($row['group_id'])) {
                                                                                                                            $result['error'] = 1;
                                                                                                                            $result['message'] = sprintf($GLOBALS['_LANG']['group_stock_insufficiency'],
                                                                                                                                $row['goods_name'],
                                                                                                                                $row['group_number'],
                                                                                                                                $row['group_number']);
                                                                                                                            exit($json->encode($result));
                                                                                                                        ...
                                                                                                                        if ($row['extension_code'] == 'package_buy') {
                                                                                                                            ...
                                                                                                                            $attr_id = empty($row['goods_attr_id']) ? array() : explode(',',
                                                                                                                                $row['goods_attr_id']);
                                                                                                                            $goods_price = get_final_price($row['goods_id'],
                                                                                                                                $val,
                                                                                                                                true,
                                                                                                                                $attr_id,
                                                                                                                                $_POST['warehouse_id'],
                                                                                                                    ...
                                                                                                                    foreach ($cart_goods['goods_list'] as $goods) {
                                                                                                                        ...
                                                                                                                        if (isset($result['rec_goods']) && 0 < $goods['parent_id'] && $result['rec_goods'] == $goods['parent_id']) {
                                                                                                                            if ($goods['rec_id'] != $key) {
                                                                                                                                ...
                                                                                                                                $result['group'][$goods['rec_id']]['rec_group_subtotal'] = price_format($goods['goods_amount'],
                                                                                                                                    false);
                                                                                                                            }
                                                                                                                        }
                                                                                                                    }
                                                                                                                    ...
                                                                                                                    $total_goods_price = price_format($goods_amount,
                                                                                                                        false);
                                                                                                                    $result['flow_info'] = insert_flow_info($total_goods_price,
                                                                                                                    ...
                                                                                                                    $act_sel = array(
                                                                                                                        'act_sel_id' => $act_sel_id,
                                                                                                                        'act_pro_sel_id' => $act_pro_sel_id,
                                                                                                                        'act_sel' => $sel_flag
                                                                                                                    );
                                                                                                                ...
                                                                                                                if ($_REQUEST['step'] == 'ajax_cart_goods_amount') {
                                                                                                                    require_once ROOT_PATH . 'includes/cls_json.php';
                                                                                                                    $json = new JSON();
                                                                                                                    $result = array(
                                                                                                                        'error' => 0,
                                                                                                                    ...
                                                                                                                    $discount = compute_discount(3,
                                                                                                                        $rec_id);
                                                                                                                    $favour_name = empty($discount['name']) ? '' : implode(',',
                                                                                                                        $discount['name']);
                                                                                                                    $flow_type = isset($_SESSION['flow_type']) ? intval($_SESSION['flow_type']) : CART_GENERAL_GOODS;
                                                                                                                    $cart_goods = cart_goods($flow_type,
                                                                                                                        $rec_id,
                                                                                                                    ...
                                                                                                                    $result['goods_amount'] = price_format($goods_amount['subtotal_amount'],
                                                                                                                        false);
                                                                                                                    ...
                                                                                                                    if ($_REQUEST['step'] == 'cart_change_fav') {
                                                                                                                        require_once ROOT_PATH . 'includes/cls_json.php';
                                                                                                                        $json = new JSON();
                                                                                                                        $result = array(
                                                                                                                            'error' => 0,
                                                                                                                        ...
                                                                                                                        update_cart_goods_fav($rec_id,
                                                                                                                            $user_id,
                                                                                                                            $act_id);
                                                                                                                        $smarty->assign('area_id',
                                                                                                                            $area_id);
                                                                                                                        $smarty->assign('flow_region',
                                                                                                                            $_COOKIE['flow_region']);
                                                                                                                        ...
                                                                                                                        $smarty->assign('total',
                                                                                                                            $cart_goods['total']);
                                                                                                                        $smarty->assign('shopping_money',
                                                                                                                            sprintf($_LANG['shopping_money'],
                                                                                                                                $cart_goods['total']['goods_price']));
                                                                                                                        $smarty->assign('market_price_desc',
                                                                                                                            sprintf($_LANG['than_market_price'],
                                                                                                                                $cart_goods['total']['market_price'],
                                                                                                                                $cart_goods['total']['saving'],
                                                                                                                                $cart_goods['total']['save_rate']));
                                                                                                                        ...
                                                                                                                        $smarty->assign('discount',
                                                                                                                            $discount['discount']);
                                                                                                                        $favour_name = empty($discount['name']) ? '' : join(',',
                                                                                                                            $discount['name']);
                                                                                                                        $smarty->assign('your_discount',
                                                                                                                            sprintf($_LANG['your_discount'],
                                                                                                                                $favour_name,
                                                                                                                                price_format($discount['discount'])));
                                                                                                                        $smarty->assign('show_goods_thumb',
                                                                                                                            $GLOBALS['_CFG']['show_goods_in_cart']);
                                                                                                                        $smarty->assign('show_goods_attribute',
                                                                                                                            $GLOBALS['_CFG']['show_attr_in_cart']);
                                                                                                                        ...
                                                                                                                        $smarty->assign('fittings_list',
                                                                                                                            $fittings_list);
                                                                                                                        $guess_goods = get_guess_goods($_SESSION['user_id'],
                                                                                                                            1,
                                                                                                                            1,
                                                                                                                            18,
                                                                                                                            $region_id,
                                                                                                                        ...
                                                                                                                        $best_goods = get_recommend_goods('best',
                                                                                                                            ...
                                                                                                                            $area_id,
                                                                                                                            $area_city);
                                                                                                                        $smarty->assign('guess_goods',
                                                                                                                            $guess_goods);
                                                                                                                        $smarty->assign('guessGoods_count',
                                                                                                                            count($guess_goods));
                                                                                                                        $smarty->assign('best_goods',
                                                                                                                            $best_goods);
                                                                                                                        $smarty->assign('bestGoods_count',
                                                                                                                            count($best_goods));
                                                                                                                        $smarty->assign('province_row',
                                                                                                                            get_region_info($province_id));
                                                                                                                        $smarty->assign('city_row',
                                                                                                                            get_region_info($city_id));
                                                                                                                        $smarty->assign('district_row',
                                                                                                                            get_region_info($district_id));
                                                                                                                        ...
                                                                                                                        $smarty->assign('province_list',
                                                                                                                            $province_list);
                                                                                                                        $smarty->assign('city_list',
                                                                                                                            $city_list);
                                                                                                                        $smarty->assign('district_list',
                                                                                                                            $district_list);
                                                                                                                        ...
                                                                                                                        if ($_REQUEST['step'] == 'update_cart') {
                                                                                                                            ...
                                                                                                                            show_message($_LANG['update_cart_notice'],
                                                                                                                                $_LANG['back_to_cart'],
                                                                                                                                'flow.php');
                                                                                                                            exit();
                                                                                                                        } else {
                                                                                                                            if ($_REQUEST['step'] == 'pdf') {
                                                                                                                                ...
                                                                                                                                $order_info['add_time'] = local_date('Y-m-d H:i:s',
                                                                                                                                    $order_info['add_time']);

                                                                                                                                if ($order_info['shipping_name']) {
                                                                                                                                    $shipping_list = explode(',',
                                                                                                                                    ...
                                                                                                                                    if (1 < count($shipping_list)) {
                                                                                                                                        ...
                                                                                                                                        $order_info['shipping_name'] = implode(',',
                                                                                                                                            $shipping_list);
                                                                                                                                    }
                                                                                                                                }
...
');
                                                                                                                                    ...
                                                                                                                                    if ($_REQUEST['step'] == 'add_favourable') {
                                                                                                                                        ...
                                                                                                                                        if ($favourable['act_type'] == FAT_GOODS) {
                                                                                                                                            ...
                                                                                                                                            if (!empty($gift_name)) {
                                                                                                                                                $result['error'] = 5;
                                                                                                                                                $result['message'] = sprintf($_LANG['gift_in_cart'],
                                                                                                                                                    join(',',
                                                                                                                                                        $gift_name));
                                                                                                                                                exit($json->encode($result));
                                                                                                                                            }
                                                                                                                                            ...
                                                                                                                                            $favourable_box = cart_add_favourable_box($act_id,
                                                                                                                                                $act_sel,
                                                                                                                                                $ru_id);
                                                                                                                                            $cart_value = array();
...
');
                                                                                                                                                ...
                                                                                                                                                if ($_REQUEST['step'] == 'validate_bonus') {
                                                                                                                                                    ...
                                                                                                                                                    $bonus_kill = price_format($bonus['type_money'],
                                                                                                                                                        false);
                                                                                                                                                    include_once 'includes/cls_json.php';
                                                                                                                                                    $result = array(
                                                                                                                                                        'error' => '',
                                                                                                                                                    ...
                                                                                                                                                    if (empty($cart_goods) || !check_consignee_info($consignee,
                                                                                                                                                        ...
                                                                                                                                                        if ($total['goods_price'] < $bonus['min_goods_amount']) {
                                                                                                                                                            $order['bonus_id'] = '';
                                                                                                                                                            $result['error'] = sprintf($_LANG['bonus_min_amount_error'],
                                                                                                                                                                $bonus['min_goods_amount']);
                                                                                                                                                        }
                                                                                                                                                    ...
                                                                                                                                                    if ($_REQUEST['step'] == 'validate_value_card') {
                                                                                                                                                        ...
                                                                                                                                                        if (!empty($value_card)) {
                                                                                                                                                            if ($value_card['use_condition'] == 1 && !comparison_cat($cart_goods,
                                                                                                                                                                    $value_card['spec_cat'])) {
                                                                                                                                                                $value_card['error'] = true;
                                                                                                                                                            }

                                                                                                                                                            if ($value_card['use_condition'] == 2 && !comparison_goods($cart_goods,
                                                                                                                                                                    $value_card['spec_goods'])) {
                                                                                                                                                                $value_card['error'] = true;
                                                                                                                                                            }
                                                                                                                                                        }
                                                                                                                                                        ...
                                                                                                                                                        if ($_REQUEST['step'] == 'add_package_to_cart') {
                                                                                                                                                            ...
                                                                                                                                                            if (!is_numeric($package->number) || intval($package->number) <= 0) {
                                                                                                                                                                ...
                                                                                                                                                                $res = add_package_to_cart($package->package_id,
                                                                                                                                                                    $package->number,
                                                                                                                                                                ...
                                                                                                                                                                if (!is_array($res) && $res) {
                                                                                                                                                                    ...
                                                                                                                                                                    if (is_array($res)) {
                                                                                                                                                                        $result['message'] = sprintf($GLOBALS['_LANG']['package_null'],
                                                                                                                                                                            $res['goods_name']);
                                                                                                                                                            ...
                                                                                                                                                            if ($_REQUEST['step'] == 'show_gift_div') {
                                                                                                                                                                include_once 'includes/cls_json.php';
                                                                                                                                                                $json = new JSON();
                                                                                                                                                                ...
                                                                                                                                                                $favourable = favourable_list($_SESSION['user_rank'],
                                                                                                                                                                    -1,
                                                                                                                                                                    $favourable_id,
                                                                                                                                                                    $act_sel,
                                                                                                                                                                    $ru_id);
                                                                                                                                                                ...
                                                                                                                                                                $activity['favourable_used'] = favourable_used($activity,
                                                                                                                                                                    $cart_favourable_num);
                                                                                                                                                                ...
                                                                                                                                                                foreach ($activity['gift'] as $key => $row) {
                                                                                                                                                                    ...
                                                                                                                                                                    $activity['act_gift_list'][$key]['url'] = build_uri('goods',
                                                                                                                                                                        array('gid' => $row['id']),
                                                                                                                                                                        $row['name']);
                                                                                                                                                                }
                                                                                                                                                                ...
                                                                                                                                                                $smarty->assign('ru_id',
                                                                                                                                                                    $ru_id);
                                                                                                                                                                $smarty->assign('gift_div',
                                                                                                                                                                    1);
                                                                                                                                                                $smarty->assign('act_id',
                                                                                                                                                                    $favourable_id);
                                                                                                                                                                ...
                                                                                                                                                                if ($_REQUEST['step'] == 'edit_Consignee') {
                                                                                                                                                                    ...
                                                                                                                                                                    $smarty->assign('consignee',
                                                                                                                                                                        $consignee);
                                                                                                                                                                    $smarty->assign('country_list',
                                                                                                                                                                        get_regions());
                                                                                                                                                                    $smarty->assign('please_select',
                                                                                                                                                                        $_LANG['please_select']);
                                                                                                                                                                    $province_list = get_regions_log(1,
                                                                                                                                                                        $consignee['country']);
                                                                                                                                                                    $city_list = get_regions_log(2,
                                                                                                                                                                        $consignee['province']);
                                                                                                                                                                    $district_list = get_regions_log(3,
                                                                                                                                                                        $consignee['city']);
                                                                                                                                                                    $street_list = get_regions_log(4,
                                                                                                                                                                        $consignee['district']);
                                                                                                                                                                    $smarty->assign('province_list',
                                                                                                                                                                        $province_list);
                                                                                                                                                                    $smarty->assign('city_list',
                                                                                                                                                                    ...
                                                                                                                                                                    if ($_REQUEST['step'] == 'insert_Consignee') {
                                                                                                                                                                        include 'includes/cls_json.php';
                                                                                                                                                                        $time = gmtime();
                                                                                                                                                                        $json = new JSON();
                                                                                                                                                                        $result = array(
                                                                                                                                                                        ...
                                                                                                                                                                        if ($consignee) {
                                                                                                                                                                            ...
                                                                                                                                                                            setcookie('street',
                                                                                                                                                                                ...
                                                                                                                                                                                $GLOBALS['cookie_path'],
                                                                                                                                                                                $GLOBALS['cookie_domain']);
                                                                                                                                                                            setcookie('street_area',
                                                                                                                                                                                '',
                                                                                                                                                                                gmtime() + 3600 * 24 * 30,
                                                                                                                                                                                $GLOBALS['cookie_path'],
                                                                                                                                                                                $GLOBALS['cookie_domain']);
                                                                                                                                                                            $flow_warehouse = get_warehouse_goods_region($consignee['province']);
                                                                                                                                                                            setcookie('area_region',
                                                                                                                                                                                $flow_warehouse['region_id'],
                                                                                                                                                                                gmtime() + 3600 * 24 * 30,
                                                                                                                                                                                $GLOBALS['cookie_path'],
                                                                                                                                                                                $GLOBALS['cookie_domain']);
                                                                                                                                                                            setcookie('flow_region',
                                                                                                                                                                                $flow_warehouse['region_id'],
                                                                                                                                                                                gmtime() + 3600 * 24 * 30,
                                                                                                                                                                                $GLOBALS['cookie_path'],
                                                                                                                                                                                $GLOBALS['cookie_domain']);
                                                                                                                                                                            ...
                                                                                                                                                                            if (0 < $_SESSION['user_id']) {
                                                                                                                                                                                ...
                                                                                                                                                                                if ($result['error'] == 0) {
                                                                                                                                                                                    ...
                                                                                                                                                                                    if (0 < $row) {
                                                                                                                                                                                        ...
                                                                                                                                                                                        $result['error'] = 0;
                                                                                                                                                                                        $consignee['user_id'] = $_SESSION['user_id'];
                                                                                                                                                                                        $saveConsignee = save_consignee($consignee,
                                                                                                                                                                                            true);
                                                                                                                                                                                ...
                                                                                                                                                                                if ($_CFG['use_coupons'] == 1 && $flow_type == CART_GENERAL_GOODS) {
                                                                                                                                                                                    ...
                                                                                                                                                                                    $user_coupons = get_user_coupons_list($_SESSION['user_id'],
                                                                                                                                                                                        true,
                                                                                                                                                                                        $total['goods_price'],
                                                                                                                                                                                        $cart_goods,
                                                                                                                                                                                        true,
                                                                                                                                                                                    ...
                                                                                                                                                                                    if (defined('THEME_EXTENSION')) {
                                                                                                                                                                                        $coupons_list = get_user_coupons_list($_SESSION['user_id'],
                                                                                                                                                                                            true,
                                                                                                                                                                                            '',
                                                                                                                                                                                            false,
                                                                                                                                                                                            true,
                                                                                                                                                                                        ...
                                                                                                                                                                                        if (!empty($coupons_list)) {
                                                                                                                                                                                            foreach ($coupons_list as $k => $v) {
                                                                                                                                                                                                ...
                                                                                                                                                                                                $coupons_list[$k]['cou_end_time'] = local_date('Y-m-d',
                                                                                                                                                                                                    $v['cou_end_time']);
                                                                                                                                                                                        ...
                                                                                                                                                                                        $smarty->assign('coupons_list',
                                                                                                                                                                                            $coupons_list);
                                                                                                                                                                                    }

                                                                                                                                                                                    foreach ($user_coupons as $k => $v) {
                                                                                                                                                                                        $user_coupons[$k]['cou_type_name'] = $v['cou_type'];
                                                                                                                                                                                        $user_coupons[$k]['cou_end_time'] = local_date('Y-m-d',
                                                                                                                                                                                            $v['cou_end_time']);
                                                                                                                                                                        ...
                                                                                                                                                                        if ($_REQUEST['step'] == 'delete_Consignee') {
                                                                                                                                                                            include 'includes/cls_json.php';
                                                                                                                                                                            $json = new JSON();
                                                                                                                                                                            $res = array(
                                                                                                                                                                                'message' => '',
                                                                                                                                                                            ...
                                                                                                                                                                            if ($_REQUEST['step'] == 'edit_consignee_checked') {
                                                                                                                                                                                include 'includes/cls_json.php';
                                                                                                                                                                                $flow_type = isset($_SESSION['flow_type']) ? intval($_SESSION['flow_type']) : CART_GENERAL_GOODS;
                                                                                                                                                                                ...
                                                                                                                                                                                if ($_REQUEST['step'] == 'edit_offline_store') {
                                                                                                                                                                                    include 'includes/cls_json.php';
                                                                                                                                                                                    $flow_type = isset($_SESSION['flow_type']) ? intval($_SESSION['flow_type']) : CART_GENERAL_GOODS;
...
');
                                                                                                                                                                                            ...
                                                                                                                                                                                            $smarty->assign('order',
                                                                                                                                                                                                $order);
                                                                                                                                                                                            $smarty->assign('is_zc_order',
                                                                                                                                                                                                $order['is_zc_order']);
                                                                                                                                                                                            $smarty->assign('pay_success',
                                                                                                                                                                                                true);
                                                                                                                                                                                        } else {
                                                                                                                                                                                            if ($_REQUEST['act'] == 'check_cart_goods') {
                                                                                                                                                                                                require_once ROOT_PATH . 'includes/cls_json.php';
                                                                                                                                                                                                $json = new JSON();
                                                                                                                                                                                                $result = array(
                                                                                                                                                                                                    'error' => 0,
                                                                                                                                                                                                        ...
                                                                                                                                                                                                        foreach ($res as $val) {
                                                                                                                                                                                                            if (empty($val['is_invalid'])) {
                                                                                                                                                                                                                ...
                                                                                                                                                                                                                if ($val['extension_code'] == 'package_buy') {
                                                                                                                                                                                                                    if ($GLOBALS['_CFG']['use_storage'] == '1' && judge_package_stock($val['goods_id'],
                                                                                                                                                                                                                            $val['goods_number'])) {
                                                                                                                                                                                                                        $result['error'] = 1;
                                                                                                                                                                                                                        $result['message'] = sprintf($_LANG['flow_package_buy_insufficient'],
                                                                                                                                                                                                                            $val['goods_name']);
                                                                                                                                                                                                                        $result['rec_id'] = $key;
                                                                                                                                                                                                                        exit($json->encode($result));
                                                                                                                                                                                                                    }
                                                                                                                                                                                                                ...
                                                                                                                                                                                                                $result['error'] = 1;
                                                                                                                                                                                                                $result['message'] = sprintf($_LANG['goods_lower_frame_notic'],
                                                                                                                                                                                                                    $val['goods_name']);
                                                                                                                                                                                                                $result['rec_id'] = $key;
                                                                                                                                                                                                            }
                                                                                                                                                                                                        }
                                                                                                                                                                                                ...
                                                                                                                                                                                                if ($_REQUEST['act'] == 'onlinepay_edit') {
                                                                                                                                                                                                    ...
                                                                                                                                                                                                    $db->query($sql);
                                                                                                                                                                                                    $order_info = get_table_date('order_info',
                                                                                                                                                                                                        ' order_sn = \'' . $order_sn . '\' ',
                                                                                                                                                                                                        array('order_id'));
