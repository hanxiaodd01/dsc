...
class BCS_RequestCore
{
     ...
     *
     * <ul>
     * <li><code>$curl_handle</code> - <code>resource</code> - Required - The cURL handle resource that represents the
     * in-progress transfer.</li>
     * <li><code>$file_handle</code> - <code>resource</code> - Required - The file handle resource that represents the
     * file on the local file system.</li>
     * <li><code>$length</code> - <code>integer</code> - Required - The length in kilobytes of the data chunk that was
     * transferred.</li>
     * </ul>
     *
    ...
    public function process_response($curl_handle = null, $response = null)
    {
        ...
        if (is_resource($this->curl_handle)) {
            ...
            if ($curl_handle && $response) {
                ...
                return new  $class ($this->response_headers, $this->response_body, $this->response_code,
                    $this->curl_handle);
            }
        }
        // Return false
