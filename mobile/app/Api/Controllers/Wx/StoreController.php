...
class StoreController extends \App\Api\Controllers\Controller
{
    ...
    public function detail(\Illuminate\Http\Request $request)
    {
        ...
        return $this->storeService->detail($request->get('id'), $request->get('page'), $request->get('per_page'),
            $request->get('cate_key'), $request->get('sort'), $request->get('order'), $request->get('cat_id'), $uid);
    }
