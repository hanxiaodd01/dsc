...
class IndexController extends \App\Modules\Base\Controllers\FrontendController
{
    ...
    public function actionDetail()
    {
        ...
        foreach ($seo as $key => $value) {
            $seo[$key] = html_in(str_replace(array('{name}', '{description}'),
    ...
    public function actionPrice()
    {
        ...
        if ($this->goods_id == 0) {
            ...
            $products = get_warehouse_id_attr_number($this->goods_id, $_REQUEST['attr'], $goods['user_id'],
                $warehouse_id, $this->area_id, $area_city);
    ...
    public function actionBuy()
    {
        ...
        $order_goods = get_for_purchasing_goods($start_date, $end_date, $group_buy['goods_id'], $_SESSION['user_id'],
            'group_buy');
