...
class IndexController extends \App\Modules\Base\Controllers\FrontendController
{
    ...
    public function actionTopic()
    {
        if (IS_POST) {
            ...
            if ($action == 'info') {
                show_message('发布话题成功', '返回上一页', url('crowd_funding/index/info', array('id' => $data['pid'])),
                    'success');
            } else {
                show_message('发布话题成功', '返回上一页', url('crowd_funding/index/comment', array('id' => $data['pid'])),
                    'success');
            }
        }
    ...
    public function actionCheckout()
    {
        ...
        if ($shengyu == 0) {
            show_message('该产品已售罄，请选择其他产品', '', url('crowd_funding/index/info', array('id' => $_SESSION['pid'])),
                'warning');
        }
