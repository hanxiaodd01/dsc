...
class CoudanController extends IndexController
{
    ...
    public function actionIndex()
    {
        ...
        $display = in_array($goods_display,
        ...
        if (IS_AJAX) {
            ...
            $favourable_goods_list = favourable_goods_list($_SESSION['user_rank'], $active_id, $sort, $order, $size,
                $page, $this->region_id, $this->area_info['region_id']);
            exit(json_encode(array(
                'list' => $favourable_goods_list['list'],
                'totalPage' => $favourable_goods_list['totalpage']
            )));
        }
    ...
    public function actionAddToCartCoudan()
    {
        ...
        if (!is_numeric($goods_number) || $goods_number <= 0) {
            ...
            $rec_id = addto_cart($goods->goods_id, $goods_number, $goods->spec, $goods->parent, $cart_extends,
                $rec_type);
