...
class IndexController extends \App\Modules\Base\Controllers\FrontendController
{
    ...
    public function actionIndex()
    {
        ...
        $this->order = isset($_REQUEST['order']) && in_array(trim(strtoupper($_REQUEST['order'])),
        ...
        if (IS_AJAX) {
            $this->sort = isset($_REQUEST['sort']) && in_array(trim(strtolower($_REQUEST['sort'])),
                array('goods_id', 'amount', 'popularity', 'integral')) ? trim($_REQUEST['sort']) : 'goods_id';
    ...
    public function actionDetail()
    {
        ...
        $new_goods = get_recommend_goods('new', '', $this->region_id, $this->area_info['region_id'], $this->area_city,
            $goods['user_id']);
        ...
        if ($info['goods_desc']) {
            $info['goods_desc'] = str_replace('src="images/upload', 'src="' . __STATIC__ . '/images/upload',
                $info['goods_desc']);
        }
