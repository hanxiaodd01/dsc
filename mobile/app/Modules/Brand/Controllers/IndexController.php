...
class IndexController extends \App\Modules\Base\Controllers\FrontendController
{
    ...
    public function actionIndex()
    {
            ...
            if ($list) {
                if ($list['top']) {
                    ...
                    foreach ($list['top'] as $key => $val) {
                        $list['top'][$key]['goods'] = brand_get_goods($val['brand_id'], $this->mbid, $this->cate,
                            $this->size, $this->page, $this->sort, $this->order, $this->region_id, $this->area_id, $act,
                            $this->is_ship, $this->price_min, $this->price_max, $this->other_area_id);
                        $arr_tmp = array();
                ...
                if ($list['center']) {
                    ...
                    foreach ($list['center'] as $key => $val) {
                        ...
                        $list['center'][$key]['goods'] = brand_get_goods($val['brand_id'], $this->mbid, $this->cate,
                            $this->size, $this->page, $this->sort, $this->order, $this->region_id, $this->area_id, $act,
                            $this->is_ship, $this->price_min, $this->price_max, $this->other_area_id);
                        $arr_tmp = array();
        ...
        foreach ($seo as $key => $value) {
            $seo[$key] = html_in(str_replace(array('{sitename}', '{key}', '{description}'),
                array(C('shop.shop_name'), C('shop.shop_keywords'), C('shop.shop_desc')), $value));
        }
        ...
        foreach ($res as $key => $row) {
            if ($key == 0) {
                ...
                if (0 < $key && $key < 4) {
                    ...
                    $arr['center'][$row['brand_id']]['brand_bg'] = get_data_path($row['brand_bg'], 'brandbg/',
                        elixir('img/shopping_info_b.png'));
                    ...
                    if (4 < $key && $key < 4) {
                        ...
                        $arr['list1'][$row['brand_id']]['brand_desc'] = htmlspecialchars($row['brand_desc'],
                            ENT_QUOTES);
                    } else {
                        ...
                        $arr['list2'][$row['brand_id']]['brand_desc'] = htmlspecialchars($row['brand_desc'],
                            ENT_QUOTES);
                    }
                }
            }
    ...
    public function actionDetail()
    {
        ...
        $count = goods_count_by_brand($brand_id, $mbid, $this->cate, $act, $this->is_ship, $this->price_min,
            $this->price_max, $this->region_id, $this->area_id, $this->self, $this->other_area_id);
        $goods_list = brand_get_goods($brand_id, $mbid, $this->cate, $this->size, $this->page, $this->sort,
            $this->order, $this->region_id, $this->area_id, '', $this->is_ship, $this->price_min, $this->price_max,
            $this->type, $this->other_area_id);
        $new_count = goods_count_by_brand($brand_id, $mbid, $this->cate, $act, $this->is_ship, $this->price_min,
            $this->price_max, $this->region_id, $this->area_id, $this->self, 'new', $this->other_area_id);
        $hot_count = goods_count_by_brand($brand_id, $mbid, $this->cate, $act, $this->is_ship, $this->price_min,
            $this->price_max, $this->region_id, $this->area_id, $this->self, 'hot', $this->other_area_id);
        $promote_count = goods_count_by_brand($brand_id, $mbid, $this->cate, $act, $this->is_ship, $this->price_min,
            $this->price_max, $this->region_id, $this->area_id, $this->self, 'promote', $this->other_area_id);
        $best_count = goods_count_by_brand($brand_id, $mbid, $this->cate, $act, $this->is_ship, $this->price_min,
            $this->price_max, $this->region_id, $this->area_id, $this->self, 'best', $this->other_area_id);
        ...
        foreach ($seo as $key => $value) {
            $seo[$key] = html_in(str_replace(array('{sitename}', '{description}', '{name}'),
                array(C('shop.shop_name'), $brand_info['brand_desc'], $brand_info['brand_name']), $value));
        }
    ...
    public function actionGoods()
    {
        if (IS_AJAX) {
            ...
            $goods_list = brand_get_goods_ajax($brand_id, $this->mbid, $this->cate, $size, $page, $this->sort,
                $this->order, $this->region_id, $this->area_id, $act, $this->is_ship, $this->price_min,
                $this->price_max, $type, $this->other_area_id);
