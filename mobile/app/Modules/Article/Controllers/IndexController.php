...
class IndexController extends \App\Modules\Base\Controllers\FrontendController
{
    ...
    public function __construct(
        \App\Repositories\Article\CategoryRepository $category,
        \App\Repositories\Article\ArticleRepository $article
    ) {
        parent::__construct();
    ...
    public function actionIndex()
    {
        ...
        foreach ($seo as $key => $value) {
            $seo[$key] = html_in(str_replace(array('{sitename}', '{key}', '{name}', '{description}', '{article_class}'),
                array(
                    C('shop.shop_name'),
                    $article_cat['keywords'],
                    $article_cat['cat_name'],
                    $article_cat['cat_desc'],
