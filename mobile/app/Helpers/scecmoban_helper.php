...
function get_merchants_goods_comment($ru_id)
{
    ...
    @$arr['cmt']['commentRank']['zconments'] = get_conments_stars($arr['commentRank']['mc_all'],
        ...
        $arr['commentRank']['mc_four'], $arr['commentRank']['mc_five']);
    @$arr['cmt']['commentServer']['zconments'] = get_conments_stars($arr['commentServer']['mc_all'],
        ...
        $arr['commentServer']['mc_four'], $arr['commentServer']['mc_five']);
    @$arr['cmt']['commentDelivery']['zconments'] = get_conments_stars($arr['commentDelivery']['mc_all'],
        ...
        $arr['commentDelivery']['mc_four'], $arr['commentDelivery']['mc_five']);
    ...
    if (4 <= $arr['cmt']['commentRank']['zconments']['score']) {
        ...
        if (3 < $arr['cmt']['commentRank']['zconments']['score']) {
    ...
    if (4 <= $arr['cmt']['commentServer']['zconments']['score']) {
        ...
        if (3 < $arr['cmt']['commentServer']['zconments']['score']) {
    ...
    if (4 <= $arr['cmt']['commentDelivery']['zconments']['score']) {
        ...
        if (3 < $arr['cmt']['commentDelivery']['zconments']['score']) {
