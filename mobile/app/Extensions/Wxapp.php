...
class Wxapp
{
    ...
    public function getWaCode($path, $width = '430', $auto_color = true, $line_color = '')
    {
        ...
        $result = $this->curlPost(self::API_URL_PREFIX . self::GET_WXA_CODE . 'access_token=' . self::getAccessToken(),
    ...
    public function getWaCodeUnlimit($scene = '', $path, $width, $auto_color = false, $line_color = '')
    {
        ...
        $result = $this->curlPost(self::API_URL_PREFIX . self::GET_WXA_CODE_UNLIMIT . 'access_token=' . self::getAccessToken(),
            self::json_encode($data));
        return $result;
    }
    ...
    public function getWxaCode($path, $width = '430')
    {
        ...
        $result = $this->curlPost(self::API_URL_PREFIX . self::GET_WXA_QRCODE . 'access_token=' . self::getAccessToken(),
            self::json_encode($data));
        return $result;
    }
    ...
    public function getWxTemplateKeywordList($tpl_id)
    {
        ...
        $result = $this->curlPost(self::API_URL_PREFIX . self::GET_WXA_KEYWORD_LIST . 'access_token=' . self::getAccessToken(),
            self::json_encode($tpl_id));
    ...
    public function wxaddTemplateMessage($tpl_id, $keyword_id)
    {
        ...
        $result = $this->curlPost(self::API_URL_PREFIX . self::GET_WXA_TEMPLATE_ADD . 'access_token=' . self::getAccessToken(),
            self::json_encode($tpl_id));
    ...
    public function wxDelTemplate($template_id)
    {
        ...
        $result = $this->curlPost(self::API_URL_PREFIX . self::GET_WXA_TEMPLATE_DEL . 'access_token=' . self::getAccessToken(),
            self::json_encode($data));
    ...
    {
        $result = $this->curlPost(self::API_URL_PREFIX . self::GET_WXA_TEMPLATE_SEND_URL . 'access_token=' . self::getAccessToken(),
            self::json_encode($data));
