...
class Wechat extends Wechat\SDK
{
    ...
    public function PayRefund($arr = array(), $sslcert = '', $sslkey = '')
    {
        ...
        $arrdata = $this->getPaySign($arr);
        $xmldata = $this->xml_encode($arrdata);
        $result = $this->postXmlSSLCurl(self::PAY_PREFIX . self::PAY_REFUND, $xmldata, $this->curl_timeout, $sslcert,
            $sslkey);
    ...
    public function QueryRedpack($arr = array(), $sslcert = '', $sslkey = '')
    {
        ...
        $arrdata = $this->getRedpackSign($arr);
        $xmldata = $this->xml_encode($arrdata);
        $result = $this->postXmlSSLCurl(self::PAY_PREFIX . self::REDPACK_QUERY, $xmldata, $this->curl_timeout, $sslcert,
            $sslkey);
    ...
    public function MchPay($arr = array(), $sslcert = '', $sslkey = '')
    {
        ...
        $xmldata = $this->xml_encode($arrdata);
        $result = $this->postXmlSSLCurl(self::PAY_PREFIX . self::MCHPAY_TRANS, $xmldata, $this->curl_timeout, $sslcert,
            $sslkey);
    ...
    public function MchPayQuery($arr = array(), $sslcert = '', $sslkey = '')
    {
        ...
        $arrdata = $this->getPaySign($arr);
        $xmldata = $this->xml_encode($arrdata);
        $result = $this->postXmlSSLCurl(self::PAY_PREFIX . self::MCHPAY_QUERY, $xmldata, $this->curl_timeout, $sslcert,
            $sslkey);
    ...
    public function createTags($name)
    {
        ...
        $result = $this->http_post(self::API_URL_PREFIX . self::TAGS_CREATE_URL . 'access_token=' . $this->get_access_token(),
    ...
    public function updateTags($tagid, $name)
    {
        ...
        $result = $this->http_post(self::API_URL_PREFIX . self::TAGS_UPDATE_URL . 'access_token=' . $this->get_access_token(),
            self::json_encode($data));
    ...
    public function deleteTags($tagid)
    {
        ...
        $result = $this->http_post(self::API_URL_PREFIX . self::TAGS_DELETE_URL . 'access_token=' . $this->get_access_token(),
            self::json_encode($data));
    ...
    public function getUserTaglist($openid)
    {
        ...
        $result = $this->http_post(self::API_URL_PREFIX . self::TAGS_GETIDLIST_URL . 'access_token=' . $this->get_access_token(),
            self::json_encode($data));
    ...
    public function batchtaggingTagsMembers($tagid, $openid_list)
    {
        ...
        $result = $this->http_post(self::API_URL_PREFIX . self::TAGS_MEMBER_BATCHTAGGING_URL . 'access_token=' . $this->get_access_token(),
            self::json_encode($data));
    ...
    public function batchuntaggingTagsMembers($tagid, $openid_list)
    {
        ...
        $data = array('openid_list' => $openid_list, 'tagid' => $tagid);
        $result = $this->http_post(self::API_URL_PREFIX . self::TAGS_MEMBER_BATCHUNTAGGING_URL . 'access_token=' . $this->get_access_token(),
            self::json_encode($data));
