...
class AddressRepository
{
    ...
    {
        return \App\Models\UserAddress::select('address_id', 'address_name', 'consignee', 'email', 'mobile', 'country',
            'province', 'city', 'district', 'street', 'address')->where('user_id', $id)->get()->toArray();
    }
