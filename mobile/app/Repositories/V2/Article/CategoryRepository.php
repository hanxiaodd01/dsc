...
class CategoryRepository implements \app\classes\interfaces\RepositoryInterface
{
    ...
    {
        return \app\models\ArticleCat::orderBy('sort_order')->orderBy('cat_id')->paginate($perPage,
            $columns)->toArray();
    }
    ...
    {
        return \app\models\ArticleCat::where('parent_id', 0)->where('cat_type',
            1)->orderBy('sort_order')->orderBy('cat_id')->get()->toArray();
    }
