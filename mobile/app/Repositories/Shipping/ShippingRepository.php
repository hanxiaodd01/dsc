...
class ShippingRepository
{
    ...
    public function total_shipping_fee($address, $products, $shipping_id, $ruId = 0)
    {
        ...
        $result = \App\Models\ShippingArea::select('shipping_area.*')->with(array(
    ...
    {
        $res = \App\Models\SellerShopinfo::select('shipping.shipping_id', 'shipping.shipping_name',
            'shipping.shipping_code')->join('shipping', 'shipping.shipping_id', '=',
            'seller_shopinfo.shipping_id')->where('ru_id', $ru_id)->first();
