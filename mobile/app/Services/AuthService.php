...
class AuthService
{
	...
	public function createUser($args)
	{
		...
		$extends = array('nick_name' => $args['nickname'], 'sex' => $args['sex'], 'user_picture' => $args['headimgurl'], 'reg_time' => gmtime(), 'parent_id' => $args['parent_id'], 'drp_parent_id' => $args['drp_parent_id']);
	...
	{
		$key = strtoupper('HTTP_X_' . app('config')->get('app.name') . '_Authorization');
