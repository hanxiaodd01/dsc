...
class UserService
{
    ...
    public function __construct(
        ...
        \App\Repositories\Store\CollectStoreRepository $collectStoreRepository,
        ...
        \App\Repositories\Bonus\UserBonusRepository $userBonusRepository,
        ...
        \App\Repositories\Comment\CommentRepository $commentRepository,
    ...
    {
        $orderList = $this->orderRepository->getOrderByUserId($args['uid'], $args['status'], $args['type'],
            $args['page'], $args['size']);
    ...
    public function collectStore($uid)
    {
        ...
        foreach ($list as $key => $value) {
            ...
            $list[$key]['logo_thumb'] = get_image_path(str_replace('../', '',
                $store[0]['sellershopinfo']['logo_thumb']));
    ...
    public function orderActionChange(
        $order_id,
        $action_user = 'admin',
        $order_status = 0,
        $shipping_status = 0,
