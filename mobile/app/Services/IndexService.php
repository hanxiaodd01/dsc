...
class IndexService
{
    ...
    public function __construct(
        ...
        \App\Repositories\Article\ArticleRepository $articleRepository,
    ...
    public function article()
    {
        ...
        foreach ($res as $k => $v) {
            $res[$k]['content'] = str_replace(array('src="/images/upload', 'src="images/upload'),
                'src="' . $rootPath . '/images/upload', $v['content']);
        }
