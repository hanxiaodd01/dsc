...
class Alioss
{
    ...
    public function __construct($config)
    {
        ...
        // OssClient初始化
        try {
            $this->client = new OssClient($this->config['accessKeyId'], $this->config['accessKeySecret'],
                $this->config['endpoint'], $this->config['isCName']);
    ...
    public function save(&$file, $replace = true)
    {
        ...
        $options = array();
        try {
            $this->client->putObject($bucket, $object, '{$object}');
