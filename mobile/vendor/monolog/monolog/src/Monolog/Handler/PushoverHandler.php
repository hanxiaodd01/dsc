...
class PushoverHandler extends SocketHandler
{
     ...
     * @param int          $retry             The retry parameter specifies how often (in seconds) the Pushover servers
     *                                        will send the same notification to the user.
     * @param int          $expire            The expire parameter specifies how many seconds your notification will
