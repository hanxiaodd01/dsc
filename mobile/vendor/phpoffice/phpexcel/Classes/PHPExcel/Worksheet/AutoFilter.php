    ...
    private function _dynamicFilterDateRange($dynamicRuleType, &$filterColumn)
    {
        ...
        switch ($dynamicRuleType) {
            ...
            case PHPExcel_Worksheet_AutoFilter_Column_Rule::AUTOFILTER_RULETYPE_DYNAMIC_NEXTQUARTER :
                ...
                $maxVal = (int)PHPExcel_Shared_Date::PHPtoExcel(gmmktime(0, 0, 0, date('t', $baseDate),
                    (1 + $thisQuarter) * 3, date('Y', $baseDate)));
                ++$maxVal;
                $val = (int)PHPExcel_Shared_Date::PHPToExcel(gmmktime(0, 0, 0, 1, 1 + $thisQuarter * 3,
                    date('Y', $baseDate)));
                break;
            ...
            case PHPExcel_Worksheet_AutoFilter_Column_Rule::AUTOFILTER_RULETYPE_DYNAMIC_NEXTMONTH :
                ...
                ++$maxVal;
                $val = (int)PHPExcel_Shared_Date::PHPToExcel(gmmktime(0, 0, 0, 1, date('m', $baseDate),
                    date('Y', $baseDate)));
                break;
        ...
        foreach ($this->_columns as $columnID => $filterColumn) {
            ...
            switch ($filterColumn->getFilterType()) {
                ...
                case PHPExcel_Worksheet_AutoFilter_Column::AUTOFILTER_FILTERTYPE_DYNAMICFILTER :
                    ...
                    foreach ($rules as $rule) {
                        ...
                        if (($dynamicRuleType == PHPExcel_Worksheet_AutoFilter_Column_Rule::AUTOFILTER_RULETYPE_DYNAMIC_ABOVEAVERAGE) ||
                            ...
                            $average = PHPExcel_Calculation::getInstance()->calculateFormula($averageFormula, null,
                            ...
                            if ($dynamicRuleType{0} == 'M' || $dynamicRuleType{0} == 'Q') {
                                ...
                                //	Date Range
                                $columnFilterTests[$columnID] = $this->_dynamicFilterDateRange($dynamicRuleType,
                                    $filterColumn);
                                break;
                            }
                        }
                ...
                case PHPExcel_Worksheet_AutoFilter_Column::AUTOFILTER_FILTERTYPE_TOPTENFILTER :
                    ...
                    $maxVal = $this->_calculateTopTenValue($columnID, $rangeStart[1] + 1, $rangeEnd[1], $toptenRuleType,
                        $ruleValue);
