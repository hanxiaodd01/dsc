...
class PHPExcel_Calculation_LookupRef
{
    ...
    public static function INDIRECT($cellAddress = null, PHPExcel_Cell $pCell = null)
    {
        ...
        if ((!preg_match('/^' . PHPExcel_Calculation::CALCULATION_REGEXP_CELLREF . '$/i', $cellAddress1, $matches)) ||
            ...
            if (!preg_match('/^' . PHPExcel_Calculation::CALCULATION_REGEXP_NAMEDRANGE . '$/i', $cellAddress1,
                $matches)) {
                return PHPExcel_Calculation_Functions::REF();
            }
     ...
     *                            result to refer to. Using 5 as the cols argument specifies that the upper-left cell
     *                            in the reference is five columns to the right of reference. Cols can be positive
     *                            (which means to the right of the starting reference) or negative (which means to the
...
//				echo '$i='.$i.'<br />';
     ...
     * @return    array
     *
     * Unlike the Excel TRANSPOSE function, which will only work on a single row or column, this function will
     * transpose a full matrix.
     */
