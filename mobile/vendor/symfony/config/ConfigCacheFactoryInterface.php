...
interface ConfigCacheFactoryInterface
{
     ...
     * @param callable $callable The callable to be executed when the cache needs to be filled (i. e. is not fresh).
     *                           The cache will be passed as the only parameter to this callback
     *
