...
class DirectoryResourceTest extends TestCase
{
    ...
    public function testIsFresh()
    {
        ...
        $this->assertFalse($resource->isFresh(time() - 86400),
    ...
    public function testIsFreshUpdateFile()
    {
        ...
        $this->assertFalse($resource->isFresh(time() + 10),
    ...
    public function testIsFreshNewFileWithDifferentPattern()
    {
        ...
        $this->assertTrue($resource->isFresh(time() + 10),
            '->isFresh() returns true if a new file with a non-matching pattern is added');
    }
