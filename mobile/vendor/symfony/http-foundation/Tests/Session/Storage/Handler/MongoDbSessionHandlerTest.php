    ...
    public function testRead()
    {
        ...
        $collection->expects($this->once())
            ...
            ->will($this->returnCallback(function ($criteria) use ($testTimeout) {
                ...
                if (phpversion('mongodb')) {
                    $this->assertInstanceOf('MongoDB\BSON\UTCDateTime',
                    ...
                    $this->assertGreaterThanOrEqual($criteria[$this->options['expiry_field']]['$gte']->sec,
                        $testTimeout);
                }
                ...
                if (phpversion('mongodb')) {
                    $fields[$this->options['data_field']] = new \MongoDB\BSON\Binary('bar',
