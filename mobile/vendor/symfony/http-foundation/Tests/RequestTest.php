...
class RequestTest extends TestCase
{
    ...
    /**
     * @group               legacy
     * @expectedDeprecation The "Symfony\Component\HttpFoundation\Request::setTrustedHeaderName()" method is deprecated
     *                      since Symfony 3.3 and will be removed in 4.0. Use the $trustedHeaderSet argument of the
    ...
    /**
     * @group               legacy
     * @expectedDeprecation Checking only for cacheable HTTP methods with
     *                      Symfony\Component\HttpFoundation\Request::isMethodSafe() is deprecated since Symfony 3.2
     *                      and will throw an exception in 4.0. Disable checking only for cacheable methods by calling
     *                      the method with `false` as first argument or use the Request::isMethodCacheable() instead.
     */
