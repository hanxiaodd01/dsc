...
EOF;
     ...
     * @group                    legacy
     * @expectedException \LogicException
     * @expectedExceptionMessage Bundle "ParentCBundle" is directly extended by two bundles "ChildC2Bundle" and
     *                           "ChildC1Bundle".
     */
    ...
    public function testTerminateDelegatesTerminationOnlyForTerminableInterface()
    {
        ...
        $this->assertFalse($httpKernel->terminateCalled,
    ...
    /**
     * @group               legacy
     * @expectedDeprecation The Symfony\Component\HttpKernel\Kernel::getEnvParameters() method is deprecated as of 3.3
     *                      and will be removed in 4.0. Use the %cenv()%c syntax to get the value of any environment
     *                      variable from configuration files instead.
     * @expectedDeprecation The support of special environment variables that start with SYMFONY__ (such as
     *                      "SYMFONY__FOO__BAR") is deprecated as of 3.3 and will be removed in 4.0. Use the %cenv()%c
     *                      syntax instead to get the value of environment variables in configuration files.
     */
