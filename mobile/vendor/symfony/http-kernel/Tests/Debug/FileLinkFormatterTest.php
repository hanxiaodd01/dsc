...
class FileLinkFormatterTest extends TestCase
{
    ...
    public function testWhenFileLinkFormatAndRequest()
    {
        ...
        $sut = new FileLinkFormatter('debug://open?url=file://%f&line=%l', $requestStack, __DIR__,
    ...
    public function testWhenNoFileLinkFormatAndRequest()
    {
        ...
        $this->assertSame('http://www.example.org/app.php/_profiler/open?file=file.php&line=3#line3',
            $sut->format($file, 3));
    }
}
