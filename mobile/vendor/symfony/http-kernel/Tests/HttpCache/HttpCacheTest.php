...
class HttpCacheTest extends HttpCacheTestCase
{
    ...
    public function testHitsCachedResponsesWithExpiresHeader()
    {
        ...
        $this->assertLessThan(2,
            strtotime($this->responses[0]->headers->get('Date')) - strtotime($this->response->headers->get('Date')));
    ...
    public function testDegradationWhenCacheLocked()
    {
        ...
        $this->setNextResponse(200, array('Cache-Control' => 'public, s-maxage=5', 'Last-Modified' => 'some while ago'),
            'Old response');
    ...
    public function testServesResponseWhileFreshAndRevalidatesWithLastModifiedInformation()
    {
        ...
        $this->setNextResponse(200, array(), 'Hello World',
