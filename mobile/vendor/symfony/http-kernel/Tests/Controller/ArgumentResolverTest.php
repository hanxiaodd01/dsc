...
class ArgumentResolverTest extends TestCase
{
    ...
    public function testGetArgumentsReturnsEmptyArrayWhenNoArguments()
    {
        ...
        $this->assertEquals(array(), self::$resolver->getArguments($request, $controller),
    ...
    public function testGetArgumentsInjectsRequest()
    {
        ...
        $this->assertEquals(array($request), self::$resolver->getArguments($request, $controller),
    ...
    public function testGetNullableArguments()
    {
        ...
        $this->assertEquals(array('foo', new \stdClass(), 'value', 'mandatory'),
            self::$resolver->getArguments($request, $controller));
    }
    ...
    public function testGetNullableArgumentsWithDefaults()
    {
        ...
        $this->assertEquals(array(null, null, 'value', 'mandatory'),
            self::$resolver->getArguments($request, $controller));
    }
