...
class ContainerControllerResolverTest extends ControllerResolverTest
{
     ...
     * @expectedExceptionMessage Controller
     *                           "Symfony\Component\HttpKernel\Tests\Controller\ImpossibleConstructController" cannot
     *                           be fetched from the container because it is private. Did you forget to tag the service
    ...
    /**
     * @expectedException \LogicException
     * @expectedExceptionMessage Controller "app.my_controller" cannot be fetched from the container because it is
     *                           private. Did you forget to tag the service with "controller.service_arguments"?
     */
    ...
    /**
     * @expectedException \LogicException
     * @expectedExceptionMessage Controller "app.my_controller" cannot be called without a method name. Did you forget
     *                           an "__invoke" method?
     */
     ...
     */
    public function testGetControllerOnNonUndefinedFunction(
        $controller,
        $exceptionName = null,
