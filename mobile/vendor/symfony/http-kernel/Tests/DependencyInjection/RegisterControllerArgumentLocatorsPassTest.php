...
class RegisterControllerArgumentLocatorsPassTest extends TestCase
{
     ...
     * @expectedExceptionMessage Class "Symfony\Component\HttpKernel\Tests\DependencyInjection\NotFound" used for
     *                           service "foo" cannot be found.
     */
    ...
    /**
     * @expectedException \Symfony\Component\DependencyInjection\Exception\InvalidArgumentException
     * @expectedExceptionMessage Missing "action" attribute on tag "controller.service_arguments" {"argument":"bar"}
     *                           for service "foo".
     */
    ...
    /**
     * @expectedException \Symfony\Component\DependencyInjection\Exception\InvalidArgumentException
     * @expectedExceptionMessage Missing "argument" attribute on tag "controller.service_arguments"
     *                           {"action":"fooAction"} for service "foo".
     */
    ...
    /**
     * @expectedException \Symfony\Component\DependencyInjection\Exception\InvalidArgumentException
     * @expectedExceptionMessage Missing "id" attribute on tag "controller.service_arguments"
     *                           {"action":"fooAction","argument":"bar"} for service "foo".
     */
    ...
    /**
     * @expectedException \Symfony\Component\DependencyInjection\Exception\InvalidArgumentException
     * @expectedExceptionMessage Invalid "action" attribute on tag "controller.service_arguments" for service "foo": no
     *                           public "barAction()" method found on class
     *                           "Symfony\Component\HttpKernel\Tests\DependencyInjection\RegisterTestController".
     */
    public function testInvalidMethod()
    {
        ...
        $container->register('foo', RegisterTestController::class)
            ->addTag('controller.service_arguments',
                array('action' => 'barAction', 'argument' => 'bar', 'id' => 'bar_service'));
    ...
    /**
     * @expectedException \Symfony\Component\DependencyInjection\Exception\InvalidArgumentException
     * @expectedExceptionMessage Invalid "controller.service_arguments" tag for service "foo": method "fooAction()" has
     *                           no "baz" argument on class
     *                           "Symfony\Component\HttpKernel\Tests\DependencyInjection\RegisterTestController".
     */
    public function testInvalidArgument()
    {
        ...
        $container->register('foo', RegisterTestController::class)
            ->addTag('controller.service_arguments',
                array('action' => 'fooAction', 'argument' => 'baz', 'id' => 'bar'));
    ...
    public function testAllActions()
    {
        ...
        $expected = array(
            'bar' => new ServiceClosureArgument(new TypedReference(ControllerDummy::class, ControllerDummy::class,
                RegisterTestController::class, ContainerInterface::IGNORE_ON_INVALID_REFERENCE))
        );
    ...
    public function testExplicitArgument()
    {
        ...
        $container->register('foo', RegisterTestController::class)
            ...
            ->addTag('controller.service_arguments',
                array('action' => 'fooAction', 'argument' => 'bar', 'id' => 'baz')) // should be ignored, the first wins
        ;
        ...
        $expected = array(
            'bar' => new ServiceClosureArgument(new TypedReference('bar', ControllerDummy::class,
                RegisterTestController::class))
        );
        $this->assertEquals($expected, $locator->getArgument(0));
    }
    ...
    public function testOptionalArgument()
    {
        ...
        $container->register('foo', RegisterTestController::class)
            ->addTag('controller.service_arguments',
                array('action' => 'fooAction', 'argument' => 'bar', 'id' => '?bar'));
    ...
    /**
     * @expectedException \Symfony\Component\DependencyInjection\Exception\InvalidArgumentException
     * @expectedExceptionMessage Cannot determine controller argument for
     *                           "Symfony\Component\HttpKernel\Tests\DependencyInjection\NonExistentClassController::fooAction()":
     *                           the $nonExistent argument is type-hinted with the non-existent class or interface:
     *                           "Symfony\Component\HttpKernel\Tests\DependencyInjection\NonExistentClass". Did you
     *                           forget to add a use statement?
     */
     ...
     * @expectedException \Symfony\Component\DependencyInjection\Exception\InvalidArgumentException
     * @expectedExceptionMessage Cannot determine controller argument for
     *                           "Symfony\Component\HttpKernel\Tests\DependencyInjection\NonExistentClassDifferentNamespaceController::fooAction()":
     *                           the $nonExistent argument is type-hinted with the non-existent class or interface:
