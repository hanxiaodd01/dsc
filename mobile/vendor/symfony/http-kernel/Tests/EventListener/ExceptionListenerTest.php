...
class ExceptionListenerTest extends TestCase
{
    ...
    public function provider()
    {
        ...
        $event = new GetResponseForExceptionEvent(new TestKernel(), $request, HttpKernelInterface::MASTER_REQUEST,
            $exception);
        $event2 = new GetResponseForExceptionEvent(new TestKernelThatThrowsException(), $request,
            HttpKernelInterface::MASTER_REQUEST, $exception);
    ...
    public function testSubRequestFormat()
    {
        ...
        $event = new GetResponseForExceptionEvent($kernel, $request, HttpKernelInterface::MASTER_REQUEST,
            new \Exception('foo'));
