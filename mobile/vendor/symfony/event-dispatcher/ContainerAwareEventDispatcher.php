...
class ContainerAwareEventDispatcher extends EventDispatcher
{
    ...
    public function __construct(ContainerInterface $container)
    {
        ...
        if (__CLASS__ !== $class) {
            @trigger_error(sprintf('The %s class is deprecated since Symfony 3.3 and will be removed in 4.0. Use EventDispatcher with closure factories instead.',
    ...
    {
        @trigger_error('The ' . __METHOD__ . '() method is deprecated since Symfony 3.3 as its class will be removed in 4.0. Inject the container or the services you need in your listeners/subscribers instead.',
            E_USER_DEPRECATED);
