...
class ProcessTest extends TestCase
{
    ...
    /**
     * @group               legacy
     * @expectedDeprecation The provided cwd does not exist. Command is currently ran against getcwd(). This behavior
     *                      is deprecated since Symfony 3.4 and will be removed in 4.0.
     */
