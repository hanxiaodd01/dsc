...
class PropertyAccessorTest extends TestCase
{
    ...
    {
        $this->assertSame('Bernhard',
            $this->propertyAccessor->getValue(new TestClassMagicGet('Bernhard'), 'magicProperty'));
    }
    ...
    public function testGetValueReadsMagicGetThatReturnsConstant()
    {
        $this->assertSame('constant value',
            $this->propertyAccessor->getValue(new TestClassMagicGet('Bernhard'), 'constantMagicProperty'));
    }
    ...
    public function testGetValueReadsMagicCallThatReturnsConstant()
    {
        ...
        $this->assertSame('constant value',
            $this->propertyAccessor->getValue(new TestClassMagicCall('Bernhard'), 'constantMagicCallProperty'));
    }
    ...
    {
        $this->propertyAccessor = new PropertyAccessor(false, true);
        $this->assertNull($this->propertyAccessor->getValue(array('index' => array('nullable' => null)),
            '[index][nullable]'));
    }
    ...
    {
        $this->assertFalse($this->propertyAccessor->isReadable(new TestClassMagicCall('Bernhard'),
            'magicCallProperty'));
    }
    ...
    {
        $this->assertFalse($this->propertyAccessor->isWritable(new TestClassMagicCall('Bernhard'),
            'magicCallProperty'));
    }
    ...
    public function getValidPropertyPaths()
    {
        return array(
            ...
            array(
                (object)array('property' => (object)array('firstName' => 'Bernhard')),
                'property.firstName',
                'Bernhard'
            ),
            ...
            array(
                ...
                'publicGetter.publicGetter.publicGetSetter',
                'bar'
            ),
            array(
                new TestClass(array('foo' => array('baz' => new TestClass('bar')))),
                'publicGetter[foo][baz].publicGetSetter',
                'bar'
            ),
        );
    }
    ...
    public function getReferenceChainObjectsForSetValue()
    {
        return array(
            ...
            array(
                new TestClassSetValue(array('a' => array('b' => array('c' => new TestClassSetValue('old-value'))))),
                'value[a][b][c].value',
                'new-value'
            ),
    ...
    public function getReferenceChainObjectsForIsWritable()
    {
        return array(
            ...
            array(
                new TestClassIsWritable(new \ArrayIterator(array('a' => array('b' => 'old-value')))),
                'value[a][b]',
                true
            ),
            array(
                new TestClassIsWritable(array('a' => array('b' => array('c' => new TestClassSetValue('old-value'))))),
                'value[a][b][c].value',
                true
            ),
        );
