...
abstract class PropertyAccessorCollectionTest extends PropertyAccessorArrayAccessTest
{
     ...
     * @expectedExceptionMessageRegExp /Could not determine access type for property "axes" in class
     *                                 "Mock_PropertyAccessorCollectionTest_CarNoAdderAndRemover_[^"]*"./
     */
    ...
    /**
     * @expectedException \Symfony\Component\PropertyAccess\Exception\NoSuchPropertyException
     * expectedExceptionMessageRegExp /The property "axes" in class "Mock_PropertyAccessorCollectionTest_Car[^"]*" can
     * be defined with the methods "addAxis()", "removeAxis()" but the new value must be an array or an instance of
     * \Traversable, "string" given./
     */
