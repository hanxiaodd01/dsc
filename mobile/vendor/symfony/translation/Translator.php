...
class Translator implements TranslatorInterface, TranslatorBagInterface
{
    ...
    public function __construct($locale, $formatter = null, $cacheDir = null, $debug = false)
    {
        ...
        if ($formatter instanceof MessageSelector) {
            ...
            @trigger_error(sprintf('Passing a "%s" instance into the "%s" as a second argument is deprecated since Symfony 3.4 and will be removed in 4.0. Inject a "%s" implementation instead.',
                MessageSelector::class, __METHOD__, MessageFormatterInterface::class), E_USER_DEPRECATED);
...
EOF
    ...
    {
        return $this->cacheDir . '/catalogue.' . $locale . '.' . strtr(substr(base64_encode(hash('sha256',
                serialize($this->fallbackLocales), true)), 0, 7), '/', '_') . '.php';
    }
