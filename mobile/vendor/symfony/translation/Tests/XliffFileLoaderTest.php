...
class XliffFileLoaderTest extends TestCase
{
    ...
    public function testIncompleteResource()
    {
        ...
        $this->assertEquals(array('foo' => 'bar', 'extra' => 'extra', 'key' => '', 'test' => 'with'),
    ...
    public function testEncoding()
    {
        ...
        $this->assertEquals(array('notes' => array(array('content' => utf8_decode('bäz'))), 'id' => '1'),
    ...
    public function testLoadNotes()
    {
        ...
        $this->assertEquals(array('notes' => array(array('priority' => 1, 'content' => 'foo')), 'id' => '1'),
            $catalogue->getMetadata('foo', 'domain1'));
        // message without target
        $this->assertEquals(array('notes' => array(array('content' => 'bar', 'from' => 'foo')), 'id' => '2'),
    ...
    public function testLoadVersion2()
    {
        ...
        // target attributes
        $this->assertEquals(array('target-attributes' => array('order' => 1)),
