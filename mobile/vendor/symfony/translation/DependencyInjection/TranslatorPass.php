...
class TranslatorPass implements CompilerPassInterface
{
    ...
    public function __construct(
        ...
        $readerServiceId = 'translation.loader',
        ...
        if ('translation.loader' === $readerServiceId && 2 > func_num_args()) {
            @trigger_error('The default value for $readerServiceId will change in 4.0 to "translation.reader".',
                E_USER_DEPRECATED);
        }
    ...
    public function process(ContainerBuilder $container)
    {
        ...
        if ($container->hasDefinition($this->debugCommandServiceId)) {
            $container->getDefinition($this->debugCommandServiceId)->replaceArgument(4,
                $container->getParameter('twig.default_path'));
        }

        if ($container->hasDefinition($this->updateCommandServiceId)) {
            $container->getDefinition($this->updateCommandServiceId)->replaceArgument(5,
                $container->getParameter('twig.default_path'));
        }
    }
}
