...
class InlineTest extends TestCase
{
    ...
    {
        $this->assertSame($value, Inline::parse($yaml, $flags),
     ...
     *                      will be removed in 4.0. Use the !php/const (without the colon) tag instead on line 1.
    ...
    /**
     * @group               legacy
     * @expectedDeprecation Using a colon after an unquoted mapping key that is not followed by an indication character
     *                      (i.e. " ", ",", "[", "]", "{", "}") is deprecated since version 3.2 and will throw a
     *                      ParseException in 4.0 on line 1. throws \Symfony\Component\Yaml\Exception\ParseException in
     *                      4.0
     */
    ...
    public function testParseUnquotedScalarStartingWithReservedIndicator($indicator)
    {
        if (method_exists($this, 'expectExceptionMessage')) {
            ...
            $this->expectExceptionMessage(sprintf('cannot start a plain scalar; you need to quote the scalar at line 1 (near "%sfoo ").',
                $indicator));
        } else {
            $this->setExpectedException(ParseException::class,
                sprintf('cannot start a plain scalar; you need to quote the scalar at line 1 (near "%sfoo ").',
                    $indicator));
        }
    ...
    /**
     * @group               legacy
     * @expectedDeprecation Not quoting the scalar "%bar " starting with the "%" indicator character is deprecated
     *                      since Symfony 3.1 and will throw a ParseException in 4.0 on line 1. throws
     *                      \Symfony\Component\Yaml\Exception\ParseException in 4.0
     */
    ...
    /**
     * @group               legacy
     * @expectedDeprecation Omitting the key of a mapping is deprecated and will throw a ParseException in 4.0 on line
     *                      1.
     */
    ...
    /**
     * @group               legacy
     * @expectedDeprecation Implicit casting of incompatible mapping keys to strings is deprecated since version 3.3
     *                      and will throw \Symfony\Component\Yaml\Exception\ParseException in 4.0. Quote your
     *                      evaluable mapping keys instead on line 1.
    ...
    /**
     * @group               legacy
     * @expectedDeprecation Support for the !str tag is deprecated since version 3.4. Use the !!str tag instead on line
     *                      1.
     */
