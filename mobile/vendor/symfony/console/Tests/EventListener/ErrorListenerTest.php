...
class ErrorListenerTest extends TestCase
{
    public function testOnConsoleError()
    {
        ...
        $logger
            ...
            ->with('Error thrown while running command "{command}". Message: "{message}"',
                array('error' => $error, 'command' => 'test:run --foo=baz buzz', 'message' => 'An error occurred'));
    ...
    public function testOnConsoleErrorWithNoCommandAndNoInputString()
    {
        ...
        $logger
            ...
            ->with('An error occurred while using the console. Message: "{message}"',
                array('error' => $error, 'message' => 'An error occurred'));
    ...
    public function testOnConsoleTerminateForNonZeroExitCodeWritesToLog()
    {
        ...
        $listener = new ErrorListener($logger);
        $listener->onConsoleTerminate($this->getConsoleTerminateEvent(new ArgvInput(array('console.php', 'test:run')),
            255));
    }
    ...
    public function testAllKindsOfInputCanBeLogged()
    {
        ...
        $logger
            ...
            ->with('Command "{command}" exited with code "{code}"',
                array('command' => 'test:run --foo=bar', 'code' => 255));
