...
class ApplicationTest extends TestCase
{
    ...
    public function testRenderException()
    {
        ...
        $tester->run(array('command' => 'foo'),
            array('decorated' => false, 'verbosity' => Output::VERBOSITY_VERBOSE, 'capture_stderr_separately' => true));
        ...
        $tester->run(array('command' => 'list', '--foo' => true),
            array('decorated' => false, 'capture_stderr_separately' => true));
        ...
        $this->assertStringEqualsFile(self::$fixturesPath . '/application_renderexception3.txt',
            $tester->getErrorOutput(true), '->renderException() renders a pretty exceptions with previous exceptions');
        ...
        $this->assertStringEqualsFile(self::$fixturesPath . '/application_renderexception4.txt',
            $tester->getErrorOutput(true), '->renderException() wraps messages when they are bigger than the terminal');
        putenv('COLUMNS=120');
    }
    ...
    public function testRenderExceptionEscapesLines()
    {
        ...
        $tester->run(array('command' => 'foo'), array('decorated' => false));
        $this->assertStringEqualsFile(self::$fixturesPath . '/application_renderexception_escapeslines.txt',
    ...
    public function testRenderExceptionLineBreaks()
    {
        ...
        $tester->run(array('command' => 'foo'), array('decorated' => false));
        $this->assertStringEqualsFile(self::$fixturesPath . '/application_renderexception_linebreaks.txt',
    ...
    /**
     * @group               legacy
     * @expectedDeprecation The "ConsoleEvents::EXCEPTION" event is deprecated since Symfony 3.3 and will be removed in
     *                      4.0. Listen to the "ConsoleEvents::ERROR" event instead.
     */
