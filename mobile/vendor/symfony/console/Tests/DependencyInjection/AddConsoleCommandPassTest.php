...
class AddConsoleCommandPassTest extends TestCase
{
    ...
    public function testProcessRegistersLazyCommands()
    {
        ...
        $this->assertSame(array('my:command' => 'my-command', 'my:alias' => 'my-command'),
        ...
        $this->assertSame(array('console.command.symfony_component_console_tests_dependencyinjection_mycommand' => 'my-command'),
        ...
        $this->assertSame(array(array('setName', array('my:command')), array('setAliases', array(array('my:alias')))),
    ...
    public function testProcessFallsBackToDefaultName()
    {
        ...
        $this->assertSame(array('console.command.symfony_component_console_tests_dependencyinjection_namedcommand' => 'with-default-name'),
            $container->getParameter('console.command.ids'));
        ...
        $this->assertSame(array('new-name' => 'with-default-name'),
