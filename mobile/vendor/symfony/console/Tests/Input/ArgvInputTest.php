...
class ArgvInputTest extends TestCase
{
    ...
    public function testParseArrayOption()
    {
        ...
        $this->assertSame(array('name' => array('foo', 'bar', '')), $input->getOptions(),
    ...
    {
        $input = new ArgvInput($argv);
        $this->assertEquals($expected, $input->getParameterOption($key, false, $onlyParams),
    ...
    public function testParseOptionWithValueOptionalGivenEmptyAndRequiredArgument()
    {
        ...
        $this->assertEquals(array('foo' => null), $input->getOptions(),
        ...
        $this->assertEquals(array('foo' => '0'), $input->getOptions(),
            '->parse() parses optional options with empty value as null');
        $this->assertEquals(array('name' => 'bar'), $input->getArguments(), '->parse() parses required arguments');
    }
