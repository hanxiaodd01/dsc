...
class FullApplicationTest extends PHPUnit_Framework_TestCase
{
    ...
    {
        $app = new Application;
        $app->instance('Illuminate\Contracts\Debug\ExceptionHandler',
    ...
    public function testGeneratingUrlsForRegexParameters()
    {
        ...
        $app->get('/foo-bar/{baz:[0-9]+}/{boom:[0-9]+}', [
            'as' => 'baz',
            function () {
                //
            }
        ...
        $this->assertEquals('http://lumen.laravel.com/foo-bar/{baz:[0-9]+}/{boom:[0-9]+}?ba=1&bo=2',
            route('baz', ['ba' => 1, 'bo' => 2]));
    ...
    {
        $routes = new FastRoute\RouteCollector(new FastRoute\RouteParser\Std,
