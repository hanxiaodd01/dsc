...
class JWS extends JWT
{
     ...
     * Constructor.
     *
     * @param array  $header           An associative array of headers. The value can be any type accepted by
     *                                 json_encode or a JSON serializable object
     *
     ...
     * @param string $algo The algorithms this JWS should be signed with. Use it if you want to restrict which
     *                     algorithms you want to allow to be validated.
     *
     * @return bool
     * @see JWS::load).
     *
