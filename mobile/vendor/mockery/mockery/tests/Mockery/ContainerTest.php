...
class ContainerTest extends MockeryTestCase
{
    ...
    {
        $m = $this->container->mock(new MockeryTestBar1,
            array('foo' => 1, Mockery\Container::BLOCKS => array('method1')));
     ...
     * @expectedExceptionMessage protectedMethod() cannot be mocked as it a protected method and mocking protected
     *                           methods is not allowed for this mock
     */
