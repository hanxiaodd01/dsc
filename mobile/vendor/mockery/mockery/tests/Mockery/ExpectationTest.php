...
class ExpectationTest extends MockeryTestCase
{
    ...
    public function testExpectationCastToStringFormatting()
    {
        ...
        $this->assertEquals('[foo(1, "bar", object(stdClass), array(\'Spam\'=>\'Ham\',\'Bar\'=>\'Baz\',))]',
            (string)$exp);
    }
