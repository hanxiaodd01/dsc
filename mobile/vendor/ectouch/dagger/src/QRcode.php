...
//---- qrimage.php -----------------------------
        ...
        class QRimage
        {
            ...
            private static function image($frame, $pixelPerPoint = 4, $outerFrame = 4)
            {
                ...
                ImageCopyResized($target_image, $base_image, 0, 0, 0, 0, $imgW * $pixelPerPoint, $imgH * $pixelPerPoint,
                    $imgW, $imgH);
        ...
        class QRrawcode
        {
            ...
            public function init(array $spec)
            {
                ...
                for ($i = 0; $i < QRspec::rsBlockNum1($spec); $i++) {
                    ...
                    $this->rsblocks[$blockNo] = new QRrsblock($dl, array_slice($this->datacode, $dataPos), $el, $ecc,
                        $rs);
