    ...
    public function testBirthNumber()
    {
        ...
        for ($i = 0; $i < 1000; $i++) {
            ...
            $this->assertTrue(checkdate($month, $day, $year),
                "Birth number $birthNumber: date $year/$month/$day is invalid.");
            ...
            if (strlen($birthNumber) == 10) {
                ...
                $this->assertEquals($crc, $refCrc,
                    "Birth number $birthNumber: checksum $crc doesn't match expected $refCrc.");
            }
        }
    }
}
