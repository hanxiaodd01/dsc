...
if (!$smarty->is_cached($tpl, $cache_id)) {
    ...
    $goods['goods_thumb'] = strpos($goods['goods_thumb'], 'http://') === false && strpos($goods['goods_thumb'],
        'https://') === false ? $ecs->url() . $goods['goods_thumb'] : $goods['goods_thumb'];
    $goods['goods_img'] = strpos($goods['goods_img'], 'http://') === false && strpos($goods['goods_img'],
        'https://') === false ? $ecs->url() . $goods['goods_img'] : $goods['goods_img'];
