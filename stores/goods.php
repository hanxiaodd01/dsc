                ...
                if ($_REQUEST['act'] == 'product_add_execute') {
                    ...
                    if ($have_goods_attr) {
                        ...
                        foreach ($product['product_sn'] as $key => $value) {
                            ...
                            $goods_attr_id = handle_goods_attr($product['goods_id'], $id_list, $is_spec_list,
                                $value_price_list);
                    ...
                    make_json_response('', 1, $_LANG['edit_succeed'],
                        array('url' => 'goods.php?act=list&page=' . $page, 'page' => $page));
                } else {
                    if ($_REQUEST['act'] == 'product_remove') {
                        ...
                        if ($result) {
                            $url = 'goods.php?act=product_query&' . str_replace('act=product_remove', '',
                        ...
                        if ($_REQUEST['act'] == 'product_query') {
                            ...
                            if ($_REQUEST['act'] == 'edit_product_sn') {
                                ...
                                if ($_REQUEST['act'] == 'edit_product_number') {
                                    ...
                                    if ($_REQUEST['act'] == 'sel_cat_goodslist') {
                                        ...
                                        if ($_REQUEST['act'] == 'batch_goods_number') {
                                            ...
                                            if (!empty($checkboxes)) {
                                                ...
                                                make_json_response('', 1, '同步成功！', array(
                                                    'url' => 'goods.php?act=list&page=' . $page,
                                                    'page' => $page
                                                ));
                                            } else {
                                                make_json_response('', 2, '请选择商品！', array(
                                                    'url' => 'goods.php?act=list&page=' . $page,
                                                    'page' => $page
                                                ));
                                            }
