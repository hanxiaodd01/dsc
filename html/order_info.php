    ...
    <tr>
        <td style="font-size: 26px; font-weight: bold; height: 40px;">
            <?php if (!empty($shop_info['shop_logo'])) { ?>
                <img src="<?php echo str_replace(array('../'), '', $shop_info['shop_logo']); ?>" alt="Logo"
                     width="134"/>
            <?php } ?>
        ...
        <td style="width: 150px; font-size: 12px;">
            <table style="width: 100%" cellspacing="0" cellpadding="0">
                <tr>
                    ...
                    <td style="height:20px"><?php echo $order_info['order_sn']; ?></td>
                </tr>
                <tr>
                    <td style="height:20px">下单时间：</td>
                    <td style="height:20px"><?php echo $order_info['add_time']; ?></td>
                </tr>
                <tr>
                    <td style="height:20px">手&nbsp;&nbsp;机：</td>
                    <td style="height:20px"><?php echo $consignee['mobile']; ?></td>
                </tr>
                <tr>
...
<table style="border: 1px solid #000000; text-align: center; background: #FFFFFF; width: 980px; margin: auto"
    ...
    <tr>
        <td style="height:30px; width: 39px; font-size: 12px; font-weight: bold; text-align: center; border-bottom: 1px solid #000000;border-right: 1px solid #000000;">
            序号
        </td>
        <td style="height:30px; width: 149px; font-size: 12px; font-weight: bold; text-align: center; border-bottom: 1px solid #000000;border-right: 1px solid #000000;">
            订货号
        </td>
        <td style="height:30px; width: 359px; font-size: 12px; font-weight: bold; text-align: center; border-bottom: 1px solid #000000;border-right: 1px solid #000000;">
            产品名称
        </td>
        <td style="height:30px; width: 169px; font-size: 12px; font-weight: bold; text-align: center; border-bottom: 1px solid #000000;border-right: 1px solid #000000;">
            产品属性
        </td>
        <td style="height:30px; width: 79px; font-size: 12px; font-weight: bold; text-align: center; border-bottom: 1px solid #000000;border-right: 1px solid #000000;">
            数量
        </td>
        <td style="height:30px; width: 79px; font-size: 12px; font-weight: bold; text-align: center; border-bottom: 1px solid #000000;border-right: 1px solid #000000;">
            单价
        </td>
        <td style="height:30px; width: 100px; font-size: 12px; font-weight: bold; text-align: center; border-bottom-style: solid; border-bottom-color: #000000; border-bottom-width: 1px;">
            金额
        </td>
    </tr>
    <?php foreach ($order_goods
...
<table style="border: 1px solid #000000; text-align: left; background: #FFFFFF; width: 1014px; margin: auto; font-size: 12px;"
       cellspacing="0" cellpadding="0">
    <tr>
        <td style="width:70%">
            ...
            <table style="width: 100%" cellspacing="0" cellpadding="0">
                ...
                <tr>
                    ...
                    <td style="height:20px" colspan="2"><?php echo $order_info['pay_name']; ?></td>
                </tr>
                <tr>
                    <td style="height:20px; width: 100px; text-align:right">配送方式：</td>
                    <td style="height:20px" colspan="2"><?php echo $order_info['shipping_name']; ?></td>
                </tr>
                <tr>
                    <td colspan="3">&nbsp;</td>
                </tr>
        ...
        <td style="width:30%; border-left: 1px solid #000000">
            <table style="width: 100%" cellspacing="0" cellpadding="0">
                ...
                <tr>
                    <td style="height:20px">&nbsp;总金额: <?php echo $order_info['order_amount']; ?>（RMB）</td>
                </tr>
                <tr>
                    <td style="color:#F00">&nbsp;包含：</td>
                </tr>
                <tr>
                    <td style="color:#F00">&nbsp;运费: <?php echo $order_info['formated_shipping_fee']; ?>（RMB）</td>
                </tr>
                <tr>
                    <td style="height:20px">&nbsp;</td>
                </tr>
...
<table style="border: 1px solid #000000; text-align: left; background: #FFFFFF; ; margin: auto; font-size: 12px; width:1014px;"
       cellspacing="0" cellpadding="0">
    <tr>
        <td style="width: 30px">
        </td>
