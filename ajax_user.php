...
if ($_REQUEST['act'] == 'comments_form') {
    ...
    if ($_REQUEST['act'] == 'upload_user_picture') {
        ...
        if ($filename && isset($_SESSION['user_id']) && 0 < $_SESSION['user_id']) {
            ...
            if (!empty($filename_arr)) {
                ...
                $filename_120 = $image->make_thumb($filename_cropper, 120, 120, $route, '',
                    $_SESSION['user_id'] . '_120.jpg');
                $filename_48 = $image->make_thumb($filename_cropper, 48, 48, $route, '',
                    $_SESSION['user_id'] . '_48.jpg');
                $filename_24 = $image->make_thumb($filename_cropper, 24, 24, $route, '',
                    $_SESSION['user_id'] . '_24.jpg');
                get_oss_add_file(array($filename_120, $filename_48, $filename_24));
                $parent['user_picture'] = $filename_120;
                $GLOBALS['db']->autoExecute($GLOBALS['ecs']->table('users'), $parent, 'UPDATE',
        ...
        if ($_REQUEST['act'] == 'checked_report_title') {
            ...
            if ($_REQUEST['act'] == 'ajax_report_img') {
                ...
                if ($_REQUEST['act'] == 'del_reportpic') {
                    ...
                    if ($_REQUEST['act'] == 'check_report_state') {
                        ...
                        if ($_REQUEST['act'] == 'complaint_title_desc') {
