...
class Services_JSON
{
                        ...
                        for ($c = 0; $c < $strlen_chrs; ++$c) {
                            ...
                            switch (true) {
                                ...
                                case preg_match('/\\\\u[0-9A-F]{4}/i', substr($chrs, $c, 6)):
                                    $utf16 = chr(hexdec(substr($chrs, $c + 2, 2))) . chr(hexdec(substr($chrs, $c + 4,
                                            2)));
                            ...
                            for ($c = 0; $c <= $strlen_chrs; ++$c) {
                                ...
                                if (($c == $strlen_chrs) || (($chrs[$c] == ',') && ($top['what'] == SERVICES_JSON_SLICE))) {
                                    ...
                                    if ((($chrs[$c] == '"') || ($chrs[$c] == '\'')) && ($top['what'] != SERVICES_JSON_IN_STR)) {
                                        ...
                                        if (($chrs[$c] == $top['delim']) && ($top['what'] == SERVICES_JSON_IN_STR) && (((strlen(substr($chrs,
                                                            0, $c)) - strlen(rtrim(substr($chrs, 0, $c),
                                                            '\\'))) % 2) != 1)) {
                                            array_pop($stk);
                                        } else {
                                            if (($chrs[$c] == '[') && in_array($top['what'], array(
                                                    SERVICES_JSON_SLICE,
                                                ...
                                                if (($chrs[$c] == ']') && ($top['what'] == SERVICES_JSON_IN_ARR)) {
                                                    ...
                                                    if (($chrs[$c] == '{') && in_array($top['what'], array(
                                                        ...
                                                        if (($chrs[$c] == '}') && ($top['what'] == SERVICES_JSON_IN_OBJ)) {
                                                            ...
                                                            if (($substr_chrs_c_2 == '/*') && in_array($top['what'],
                                                                    array(
                                                                        SERVICES_JSON_SLICE,
                                                                        SERVICES_JSON_IN_ARR,
                                                                        SERVICES_JSON_IN_OBJ
    ...
    public function isError($data, $code = null)
    {
        if (class_exists('pear')) {
            ...
            if (is_object($data) && ((get_class($data) == 'services_json_error') || is_subclass_of($data,
                        'services_json_error'))) {
                return true;
            }
        }
