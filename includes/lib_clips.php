...
function get_collection_brands($user_id, $record_count, $page, $pageFunc, $size = 5)
{
    ...
    foreach ($res as $key => $row) {
        ...
        $brand_list[$row['rec_id']]['url'] = build_uri('brandn', array('bid' => $row['brand_id'], 'act' => 'index'),
            $row['goods_name']);
        ...
        $sort = 'sales_volume';
        $order = 'DESC';
        $brand_list[$row['rec_id']]['brand_goods'] = brand_get_goods($brand_id, $mbid, $cat, $goods_size, $goods_page,
            $sort, $order, $region_id, $area_info['region_id'], $act, $ship, $price_min, $price_max, $self);
    }
