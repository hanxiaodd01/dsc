...
class cls_session_memcached
{
    ...
    {
        return $this->cache->set($this->session_id,
            array('expiry' => $this->_time, 'ip' => $this->_ip, 'data' => 'a:0:{}'), $this->max_life_time);
    }
    ...
    public function update_session()
    {
        ...
        return $this->cache->replace($this->session_id, array(
            'expiry' => $this->_time,
            'ip' => $this->_ip,
            'userid' => $userid,
            'adminid' => $adminid,
    ...
    {
        $GLOBALS['_SESSION'] = array();
        setcookie($this->session_name, $this->session_id, 1, $this->session_cookie_path, $this->session_cookie_domain,
