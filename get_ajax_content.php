    ...
    switch ($data_type) {
        ...
        case 'mpbtn_coupons':
            ...
            foreach ($user_coupons as $k => $v) {
                ...
                if ((strpos(',' . $v['cou_goods'] . ',',
                            ',' . $goods_id . ',') !== false || $v['cou_goods'] == 0) && $v['ru_id'] == $ru_id) {
    ...
    if ($act == 'get_login_dialog') {
        ...
        if ($act == 'get_store_list') {
            ...
            if (!empty($store_list)) {
                foreach ($store_list as $k => $v) {
                    if (is_spec($is_spec) == true) {
                        $products = get_warehouse_id_attr_number($v['goods_id'], $spec_arr, $v['ru_id'], 0, 0, 0, '',
                            $v['id']);
            ...
            if ($act == 'storePick' || $act == 'storeSelect' || $act == 'replaceStore') {
                ...
                $area_position_list = get_goods_user_area_position($ru_id, $city_id, $spec_arr, $goods_id, 0, 0, 0,
                    $store_id);
                ...
                if ($act == 'storePick') {
                    ...
                    if ($act == 'replaceStore') {
                        ...
                        foreach ($provinces as $k => $v) {
                            if (0 < count(get_goods_user_area_position($ru_id, 0, $spec_arr, $goods_id, $v['region_id'],
                                    0, 1))) {
                ...
                if ($act == 'getstoreRegion' || $act == 'get_parent_regions') {
                    ...
                    foreach ($region as $k => $v) {
                        if (0 < $v['region_id']) {
                            switch ($level) {
                                case 1:
                                    $type = count(get_goods_user_area_position($ru_id, 0, $spec_arr, $goods_id,
                                        $v['region_id'], 0, 1));
                                    break;

                                case 2:
                                    $type = count(get_goods_user_area_position($ru_id, $v['region_id'], $spec_arr,
                                        $goods_id, 0, 0, 1));
                                    break;

                                case 3:
                                    $type = count(get_goods_user_area_position($ru_id, 0, $spec_arr, $goods_id, 0,
                                        $v['region_id'], 1));
                                    break;
                            }
                                ...
                                if ($act == 'get_cat_top_list' && $tpl == 1) {
                                    ...
                                    if (0 < $cat_id) {
                                        ...
                                        if ($one_cate_child) {
                                            ...
                                            foreach ($one_cate_child['cat_id'] as $k => $v) {
                                                ...
                                                $childcate_goods_list = get_category_recommend_goods('best',
                                                    $child_children, 0, 0, 0, '', $region_id, $area_id, $area_city, 10);
                                            ...
                                            if (defined('THEME_EXTENSION')) {
                                                ...
                                                $floor_ad_arr_right = array(
                                                    'ad_arr' => $cat_top_floor_ad_right,
                                                    'id' => $cat_id
                                                );
                                    ...
                                    if ($act == 'get_index_goods_cat') {
                                        ...
                                        if ($rome_key <= count($template) - 1) {
                                            ...
                                            if ($goods_cat === false) {
                                                $goods_cat = assign_cat_goods($row['id'], $row['number'], 'web', '',
                                                    'cat', $region_id, $area_id, $area_city, $rome_key);
                                                write_static_cache('index_goods_cat' . $rome_key . '_' . $_SESSION['user_rank'] . $region_store_enabled,
                                                    $goods_cat);
                                            }
                                            ...
                                            if ($goods_cat) {
                                                ...
                                                $cat_goods_hot = insert_get_adv_child(array(
                                                    'ad_arr' => $cat_goods_hot,
                                                    'id' => $goods_cat['id'],
                                                ...
                                                $cat_goods_banner = insert_get_adv_child(array(
                                                    'ad_arr' => $cat_goods_banner,
                                                    'id' => $goods_cat['id'],
                                                    'warehouse_id' => $region_id,
                                                    'area_id' => $area_id,
                                                    'area_city' => $area_city,
                                                    'floor_style_tpl' => $goods_cat['floor_style_tpl']
                                                ));
                                                $cat_goods_ad_left = insert_get_adv_child(array(
                                                    'ad_arr' => $cat_goods_ad_left,
                                                    'id' => $goods_cat['id'],
                                                    'warehouse_id' => $region_id,
                                                    'area_id' => $area_id,
                                                    'area_city' => $area_city,
                                                ...
                                                $cat_goods_ad_right = insert_get_adv_child(array(
                                                    'ad_arr' => $cat_goods_ad_right,
                                                    'id' => $goods_cat['id'],
                                                    'warehouse_id' => $region_id,
                                                    'area_id' => $area_id,
                                                    'area_city' => $area_city,
                                            ...
                                            if ($act == 'get_cat_top_list' && $tpl == 2) {
                                                ...
                                                if (0 < $cat_id) {
                                                    ...
                                                    if ($one_cate_child) {
                                                        ...
                                                        foreach ($one_cate_child['cat_id'] as $k => $v) {
                                                            $child_children = get_children($v['id']);
                                                            $childcate_goods_list = get_category_recommend_goods('best',
                                                                $child_children, 0, 0, 0, '', $region_id, $area_id,
                                                                $area_city, 10);
                                                        ...
                                                        $childcate_goods_hot = get_category_recommend_goods('hot',
                                                            get_children($cat_id), 0, 0, 0, '', $region_id, $area_id,
                                                            $area_city, 1);
                                                ...
                                                if ($act == 'get_cat_top_list' && $tpl == 3) {
                                                    ...
                                                    if (0 < $cat_id) {
                                                        ...
                                                        if ($one_cate_child) {
                                                            $one_cate_child['brands'] = get_brands($cat_id, 'brand',
                                                                10);
                                                            ...
                                                            $childcate_goods_hot = get_category_recommend_goods('hot',
                                                                get_children($cat_id), 0, 0, 0, '', $region_id,
                                                                $area_id, $area_city, 4);
                                                            $one_cate_child['goods_hot'] = $childcate_goods_hot;
                                                            $top_style_food_left = '';
                                                            ...
                                                            $smarty->assign('class_num', $class_num);
                                                            $smarty->assign('rome_number', $rome_key);
                                                            $smarty->assign('top_style_food_left',
                                                                $top_style_food_left);
                                                    ...
                                                    if ($act == 'changeShow') {
                                                        ...
                                                        if ($type == 1) {
                                                            ...
                                                            $havealook = get_category_recommend_goods('rand',
                                                                $child_children, 0, 0, 0, '', $region_id, $area_id,
                                                                $area_city, 6);
                                                            ...
                                                            if ($type == 3) {
                                                                if (0 < $cat_id) {
                                                                    if ($tpl == 2) {
                                                                        $child_children = get_children($cat_id);
                                                                        $goods_list = get_category_recommend_goods('rand',
                                                                            $child_children, 0, 0, 0, '', $region_id,
                                                                            $area_id, $area_city, 8);
                                                                        ...
                                                                        if ($tpl == 3) {
                                                                            $child_children = get_children($cat_id);
                                                                            $goods_list = get_category_recommend_goods('rand',
                                                                                $child_children, 0, 0, 0, '',
                                                                                $region_id, $area_id, $area_city, 6);
                                                                            $smarty->assign('goods_list', $goods_list);
                                                                            $result['page'] = html_entity_decode($smarty->fetch('library/cat_goods_change.lbi'));
                                                                        }
                                                                    }
                                                        ...
                                                        if ($act == 'floor_cat_content') {
                                                            ...
                                                            if ($goods_list === false) {
                                                                $goods_list = get_floor_ajax_goods($cat_id, $floor_num,
                                                                    $warehouse_id, $area_id, $area_city, $goods_ids,
                                                                    $seller_id);
                                                                ...
                                                                if ($act == 'ajax_store_collect') {
                                                                    ...
                                                                    if ($act == 'ajax_change_brands') {
                                                                        ...
                                                                        foreach ($recommend_brands as $key => $val) {
                                                                            $recommend_brands[$key]['brand_logo'] = empty($val['brand_logo']) ? str_replace(array('../'),
                                                                                '',
                                                                                $GLOBALS['_CFG']['no_brand']) : DATA_DIR . '/brandlogo/' . $val['brand_logo'];
                                                                            if ($val['site_url'] && 8 < strlen($val['site_url'])) {
                                                                                $recommend_brands[$key]['url'] = $val['site_url'];
                                                                            } else {
                                                                                $recommend_brands[$key]['url'] = build_uri('brandn',
                                                                        ...
                                                                        if (0 < count($recommend_brands)) {
                                                                            ...
                                                                            $GLOBALS['smarty']->assign('recommend_brands',
                                                                                $recommend_brands);
                                                                        ...
                                                                        if ($act == 'view_logistics_info') {
                                                                            ...
                                                                            $result['expressid'] = get_table_date('order_info',
                                                                                'order_id=\'' . $order_id . '\'',
                                                                                array('shipping_name'), 2);
                                                                            $result['expressno'] = $invoice_no;
                                                                            exit($json->encode($result));
                                                                        } else {
                                                                            if ($act == 'insert_header_region') {
                                                                                $result = array(
                                                                                    'error' => 0,
                                                                                    'content' => ''
                                                                                );
                                                                                $json = new JSON();
                                                                                $GLOBALS['smarty']->assign('is_insert',
                                                                                    1);
