...
if ($_REQUEST['act'] == 'list') {
    ...
    $tab_menu[] = array(
        'curr' => 1,
        'text' => $_LANG['seller_commission'],
        'href' => 'merchants_commission.php?act=list'
    );
    $tab_menu[] = array(
        'curr' => 0,
        'text' => $_LANG['commission_setup'],
        'href' => 'merchants_commission.php?act=edit&id=' . $adminru['ru_id']
    );
    $tab_menu[] = array(
        'curr' => 0,
        'text' => $_LANG['commission_bill'],
        'href' => 'merchants_commission.php?act=commission_bill&id=' . $adminru['ru_id']
    );
    ...
    if ($priv_str != 'all') {
        ...
        $smarty->assign('action_link',
            array('href' => 'merchants_commission.php?act=add', 'text' => $_LANG['add_suppliers_server']));
        $smarty->assign('action_link2',
            array('href' => 'merchants_percent.php?act=list', 'text' => $_LANG['suppliers_percent_list']));
    ...
    if ($_REQUEST['act'] == 'query') {
        ...
        if ($_REQUEST['act'] == 'edit') {
            ...
            if ($_REQUEST['act'] == 'order_list') {
                ...
                $percent_id = get_table_date('merchants_server', 'user_id = \'' . $adminru['ru_id'] . '\' ', $date,
                    $sqlType = 2);
                $date = array('percent_value');
                $percent_value = get_table_date('merchants_percent', 'percent_id = \'' . $percent_id . '\'', $date,
                        $sqlType = 2) . '%';
                ...
                $smarty->assign('action_link2', array(
                    'text' => $_LANG['03_merchants_commission'],
                    'href' => 'merchants_commission.php?act=list',
                    'class' => 'icon-reply'
                ));
    ...
    if ($_REQUEST['act'] == 'handle_log') {
        ...
        if ($_REQUEST['act'] == 'Ajax_handle_log') {
            ...
            if ($_REQUEST['act'] == 'commission_bill') {
                ...
                $tab_menu[] = array(
                    'curr' => 0,
                    'text' => $_LANG['brokerage_amount_list'],
                    'href' => 'merchants_commission.php?act=list'
                );
                $tab_menu[] = array(
                    'curr' => 0,
...
');
                            ...
                            if ($bill['bill_apply'] == 0) {
                                ...
                                $GLOBALS['db']->autoExecute($GLOBALS['ecs']->table('seller_commission_bill'), $other,
                                    'UPDATE', 'id = \'' . $bill_id . '\'');
