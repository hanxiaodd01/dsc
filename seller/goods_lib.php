...
if ($_REQUEST['act'] == 'list') {
    ...
    if ($_REQUEST['act'] == 'query') {
        ...
        if ($_REQUEST['act'] == 'seller_import') {
            ...
            if ($_REQUEST['act'] == 'goods_import_action') {
                admin_priv('goods_lib_list');
                ...
                $link[] = array(
                    'text' => $_LANG['20_goods_lib'],
                    'href' => 'goods_lib.php?act=list&' . list_link_postfix()
                );
...
if ($_REQUEST['act'] == 'batch') {
    ...
    if ($_REQUEST['act'] == 'batch_import') {
        ...
        if (0 < $error) {
            sys_msg($_LANG['import_success'] . '！' . $_LANG['include_wrong_data'] . $error . $_LANG['tiao'] . '！', 0,
                $link);
        } else {
            sys_msg($_LANG['import_success'], 0, $link);
        }
