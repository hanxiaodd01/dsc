...
if ($_REQUEST['act'] == 'list') {
    ...
    $smarty->assign('action_link',
        array('href' => 'team.php?act=add', 'text' => $_LANG['add_team_goods'], 'class' => 'icon-plus'));
    $tab_menu = array();
        ...
        if ($_REQUEST['act'] == 'add' || $_REQUEST['act'] == 'edit') {
            ...
            if ($_REQUEST['act'] == 'insert_update') {
                ...
                if (0 < $id) {
                    ...
                    $links = array(
                        array(
                            'href' => 'team.php?act=list&' . list_link_postfix(),
                            'text' => $_LANG['return_team_list']
                        )
                    );
...
if ($_REQUEST['act'] == 'team_info') {
    ...
    if ($_REQUEST['act'] == 'team_info_query') {
        ...
        if ($_REQUEST['act'] == 'remove_info') {
            ...
            if ($_REQUEST['act'] == 'remove_team_info') {
                if (isset($_POST['checkboxes'])) {
                    $del_count = 0;
...
if ($_REQUEST['act'] == 'team_order') {
    ...
    if ($_REQUEST['act'] == 'team_order_query') {
