...
if ($_REQUEST['act'] == 'manage') {
    ...
    if ($GLOBALS['_CFG']['attr_set_up'] == 0) {
        ...
        if ($GLOBALS['_CFG']['attr_set_up'] == 1) {
            $smarty->assign('action_link',
                array('text' => $_LANG['new_goods_type'], 'href' => 'goods_type.php?act=add', 'class' => 'icon-plus'));
            $smarty->assign('attr_set_up', 1);
        }
    }
            ...
            if ($GLOBALS['_CFG']['attr_set_up'] == 0) {
                ...
                if ($GLOBALS['_CFG']['attr_set_up'] == 1) {
                    $smarty->assign('action_link', array(
                        'text' => $_LANG['type_cart_add'],
                        'href' => 'goods_type.php?act=cat_add',
                        'class' => 'icon-plus'
                    ));
                    $smarty->assign('attr_set_up', 1);
                }
    ...
    if ($_REQUEST['act'] == 'edit_type_name') {
        ...
        if ($_REQUEST['act'] == 'toggle_enabled') {
            ...
            if ($_REQUEST['act'] == 'add') {
                ...
                $smarty->assign('action_link', array(
                    'href' => 'goods_type.php?act=manage',
                    'text' => $_LANG['goods_type_list'],
                    'class' => 'icon-reply'
                ));
                ...
                if ($_REQUEST['act'] == 'insert') {
                    ...
                    if ($_REQUEST['act'] == 'edit') {
                        $smarty->assign('menu_select',
                            array('action' => '02_cat_and_goods', 'current' => '08_goods_type'));
