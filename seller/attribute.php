...
if ($_REQUEST['act'] == 'list') {
    ...
    $smarty->assign('action_link2',
        array('text' => $_LANG['back_list'], 'href' => 'goods_type.php?act=manage', 'class' => 'icon-reply'));
    ...
    if ($GLOBALS['_CFG']['attr_set_up'] == 0) {
        if ($adminru['ru_id'] == 0) {
            $smarty->assign('action_link', array(
                'href' => 'attribute.php?act=add&goods_type=' . $goods_type,
                'text' => $_LANG['10_attribute_add'],
                'class' => 'icon-plus'
            ));
    ...
    if ($_REQUEST['act'] == 'query') {
        ...
        if ($_REQUEST['act'] == 'add' || $_REQUEST['act'] == 'edit') {
            ...
            $smarty->assign('action_link', array(
                'href' => 'attribute.php?act=list',
                'text' => $_LANG['09_attribute_list'],
                'class' => 'icon-reply'
            ));
            assign_query_info();
...
';
    ...
    if ($_REQUEST['act'] == 'add_img') {
        ...
        $smarty->assign('action_link2',
            array('href' => 'attribute.php?act=edit&attr_id=' . $attr_id, 'text' => $_LANG['go_back']));
        $smarty->assign('action_link',
            array('href' => 'attribute.php?act=list', 'text' => $_LANG['09_attribute_list']));
        ...
        if ($_REQUEST['act'] == 'insert_img') {
            ...
            $link[0] = array(
                'text' => $_LANG['go_back'],
                'href' => 'attribute.php?act=add_img&attr_id=' . $attr_id . '&attr_name=' . $attr_name
            );
            $link[1] = array(
                'text' => $_LANG['return_this_attr'],
                'href' => 'attribute.php?act=edit&attr_id=' . $attr_id
            );
