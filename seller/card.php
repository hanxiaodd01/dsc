                ...
                if ($_REQUEST['act'] == 'insert') {
                    ...
                    if ($_REQUEST['act'] == 'edit') {
                        ...
                        $smarty->assign('action_link', array(
                            'text' => $_LANG['07_card_list'],
                            'href' => 'card.php?act=list&' . list_link_postfix()
                        ));
                        $smarty->assign('card', $card);
                        ...
                        if ($_REQUEST['act'] == 'update') {
                            ...
                            if ($_REQUEST['act'] == 'drop_card_img') {
                                ...
                                get_del_batch('', $card_id, array('card_img'), 'card_id', 'card', 0,
                                    DATA_DIR . '/cardimg/');
                                $sql = 'UPDATE ' . $ecs->table('card') . ' SET card_img = \'\' WHERE card_id = \'' . $card_id . '\'';
                                $db->query($sql);
                                $link = array(
                                    array(
                                        'text' => $_LANG['card_edit_lnk'],
                                        'href' => 'card.php?act=edit&id=' . $card_id
                                    ),
