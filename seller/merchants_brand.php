...
if ($_REQUEST['act'] == 'list') {
    ...
    if (0 < $adminru['ru_id']) {
        $smarty->assign('action_link',
            array('text' => $_LANG['07_brand_add'], 'href' => 'merchants_brand.php?act=add', 'class' => 'icon-plus'));
    }
    ...
    if ($_REQUEST['act'] == 'query') {
        ...
        if ($_REQUEST['act'] == 'add') {
            ...
            if ($_REQUEST['act'] == 'insert') {
                ...
                $is_only = $exc->is_only('brandName', $_POST['brand_name'], 0,
                ...
                if ($_REQUEST['act'] == 'edit') {
                    ...
                    if ($_REQUEST['act'] == 'updata') {
                        ...
                        if ($_POST['brand_name'] != $_POST['old_brandname']) {
                            $is_only = $exc->is_only('brandName', $_POST['brand_name'], $bid, '',
                                $GLOBALS['ecs']->table('merchants_shop_brand'), 'bid');
                                    ...
                                    if ($_REQUEST['act'] == 'toggle_show') {
                                        ...
                                        if ($_REQUEST['act'] == 'remove') {
                                            ...
                                            $brand_id = $GLOBALS['db']->getOne('SELECT brand_id FROM ' . $GLOBALS['ecs']->table('link_brand') . (' WHERE bid =\'' . $id . '\''),
                                                true);
                                            get_del_batch('', $id, array('brandLogo'), 'bid', 'merchants_shop_brand',
                                                1);
                                            ...
                                            if ($_REQUEST['act'] == 'drop_logo') {
                                                ...
                                                get_del_batch('', $brand_id, array('brandLogo'), 'bid',
                                                    'merchants_shop_brand', 1);
