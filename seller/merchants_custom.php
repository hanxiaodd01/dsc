...
if ($_REQUEST['act'] == 'list') {
    ...
    $tab_menu[] = array(
        'curr' => 0,
        'text' => $_LANG['07_merchants_window'],
        'href' => 'merchants_window.php?act=list'
    );
    $tab_menu[] = array(
        'curr' => 1,
        'text' => $_LANG['06_merchants_custom'],
        'href' => 'merchants_custom.php?act=list'
    );
    ...
    $smarty->assign('action_link',
        array('text' => $_LANG['add_shop_window'], 'href' => 'merchants_custom.php?act=add', 'class' => 'icon-plus'));
    ...
    if ($_REQUEST['act'] == 'add') {
        ...
        if ($_REQUEST['act'] == 'insert') {
            ...
            $win_custom = isset($_REQUEST['win_custom']) ? preg_replace($preg, '',
                stripslashes($_REQUEST['win_custom'])) : '';
            ...
            if ($_REQUEST['act'] == 'edit') {
                $smarty->assign('menu_select',
                    array('action' => '19_merchants_store', 'current' => '07_merchants_window'));
                        ...
                        if ($_REQUEST['act'] == 'edit_sort_order') {
                            ...
                            if ($_REQUEST['act'] == 'toggle_show') {
                                ...
                                if ($_REQUEST['act'] == 'remove') {
                                    ...
                                    $exc->drop($id);
                                    $url = 'merchants_custom.php?act=query&' . str_replace('act=remove', '',
                                    ...
                                    if ($_REQUEST['act'] == 'query') {
                                        ...
                                        if ($_REQUEST['act'] == 'add_win_goods') {
                                            ...
                                            if ($_REQUEST['act'] == 'update_win_goods') {
                                                ...
                                                if ($_REQUEST['act'] == 'insert_win_goods') {
