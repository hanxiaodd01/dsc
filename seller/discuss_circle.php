...
if ($_REQUEST['act'] == 'list') {
    ...
    $smarty->assign('action_link',
        array('text' => $_LANG['discuss_add'], 'href' => 'discuss_circle.php?act=add', 'class' => 'icon-plus'));
    assign_query_info();
...
if ($_REQUEST['act'] == 'add') {
    ...
    $smarty->assign('action_link',
        array('href' => 'discuss_circle.php?act=list', 'text' => $_LANG['discuss_circle'], 'class' => 'icon-reply'));
...
if ($_REQUEST['act'] == 'reply') {
    ...
    $smarty->assign('action_link',
        array('text' => $_LANG['discuss_circle'], 'href' => 'discuss_circle.php?act=list', 'class' => 'icon-reply'));
    assign_query_info();
    $smarty->display('discuss_info.dwt');
}
...
if ($_REQUEST['act'] == 'batch_drop') {
    ...
    if (isset($_POST['checkboxes'])) {
        switch ($action) {
            case 'remove':
                $db->query('DELETE FROM ' . $ecs->table('discuss_circle') . ' WHERE ' . db_create_in($_POST['checkboxes'],
                        'dis_id'));
                break;
