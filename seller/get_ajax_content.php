...
if ($_REQUEST['act'] == 'get_select_category') {
    ...
    if ($table == 1) {
        $content = insert_seller_select_category($cat_id, $child_cat_id, $cat_level, $select_jsId, $type,
            'merchants_category', array(), $adminru['ru_id']);
    } else {
                ...
                if ($_REQUEST['act'] == 'changedgoods') {
                    ...
                    if (!empty($goods_list)) {
                        foreach ($goods_list as $k => $v) {
                            ...
                            $goods_list[$k]['url'] = build_uri('goods', array('gid' => $v['goods_id']),
                                $v['goods_name']);
                            ...
                            if (0 < $v['promote_price']) {
                                $goods_list[$k]['promote_price'] = bargain_price($v['promote_price'],
                                    $v['promote_start_date'], $v['promote_end_date']);
                            } else {
                            ...
                            if ($_REQUEST['act'] == 'add_albun_pic') {
                                ...
                                if (isset($_FILES['album_cover']['error']) && $_FILES['album_cover']['error'] == 0 || !isset($_FILES['album_cover']['error']) && isset($_FILES['album_cover']['tmp_name']) && $_FILES['album_cover']['tmp_name'] != 'none') {
                                    if (!check_file_type($_FILES['album_cover']['tmp_name'],
                                        $_FILES['album_cover']['name'], $allow_file_types)) {
                                        $result['error'] = 0;
                                ...
                                $album_list = get_goods_gallery_album(1, $adminru['ru_id'],
                                    array('album_id', 'album_mame'), 'ru_id');
                                ...
                                if ($_REQUEST['act'] == 'search_brand_list') {
                                    ...
                                    if (isset($_REQUEST['ru_id']) && trim($_REQUEST['ru_id']) != 'undefined') {
                                        $smarty->assign('filter_brand_list',
                                            search_brand_list(0, intval($_REQUEST['ru_id'])));
                                    } else {
                                            ...
                                            if ($search_type == 'article') {
                                                ...
                                                if ($search_type == 'area') {
                                                    ...
                                                    if ($search_type == 'goods_type') {
                                                        ...
                                                        $goods_fields = my_array_merge($_LANG['custom'],
                                                                ...
                                                                if (!empty($arr)) {
                                                                    ...
                                                                    foreach ($arr as $key => $val) {
                                                                        ...
                                                                        $arr[$key]['brand_logo'] = get_image_path($val['brand_id'],
                                                                            $val['brand_logo']);
                                                                        if (!empty($brand_ids) && in_array($val['brand_id'],
                                                                                $brand_ids)) {
                                                                            $arr[$key]['selected'] = 1;
                                                                        } else {
                                                                            if ($is_selected == 1) {
                                            ...
                                            if ($_REQUEST['act'] == 'drop_win_goods') {
                                                ...
                                                if ($_REQUEST['act'] == 'upload_img') {
                                                    ...
                                                    if ($act_type == 'goods_img') {
                                                        ...
                                                        $original_img = reformat_image_name('goods', $goods_id,
                                                            $original_img, 'source');
                                                        $goods_img = reformat_image_name('goods', $goods_id, $goods_img,
                                                            'goods');
                                                        $goods_thumb = reformat_image_name('goods_thumb', $goods_id,
                                                            $goods_thumb, 'thumb');
                                                        $result['data'] = array(
                                                        ...
                                                        if (empty($goods_id)) {
                                                            ...
                                                            $db->autoExecute($ecs->table('goods'), $result['data'],
                                                        ...
                                                        if ($img) {
                                                            if (empty($is_url_goods_img)) {
                                                                $img = reformat_image_name('gallery', $goods_id, $img,
                                                                    'source');
                                                                $gallery_img = reformat_image_name('gallery', $goods_id,
                                                                    $gallery_img, 'goods');
                                                            } else {
                                                                $img = $url_goods_img;
                                                        ...
                                                        if ($act_type == 'gallery_img') {
                                                            ...
                                                            handle_gallery_image_add($goods_id, $_FILES['img_url'],
                                                                $img_desc, $img_file, '', '', 'ajax',
                                                                $result['img_desc']);
                                                            clear_cache_files();
                                                        ...
                                                        if ($_REQUEST['act'] == 'drop_link_goods') {
                                                            ...
                                                            if ($_REQUEST['act'] == 'add_group_goods') {
                                                                ...
                                                                if ($_REQUEST['act'] == 'drop_group_goods') {
                                                                    ...
                                                                    $sql = 'DELETE FROM ' . $ecs->table('group_goods') . (' WHERE parent_id=\'' . $goods_id . '\' AND ') . db_create_in($fittings,
                                                                            'id');
                                                                                ...
                                                                                if ($_REQUEST['act'] == 'drop_area_goods') {
                                                                                    ...
                                                                                    if ($_REQUEST['act'] == 'add_link_desc') {
                                                                                        ...
                                                                                        $linked_array = empty($_REQUEST['value']) ? array() : explode(',',
                                                                                            $_REQUEST['value']);
                                                                                        $id = empty($_REQUEST['id']) ? 0 : intval($_REQUEST['id']);
                                                                                        get_add_edit_link_desc($linked_array,
                                                                                            0, $id);
                                                                                        ...
                                                                                        if ($_REQUEST['act'] == 'drop_link_desc') {
                                                                                            ...
                                                                                            if ($_REQUEST['act'] == 'edit_navname') {
                                                                                                ...
                                                                                                if ($_REQUEST['act'] == 'edit_navurl') {
                                                                                                    ...
                                                                                                    if ($_REQUEST['act'] == 'edit_navvieworder') {
                                                                                                        include_once ROOT_PATH . 'includes/cls_json.php';
                                                                                                        $json = new JSON();
                                                                                                        $result = array(
                                                                                                            'error' => '',
                                                                                                                                            ...
                                                                                                                                            if ($_REQUEST['act'] == 'getsearchgoodsDiv') {
                                                                                                                                                ...
                                                                                                                                                if ($_REQUEST['act'] == 'add_seckill_goods') {
                                                                                                                                                    ...
                                                                                                                                                    if ($goods_ids) {
                                                                                                                                                        ...
                                                                                                                                                        $list = get_add_seckill_goods($sec_id,
                                                                                                                                                            $tb_id);
