    ...
    if ($_REQUEST['act'] == 'query') {
        ...
        if ($_REQUEST['act'] == 'add') {
            ...
            $smarty->assign('action_link',
                array('href' => 'ad_position.php?act=list', 'text' => $_LANG['ad_position']));
            $smarty->assign('posit_arr',
                array('position_style' => '<table cellpadding="0" cellspacing="0">' . "\n" . '{foreach from=$ads item=ad}' . "\n" . '<tr><td>{$ad}</td></tr>' . "\n" . '{/foreach}' . "\n" . '</table>'));
            assign_query_info();
                            ...
                            if ($_REQUEST['act'] == 'edit_ad_width') {
                                ...
                                if ($_REQUEST['act'] == 'edit_ad_height') {
                                    ...
                                    if ($_REQUEST['act'] == 'remove') {
                                        ...
                                        $url = 'ad_position.php?act=query&' . str_replace('act=remove', '',
