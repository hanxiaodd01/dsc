...
if ($_REQUEST['act'] == 'list') {
    ...
    $smarty->assign('action_link',
        array('text' => $_LANG['continus_add'], 'href' => 'coupons.php?act=add', 'class' => 'icon-plus'));
...
if ($_REQUEST['act'] == 'add') {
    ...
    $smarty->assign('action_link',
        array('href' => 'coupons.php?act=list', 'text' => $_LANG['coupons_list'], 'class' => 'icon-reply'));
...
if ($_REQUEST['act'] == 'edit') {
    ...
    $smarty->assign('action_link', array(
        'href' => 'coupons.php?act=list&' . list_link_postfix(),
        'text' => $_LANG['cou_list'],
        'class' => 'icon-reply'
    ));
