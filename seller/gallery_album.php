...
if ($_REQUEST['act'] == 'list') {
    ...
    $smarty->assign('action_link',
        array('text' => $_LANG['add_album'], 'href' => 'gallery_album.php?act=add', 'class' => 'icon-plus'));
            ...
            if ($_REQUEST['act'] == 'insert' || $_REQUEST['act'] == 'update') {
                ...
                if ($_REQUEST['act'] == 'insert') {
                    ...
                    $is_only = $exc->is_only('album_mame', $album_mame, 0,
                        'ru_id = ' . $adminru['ru_id'] . (' AND album_id != \'' . $album_id . '\''));
                ...
                if ($_REQUEST['act'] == 'view') {
                    ...
                    $smarty->assign('action_link',
                        array('text' => $_LANG['upload_image'], 'spec' => 'ectype=\'addpic_album\''));
