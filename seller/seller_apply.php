...
if ($_REQUEST['act'] == 'list') {
    ...
    $smarty->assign('action_link', array(
        'text' => $_LANG['09_merchants_upgrade'],
    ...
    if ($_REQUEST['act'] == 'query') {
        ...
        if ($_REQUEST['act'] == 'info') {
            ...
            $smarty->assign('action_link',
                array('text' => $_LANG['apply_list'], 'href' => 'seller_apply.php?act=list'));
            ...
            if ($_REQUEST['act'] == 'operation') {
                ...
                if ($is_confirm != 0) {
                    ...
                    if ($cfg == '1') {
                        ...
                        if (!send_mail($grade['shop_name'], $grade['email'], $tpl['template_subject'], $content,
                            $tpl['is_html'])) {
                    ...
                    if ($is_confirm == 1) {
                        ...
                        if (0 < $back_price) {
                            log_account_change($ru_id, $apply['back_price'], 0, 0, 0,
                                $_LANG['record_id'] . $apply['apply_sn'] . $_LANG['seller_level_prepay_refund']);
                        }
                    } else {
                        ...
                        if ($apply['pay_status'] == 1 && 0 < $apply['payable_amount'] && $is_confirm != 0) {
                            log_account_change($ru_id, $apply['payable_amount'], 0, 0, 0,
                                $_LANG['record_id'] . $apply['apply_sn'] . $_LANG['seller_level_not_pass_refund']);
                        }
                    }
