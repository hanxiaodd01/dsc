...
if ($_REQUEST['act'] == 'list') {
    ...
    $smarty->assign('action_link',
        array('text' => $_LANG['package_add'], 'href' => 'package.php?act=add', 'class' => 'icon-plus'));
    ...
    if ($_REQUEST['act'] == 'query') {
        ...
        if ($_REQUEST['act'] == 'add') {
            ...
            $smarty->assign('action_link',
                array('text' => $_LANG['14_package_list'], 'href' => 'package.php?act=list', 'class' => 'icon-reply'));
            ...
            if ($_REQUEST['act'] == 'insert') {
                ...
                if ($_REQUEST['act'] == 'edit') {
                    ...
                    $smarty->assign('action_link', array(
                        'text' => $_LANG['14_package_list'],
                        'href' => 'package.php?act=list&' . list_link_postfix(),
                        'class' => 'icon-reply'
                    ));
                    ...
                    if ($_REQUEST['act'] == 'update') {
                        ...
                        $db->autoExecute($ecs->table('goods_activity'), $record, 'UPDATE',
                            'act_id = \'' . $act_id . '\' AND act_type = ' . GAT_PACKAGE);
                        ...
                        if ($_REQUEST['act'] == 'drop_thumb') {
                            ...
                            if ($_REQUEST['act'] == 'remove') {
                                ...
                                if ($package['ru_id'] != $adminru['ru_id']) {
                                    $url = 'package.php?act=query&' . str_replace('act=remove', '',
                                    ...
                                    if ($_REQUEST['act'] == 'search_goods') {
                                        ...
                                        if ($_REQUEST['act'] == 'add_package_goods') {
                                            ...
                                            if ($_REQUEST['act'] == 'drop_package_goods') {
                                                ...
                                                if ($_REQUEST['act'] == 'edit_package_nuber') {
                                                    include_once ROOT_PATH . 'includes/cls_json.php';
                                                    $json = new JSON();
                                                    ...
                                                    if ($_REQUEST['act'] == 'edit_package_product') {
                                                        include_once ROOT_PATH . 'includes/cls_json.php';
                                                        $json = new JSON();
                                                        $result = array('error' => 0);
                                                        check_authz_json('package_manage');
