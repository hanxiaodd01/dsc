...
if ($_REQUEST['act'] == 'list') {
    ...
    $smarty->assign('action_link',
        array('text' => $_LANG['add_stores'], 'href' => 'offline_store.php?act=add', 'class' => 'icon-plus'));
    ...
    if ($_REQUEST['act'] == 'query') {
        ...
        if ($_REQUEST['act'] == 'add' || $_REQUEST['act'] == 'edit') {
            ...
            $smarty->assign('action_link', array(
                'text' => $_LANG['12_offline_store'],
                'href' => 'offline_store.php?act=list',
                'class' => 'icon-reply'
            ));
            ...
            if ($_REQUEST['act'] == 'insert' || $_REQUEST['act'] == 'update') {
                ...
                if ($_REQUEST['act'] == 'order_stats') {
                    ...
                    if ($_REQUEST['act'] == 'order_stats_query') {
                        ...
                        make_json_result($smarty->fetch('store_starts_order.dwt'), '',
