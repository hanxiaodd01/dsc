                ...
                if ($_REQUEST['act'] == 'add') {
                    ...
                    if ($_REQUEST['act'] == 'insert') {
                        ...
                        if ($_POST['user_name'] == $_LANG['buyer'] || $_POST['user_name'] == $_LANG['saler']) {
                            $link[] = array(
                                'text' => $_LANG['invalid_name_cant_use'],
                        ...
                        if ($_REQUEST['act'] == 'edit') {
                            ...
                            if ($_REQUEST['act'] == 'update' || $_REQUEST['act'] == 'update_self') {
                                ...
                                $db->autoExecute($ecs->table('seller_shopinfo'), $seller_shopinfo, 'UPDATE',
                                    'ru_id = \'' . $adminru['ru_id'] . '\'');
                                ...
                                $link[] = array(
                                    'text' => strpos($g_link,
                                        'list') ? $_LANG['back_admin_list'] : $_LANG['return_login'],
                                    'href' => $g_link
                                );
                                ...
                                if ($_REQUEST['act'] == 'modif') {
                                    ...
                                    $smarty->assign('menu_select',
                                        array('action' => '10_priv_admin', 'current' => 'privilege_seller'));
                                        ...
                                        if ($_REQUEST['act'] == 'update_allot') {
                                            ...
                                            if ($_REQUEST['act'] == 'remove') {
                                                ...
                                                if ($_REQUEST['act'] == 'check_user_name') {
                                                    ...
                                                    if ($_REQUEST['act'] == 'check_user_password') {
                                                        $result = array('error' => 0, 'message' => '', 'content' => '');
                                                        $user_name = empty($_REQUEST['user_name']) ? '' : trim($_REQUEST['user_name']);
                                                        $user_password = empty($_REQUEST['user_password']) ? '' : trim($_REQUEST['user_password']);
