...
function get_sysnav()
{
    ...
    foreach ($catlist as $key => $val) {
        $val['url'] = build_uri('merchants_store', array('cid' => $val['cat_id'], 'urid' => $adminru['ru_id']),
            $val['cat_name']);
                ...
                if ($_REQUEST['act'] == 'extension_category') {
                    ...
                    if ($_REQUEST['act'] == 'add_attr_img') {
                        ...
                        if ($_REQUEST['act'] == 'insert_attr_img') {
                            ...
                            if ($other['attr_checked'] == 1) {
                                $goods = get_admin_goods_info($goods_id, array(
                                    'promote_price',
                                    'promote_start_date',
                                    'promote_end_date',
                                    'user_id',
                                ...
                                if ($GLOBALS['_CFG']['add_shop_price'] == 0 && $goods['model_attr'] == 0) {
                                    $properties = get_goods_properties($goods_id, 0, 0, 0, '', 0, $goods['model_attr'],
                                        0);
                                    ...
                                    if (!empty($goodsAttrId)) {
                                        $products = get_warehouse_id_attr_number($goods_id, $goodsAttrId,
                                            $goods['user_id'], 0, 0, $goods['model_attr']);
                                        ...
                                        if ($products) {
                                            ...
                                            if (0 < $row['promote_price']) {
                                                $promote_price = bargain_price($row['promote_price'],
                                            ...
                                            $GLOBALS['db']->autoExecute($GLOBALS['ecs']->table('goods'), $other,
                                        ...
                                        if ($_REQUEST['act'] == 'add_goods_model_price') {
                                            ...
                                            if ($_REQUEST['act'] == 'goods_wa_query') {
                                                ...
                                                if ($_REQUEST['act'] == 'add_warehouse_price') {
                                                    ...
                                                    $warehouse_area_list = get_fine_warehouse_all(0, $goods_id,
                                                        $goods_attr_id);
                                                    $smarty->assign('goods_info', $goods_info);
                                                    $smarty->assign('attr_info', $attr_info);
                                                    $smarty->assign('goods_attr_name', $goods_attr_name);
                                                    ...
                                                    if ($_REQUEST['act'] == 'insert_warehouse_price') {
                                                        ...
                                                        if ($_REQUEST['act'] == 'add_area_price') {
                                                            ...
                                                            if (empty($goods_attr_id)) {
                                                                $goods_attr_id = get_goods_attr_nameId($goods_id,
                                                                    $attr_id, $goods_attr_name);
                                                            }

                                                            if (empty($attr_id)) {
                                                                $attr_id = get_goods_attr_nameId($goods_id,
                                                                    $goods_attr_id, $goods_attr_name, 'attr_id', 1);
                                                            }
                                                            ...
                                                            $attr_info = get_table_date('attribute',
                                                                'attr_id = \'' . $attr_id . '\'', $attr_date);
                                                            $warehouse_area_list = get_fine_warehouse_area_all(0,
                                                                $goods_id, $goods_attr_id);
                                                            $smarty->assign('goods_info', $goods_info);
                                                            $smarty->assign('attr_info', $attr_info);
                                                            $smarty->assign('goods_attr_name', $goods_attr_name);
                                                            $smarty->assign('warehouse_area_list',
                                                                $warehouse_area_list);
                                                            $smarty->assign('goods_id', $goods_id);
                                                            $smarty->assign('attr_id', $attr_id);
                                                            $smarty->assign('goods_attr_id', $goods_attr_id);
                                                            ...
                                                            if ($_REQUEST['act'] == 'del_goods_attr') {
                                                                ...
                                                                $ecs->get_del_find_in_set($goods_attr_id, $where,
                                                                    $table, 'goods_attr', '|');
                                                                exit($json->encode($result));
                                                            } else {
                                                                if ($_REQUEST['act'] == 'insert_area_price') {
                                                                    ...
                                                                    $goods_attr_name = !empty($_REQUEST['goods_attr_name']) ? $_REQUEST['goods_attr_name'] : '';
                                                                    get_warehouse_area_attr_price_insert($area_name,
                                                                        $goods_id, $goods_attr_id,
                                                                        'warehouse_area_attr');
                                                                    $result['goods_attr_id'] = $goods_attr_id;
                                                                    exit($json->encode($result));
                                                                    ...
                                                                    if ($_REQUEST['act'] == 'add_sku') {
                                                                        ...
                                                                        if ($_REQUEST['act'] == 'sku_query') {
                                                                            ...
                                                                            if ($_REQUEST['act'] == 'add_attr_sku') {
                                                                                ...
                                                                                $smarty->assign('goods_info',
                                                                                    $goods_info);
                                                                                $smarty->assign('product', $product);
                                                                                $smarty->assign('editInput',
                                                                                    $editInput);
                                                                                ...
                                                                                if ($_REQUEST['act'] == 'shop_banner') {
                                                                                    ...
                                                                                    $cat_select = gallery_cat_list(0, 0,
                                                                                        false, 0, true);
                                                                                    $i = 0;
                                                                                    $default_album = 0;
                                                                                    ...
                                                                                    if ($_REQUEST['act'] == 'templateColorSet') {
                                                                                        $json = new JSON();
                                                                                                                    ...
                                                                                                                    if ($_REQUEST['act'] == 'insert_external_url') {
                                                                                                                        ...
                                                                                                                        if ($external_url_list) {
                                                                                                                            ...
                                                                                                                            if (!empty($_SESSION['thumb_img_id' . $_SESSION['seller_id']])) {
                                                                                                                                $_SESSION['thumb_img_id' . $_SESSION['seller_id']] = array_merge($thumb_img_id,
                                                                                                                                    $_SESSION['thumb_img_id' . $_SESSION['seller_id']]);
                                                                                                                            } else {
                                                                                                                        ...
                                                                                                                        if ($_REQUEST['act'] == 'insert_gallery_url') {
                                                                                                                            ...
                                                                                                                            if ($_REQUEST['act'] == 'pic_album') {
                                                                                                                                ...
                                                                                                                                if ($_REQUEST['act'] == 'goods_info') {
                                                                                                                                    ...
                                                                                                                                    $select_category_html = insert_select_category(0,
                                                                                                                                        0,
                                                                                                                                        0,
                                                                                                                                        'cat_id',
                                                                                                                                        0,
                                                                                                                                            ...
                                                                                                                                            if ($_REQUEST['act'] == 'navigator') {
                                                                                                                                                ...
                                                                                                                                                if ($_REQUEST['act'] == 'template_information') {
                                                                                                                                                    ...
                                                                                                                                                    if ($_REQUEST['act'] == 'manual_intervention') {
                                                                                                                                                        ...
                                                                                                                                                        $smarty->assign('manual_intervention',
                                                                                                                                                            $manual_intervention);
            ...
            if ($_REQUEST['act'] == 'ajaxTransport') {
                ...
                if ($_REQUEST['act'] == 'transport_insert' || $_REQUEST['act'] == 'transport_update') {
                    ...
                    if ($_REQUEST['act'] == 'transport_update') {
                        ...
                        $db->autoExecute($ecs->table('goods_transport'), $data, 'UPDATE',
                            'tid = \'' . $data['tid'] . '\'');
                        $tid = $s_tid;
                        $where = ' tid = \'' . $tid . '\'';
                    } else {
                        ...
                        $tid = $db->insert_id();
                        $db->autoExecute($ecs->table('goods_transport_extend'), array('tid' => $tid), 'UPDATE',
                            'tid = \'0\' AND admin_id = \'' . $admin_id . '\' ');
                        $db->autoExecute($ecs->table('goods_transport_express'), array('tid' => $tid), 'UPDATE',
                            'tid = \'0\' AND admin_id = \'' . $admin_id . '\' ');
                    ...
                    if (0 < count($_REQUEST['sprice'])) {
                        foreach ($_REQUEST['sprice'] as $key => $val) {
                            $info = array();
                            $info['sprice'] = $val;
                            $db->autoExecute($ecs->table('goods_transport_extend'), $info, 'UPDATE',
                                'id = \'' . $key . '\'');
                        }
                    }
                    ...
                    if (0 < count($_REQUEST['shipping_fee'])) {
                        foreach ($_REQUEST['shipping_fee'] as $key => $val) {
                            ...
                            $db->autoExecute($ecs->table('goods_transport_express'), $info, 'UPDATE',
                                'id = \'' . $key . '\'');
                        }
                    }
                    ...
                    $smarty->assign('transport_list',
                        get_table_date('goods_transport', 'ru_id=\'' . $adminru['ru_id'] . '\'', array('tid, title'),
                            1));
                    $result['content'] = $GLOBALS['smarty']->fetch('library/dialog.lbi');
                    exit($json->encode($result));
                } else {
                    if ($_REQUEST['act'] == 'ajaxCate') {
                        ...
                        if ($_REQUEST['act'] == 'cate_insert') {
                            ...
                            $cat['filter_attr'] = !empty($_POST['filter_attr']) ? implode(',',
                                array_unique(array_diff($_POST['filter_attr'], array(0)))) : 0;
                            ...
                            if (1 < count($cat_name)) {
                                ...
                                if ($db->autoExecute($ecs->table('merchants_category'), $cat) !== false) {
                                    ...
                                    if ($cat['show_in_nav'] == 1) {
                                        ...
                                        $vieworder += 2;
                                        $sql = 'INSERT INTO ' . $ecs->table('merchants_nav') . ' (name,ctype,cid,ifshow,vieworder,opennew,url,type,ru_id)' . ' VALUES(\'' . $cat['cat_name'] . '\', \'c\', \'' . $db->insert_id() . ('\',\'1\',\'' . $vieworder . '\',\'0\', \'') . build_uri('merchants_store',
                                                array('cid' => $cat_id, 'urid' => $adminru['ru_id']),
                                                $cat['cat_name']) . '\',\'middle\',\'' . $adminru['ru_id'] . '\')';
                                        $db->query($sql);
                                    }
