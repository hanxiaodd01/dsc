...
if ($_REQUEST['act'] == 'list') {
    ...
    $smarty->assign('action_link',
        array('href' => 'seckill.php?act=add', 'text' => $_LANG['seckill_add'], 'class' => 'icon-plus'));
                ...
                if ($_REQUEST['act'] == 'sg_remove') {
                    ...
                    if ($_REQUEST['act'] == 'add' || $_REQUEST['act'] == 'edit') {
                        ...
                        $smarty->assign('menu_select',
                            array('action' => '02_promotion', 'current' => '03_seckill_list'));
                        $smarty->assign('action_link', array(
                            'href' => 'seckill.php?act=list',
                            'text' => $_LANG['seckill_list'],
                            'class' => 'icon-reply'
                        ));
...
if ($_REQUEST['act'] == 'set_goods') {
    ...
    $smarty->assign('action_link',
        array('text' => $_LANG['seckill_list'], 'href' => 'seckill.php?act=list', 'class' => 'icon-reply'));
...
if ($_REQUEST['act'] == 'add_goods') {
    ...
    $smarty->assign('menu_select', array('action' => '02_promotion', 'current' => '03_seckill_list'));
    $smarty->assign('action_link',
        array('text' => $_LANG['seckill_time_bucket'], 'href' => 'seckill.php?act=set_goods&sec_id=' . $sec_id));
    $smarty->assign('primary_cat', $_LANG['02_promotion']);
    $smarty->assign('ur_here', $_LANG['03_seckill_list']);
    set_default_filter();
    assign_query_info();
