...
function get_account_tab_menu()
{
            ...
            if ($_REQUEST['act_type'] == 'topup' || $_REQUEST['act_type'] == 'topup_pay') {
                ...
                if ($_REQUEST['act_type'] == 'detail') {
                    ...
                    if ($_REQUEST['act_type'] == 'account_log') {
                        ...
                        if ($_REQUEST['act_type'] == 'frozen_money') {
                            $frozen_money_curr = 1;
                        } else {
                            if ($_REQUEST['act_type'] == 'account_log_list') {
    ...
    $tab_menu[] = array(
        'curr' => $account_curr,
        'text' => $_LANG['01_seller_account'],
        'href' => 'merchants_account.php?act=account_manage&act_type=account'
    );
    $tab_menu[] = array(
        'curr' => $deposit_curr,
        'text' => $_LANG['02_seller_deposit'],
        'href' => 'merchants_account.php?act=account_manage&act_type=deposit'
    );
    $tab_menu[] = array(
        'curr' => $topup_curr,
        'text' => $_LANG['03_top_up'],
        'href' => 'merchants_account.php?act=account_manage&act_type=topup'
    );
    $tab_menu[] = array(
        'curr' => $detail_curr,
        'text' => $_LANG['04_seller_detail'],
        'href' => 'merchants_account.php?act=account_manage&act_type=detail'
    );
    $tab_menu[] = array(
        'curr' => $account_log_curr,
        'text' => $_LANG['05_seller_account_log'],
        'href' => 'merchants_account.php?act=account_manage&act_type=account_log'
    );
    $tab_menu[] = array(
        'curr' => $frozen_money_curr,
        'text' => $_LANG['title_frozen_money'],
        'href' => 'merchants_account.php?act=account_manage&act_type=frozen_money'
    );
    $tab_menu[] = array(
        'curr' => $account_log_list_curr,
        'text' => $_LANG['fund_details'],
        'href' => 'merchants_account.php?act=account_manage&act_type=account_log_list'
    );
    return $tab_menu;
}
                ...
                if ($_REQUEST['act_type'] == 'detail') {
                    ...
                    if ($_REQUEST['act_type'] == 'account_log') {
                        ...
                        if ($_REQUEST['act_type'] == 'frozen_money') {
                            ...
                            if ($_REQUEST['act_type'] == 'topup_pay') {
                                $smarty->assign('ur_here', $_LANG['03_top_up']);
        ...
        if ($_REQUEST['act'] == 'query') {
            ...
            if ($_REQUEST['act'] == 'account_edit') {
                ...
                if ($is_insert == 'insert') {
                    ...
                    $db->autoExecute($ecs->table('users_real'), $other, 'UPDTAE',
                        'user_id = \'' . $adminru['ru_id'] . '\' AND user_type = 1');
                }

                sys_msg($is_insert ? $_LANG['add_account_ok'] : $_LANG['edit_account_ok'], 0, $link);
            } else {
                if ($_REQUEST['act'] == 'deposit_insert') {
                    ...
                    merchants_account_log($other['ru_id'], '-' . $other['amount'], $other['frozen_money'],
                        '【' . $_SESSION['seller_name'] . '】' . $_LANG['02_seller_deposit']);
                    $link[0] = array(
                        'href' => 'merchants_account.php?act=account_manage&act_type=account_log',
                        'text' => $_LANG['05_seller_account_log']
                    );
                    ...
                    if ($_REQUEST['act'] == 'unfreeze') {
                        ...
                        merchants_account_log($other['ru_id'], 0, '-' . $other['frozen_money'],
                            '【' . $_SESSION['seller_name'] . '】' . $_LANG['apply_for_account']);
                        $link[0] = array(
                            'href' => 'merchants_account.php?act=account_manage&act_type=account_log',
                            'text' => $_LANG['05_seller_account_log']
                        );
                        ...
                        if ($_REQUEST['act'] == 'topup_insert') {
                            ...
                            if ($certificate_img['name']) {
                                $other['certificate_img'] = $image->upload_image('', 'seller_account', '', 1,
