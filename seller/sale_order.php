...
if (isset($_REQUEST['act']) && (($_REQUEST['act'] == 'query') || ($_REQUEST['act'] == 'download'))) {
    ...
    make_json_result($smarty->fetch('sale_order.dwt'), '',
        array('filter' => $goods_order_data['filter'], 'page_count' => $goods_order_data['page_count']));
} else {
    ...
    $smarty->assign('action_link',
        array('text' => $_LANG['download_sale_sort'], 'href' => '#download', 'class' => 'icon-download-alt'));
    assign_query_info();
