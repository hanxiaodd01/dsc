...
if ($_REQUEST['act'] == 'list') {
    ...
    $smarty->assign('action_link',
        array('text' => $_LANG['add_new'], 'href' => 'merchants_navigator.php?act=add', 'class' => 'icon-plus'));
    ...
    if ($_REQUEST['act'] == 'query') {
        ...
        $smarty->assign('current', 'merchants_navigator');
        make_json_result($smarty->fetch('store_navigation.dwt'), '',
        ...
        if ($_REQUEST['act'] == 'add') {
            ...
            if (empty($_REQUEST['step'])) {
                ...
                $smarty->assign('action_link', array(
                    'text' => $_LANG['go_list'],
                    'href' => 'merchants_navigator.php?act=list',
                    'class' => 'icon-reply'
                ));
                $smarty->assign('ur_here', $_LANG['navigator']);
                assign_query_info();
                ...
                if (empty($_REQUEST['step'])) {
                    ...
                    if ($_REQUEST['step'] == 2) {
                        ...
                        if ($arr) {
                            ...
                            if (($item_ifshow != is_show_in_nav($arr['type'],
                                        $arr['id'])) && ($item_type == 'middle')) {
