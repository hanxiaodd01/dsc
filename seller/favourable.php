...
if ($_REQUEST['act'] == 'list') {
    ...
    $smarty->assign('action_link',
        array('href' => 'favourable.php?act=add', 'text' => $_LANG['add_favourable'], 'class' => 'icon-plus'));
            ...
            if ($_REQUEST['act'] == 'batch') {
                ...
                if ($_REQUEST['act'] == 'edit_sort_order') {
                    ...
                    if ($_REQUEST['act'] == 'add' || $_REQUEST['act'] == 'edit') {
                        ...
                        $smarty->assign('action_link',
                            array('href' => $href, 'text' => $_LANG['favourable_list'], 'class' => 'icon-reply'));
                        assign_query_info();
                        ...
                        if ($_REQUEST['act'] == 'insert' || $_REQUEST['act'] == 'update') {
                            ...
                            if ($is_add) {
                                ...
                                $favourable_info = get_table_info('favourable_activity', 'act_id = \'' . $act_id . '\'',
                                    array('user_id', 'review_status'));
                            }
