...
if ($_REQUEST['act'] == 'list') {
    ...
    $action_link2 = $_REQUEST['act'] == 'list' ? array(
        'href' => 'goods_transport.php?act=list',
        'text' => $_LANG['goods_shipping_tpl'],
        'class' => 'icon-edit'
    ) : '';
    ...
    if ($_REQUEST['act'] == 'date_list') {
        ...
        $smarty->assign('action_link',
            array('href' => 'shipping.php?act=date_add', 'text' => $_LANG['add_delivery_time']));
        ...
        if ($_REQUEST['act'] == 'date_add') {
            ...
            $smarty->assign('action_link',
                array('href' => 'shipping.php?act=date_list', 'text' => $_LANG['delivery_time_list']));
