...
if ($_REQUEST['act'] == 'first') {
    ...
    if ($_REQUEST['act'] == 'header_bg') {
        ...
        if ($_REQUEST['act'] == 'file_put_visual') {
                ...
                if ($_REQUEST['act'] == 'purchase_temp') {
                    ...
                    if (0 < $pay_id) {
                        if (0 < $temp_id) {
                            ...
                            if (0 < $apply_id) {
                                ...
                                $apply_info['log_id'] = insert_pay_log($apply_id, $apply_info['order_amount'],
                                    $type = PAY_APPLYTEMP, 0);
                            }
                    ...
                    if ($_REQUEST['act'] == 'temp_pay') {
                        ...
                        $smarty->assign('menu_select',
                            array('action' => '19_merchants_store', 'current' => '10_visual_editing'));
                        $smarty->assign('primary_cat', $_LANG['10_visual_editing']);
                        $smarty->assign('ur_here', $_LANG['tpl_pay']);
                        $smarty->assign('action_link',
                            array('text' => $_LANG['tpl_list'], 'href' => 'visual_editing.php?act=templates'));
                        ...
                        if ($payment_info['pay_code'] == 'balance') {
                            ...
                            if ($apply_info['order_amount'] < $user_money) {
                                ...
                                $db->query($sql);
                                log_account_change($adminru['ru_id'], $apply_info['order_amount'] * -1, 0, 0, 0,
                                    $_LANG['record_id'] . $apply_info['order_sn'] . $_LANG['seller_buy_visual_tpl_pay']);
                                $new_suffix = get_new_dirName($adminru['ru_id']);
                                ...
                                if (0 < $old_apply_id) {
                                    $link[] = array(
                                        'text' => $_LANG['go_back'],
                                        'href' => 'visual_editing.php?act=template_apply_list'
                                    );
                                } else {
                                    $link[] = array(
                                        'text' => $_LANG['go_back'],
                                        'href' => 'visual_editing.php?act=templates'
                                    );
                                }
                        ...
                        if ($_REQUEST['act'] == 'checkorder') {
                            ...
                            if ($_REQUEST['act'] == 'template_apply_list') {
                                ...
                                $tab_menu[] = array(
                                    'curr' => '',
                                    'text' => $_LANG['temp_operation'],
                                    'href' => 'visual_editing.php?act=templates'
                                );
                                $tab_menu[] = array(
                                    'curr' => 1,
                                    'text' => $_LANG['temp_paylist'],
                                    'href' => 'visual_editing.php?act=template_apply_list'
                                );
                                ...
                                if ($_REQUEST['act'] == 'apply_query') {
                                    ...
                                    $smarty->assign('record_count', $template_mall_list['record_count']);
                                    $smarty->assign('page_count', $template_mall_list['page_count']);
                                    make_json_result($smarty->fetch('template_apply_list.dwt'), '', array(
                                        'filter' => $template_mall_list['filter'],
                                        'page_count' => $template_mall_list['page_count']
                                    ));
                                } else {
                                    if ($_REQUEST['act'] == 'templates') {
                                        ...
                                        $smarty->assign('curr_template',
                                            get_seller_template_info($tem, $adminru['ru_id']));
                                        ...
                                        if ($_REQUEST['act'] == 'query') {
                                            ...
                                            make_json_result($smarty->fetch('templates.dwt'), '', array(
                                                'filter' => $template_mall_list['filter'],
                                                'page_count' => $template_mall_list['page_count']
                                            ));
                                        } else {
                                            if ($_REQUEST['act'] == 'generate') {
                                                ...
                                                if ($_REQUEST['act'] == 'remove_img') {
                                                    ...
                                                    if ($_REQUEST['act'] == 'edit_information') {
                                                        include_once ROOT_PATH . '/includes/cls_image.php';
                                                        $image = new cls_image($_CFG['bgcolor']);
                                                        $id = $adminru['ru_id'];
                                                        ...
                                                        if (isset($_FILES['ten_file']['error']) && $_FILES['ten_file']['error'] == 0 || !isset($_FILES['ten_file']['error']) && isset($_FILES['ten_file']['tmp_name']) && $_FILES['ten_file']['tmp_name'] != 'none') {
                                                            if (!check_file_type($_FILES['ten_file']['tmp_name'],
                                                                $_FILES['ten_file']['name'], $allow_file_types)) {
                                                            ...
                                                            $goods_thumb = $image->make_thumb($_FILES['ten_file']['tmp_name'],
                                                                265, 388, $file_name, '', $filename);
                                                        ...
                                                        if (isset($_FILES['big_file']['error']) && $_FILES['big_file']['error'] == 0 || !isset($_FILES['big_file']['error']) && isset($_FILES['big_file']['tmp_name']) && $_FILES['big_file']['tmp_name'] != 'none') {
                                                            if (!check_file_type($_FILES['big_file']['tmp_name'],
                                                                $_FILES['big_file']['name'], $allow_file_types)) {
                                                                sys_msg($_LANG['img_format_wrong']);
                                                            }
                                                            ...
                                                            if (move_upload_file($_FILES['big_file']['tmp_name'],
                                                                $file_name)) {
                                                                $big_file = $file_name;
                                                            }
                                                        }
                                                        ...
                                                        $html = write_static_file_cache('tpl_info',
                                                            iconv('UTF-8', 'GB2312', $html), 'txt', $file_dir . '/');

                                                        if ($html === false) {
                                                            $link[0]['text'] = $_LANG['back_list'];
                                                            $link[0]['href'] = 'visual_editing.php?act=templates';
                                                            sys_msg('\' . ' . $file_dir . ' . \'/tpl_info.txt' . $_LANG['no_write_power_edit'],
                                                                1, $link);
                                                        } else {
                                                            $link[0]['text'] = $_LANG['back_list'];
                                                            $link[0]['href'] = 'visual_editing.php?act=templates';
                                                        ...
                                                        if ($_REQUEST['act'] == 'removeTemplate') {
                                                            require ROOT_PATH . '/includes/cls_json.php';
                                                            $json = new JSON();
                                                            $result = array(
                                                                'error' => '',
                                                            ...
                                                            if ($default_tem == $code) {
                                                                ...
                                                                if ($rmdir == true) {
                                                                    ...
                                                                    $available_templates = get_array_sort($available_templates,
                                                                        'sort');
                                                                    @closedir($template_dir);
                                                                    $smarty->assign('available_templates',
                                                                        $available_templates);
                                                                    $sql = 'SELECT seller_templates FROM' . $GLOBALS['ecs']->table('seller_shopinfo') . ' WHERE ru_id=' . $adminru['ru_id'];
                                                                    $tem = $GLOBALS['db']->getOne($sql);
                                                                    $smarty->assign('default_tem', $tem);
                                                            ...
                                                            if ($_REQUEST['act'] == 'defaultTemplate') {
                                                                $code = isset($_REQUEST['code']) ? addslashes($_REQUEST['code']) : '';
                                                                ...
                                                                if ($_REQUEST['act'] == 'backupTemplates') {
                                                                    require ROOT_PATH . '/includes/cls_json.php';
                                                                    include_once ROOT_PATH . '/includes/cls_image.php';
                                                                    $json = new JSON();
                                                                    $image = new cls_image($_CFG['bgcolor']);
                                                                    ...
                                                                    if ($code) {
                                                                        ...
                                                                        $tab = "\n";
                                                                        $html = $end . $tab . $name . $tab . 'tpl url：' . $file_url . $tab . $description . $tab . $version . $tab . $author . $tab . $author_url . $tab . $end;
                                                                        write_static_file_cache('tpl_info',
                                                                            iconv('UTF-8', 'GB2312', $html), 'txt',
                                                                            $file_dir . '/');
                                                                        $seller_dir = ROOT_PATH . 'data/seller_templates/seller_tem_' . $adminru['ru_id'] . '/';
                                                                        $template_dir = @opendir($seller_dir);
                                                                        ...
                                                                        if (!empty($checkboxes)) {
                                                                            ...
                                                                            foreach ($checkboxes as $v) {
                                                                                if ($v) {
                                                                                    ...
                                                                                    $file_mune = array_merge($file_mune,
                                                                                        $addfiletozip);
                                                                                }
                                                                            }
                                                                            ...
                                                                            foreach ($file_mune as $v) {
                                                                                if (file_exists($dir . '/' . $v)) {
                                                                                    $zip->add_file(file_get_contents($dir . '/' . $v),
                                                                                        $v);
                                                                                }
                                                                            }
                                                                            ...
                                                                            $link[0]['text'] = $_LANG['back_list'];
                                                                            $link[0]['href'] = 'visual_editing.php?act=templates';
                                                                            sys_msg($_LANG['please_select_export_tpl'],
                                                                                1, $link);
                                                                        }
                                                                    } else {
                                                                        if ($_REQUEST['act'] == 'downloadModal') {
                                                                            require ROOT_PATH . '/includes/cls_json.php';
                                                                            $json = new JSON();
                                                                            $result = array(
                                                                                'error' => '',
                                                                            ...
                                                                            if (!isset($GLOBALS['_CFG']['server_model'])) {
                                                                                ...
                                                                                $server_model = $GLOBALS['db']->getOne($sql,
                                                                                    true);
                                                                            } else {
                                                                            ...
                                                                            if ($is_oss && $server_model) {
                                                                                if ($topic_type == 'topic_type') {
                                                                                    ...
                                                                                    $file_list = get_recursive_file_oss($dir,
                                                                                        $path, true);
                                                                                    ...
                                                                                    if ($pin_region_list !== false) {
                                                                                        del_visual_templates($id_data,
                                                                                            $code, 'del_topictemplates',
                                                                                            $adminru['ru_id']);
                                                                                    }
                                                                                } else {
                                                                                    $dir = ROOT_PATH . 'data/seller_templates/seller_tem_' . $adminru['ru_id'] . '/' . $code . '/';
                                                                            ...
                                                                            if ($_REQUEST['act'] == 'backmodal') {
                                                                                ...
                                                                                if ($_REQUEST['act'] == 'remove') {
                                                                                    ...
                                                                                    $db->query($sql);
                                                                                    $url = 'visual_editing.php?act=apply_query&' . str_replace('act=remove',
                                                                                            '',
