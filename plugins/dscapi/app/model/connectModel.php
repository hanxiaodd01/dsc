...
abstract class connectModel extends \app\func\common
{
    ...
    public function get_insert($table, $select, $format)
    {
        ...
        $common_data = array(
            'result' => 'success',
            'msg' => $connectLang['msg_success']['success'],
            'error' => $connectLang['msg_success']['error'],
            'format' => $format,
            'info' => $info
        );
    ...
    public function get_delete($table, $where, $format)
    {
        ...
        $common_data = array(
            ...
            'msg' => $return ? $connectLang['msg_success']['success'] : $connectLang['msg_failure'][$error]['failure'],
            'error' => $return ? $connectLang['msg_success']['error'] : $connectLang['msg_failure'][$error]['error'],
            'format' => $format
        );
        \app\func\common::common($common_data);
        return \app\func\common::data_back();
    ...
    public function get_list_common_data($result, $page_size, $page, $connectLang, $format)
    {
        $common_data = array(
            ...
            'msg' => empty($result) ? $connectLang['msg_failure']['failure'] : $connectLang['msg_success']['success'],
            'error' => empty($result) ? $connectLang['msg_failure']['error'] : $connectLang['msg_success']['error'],
            'format' => $format
        );
        \app\func\common::common($common_data);
    ...
    public function get_info_common_data_f($connectLang, $format)
    {
        ...
        $common_data = array(
            'result' => 'failure',
            'msg' => $connectLang['where_failure']['failure'],
            'error' => $connectLang['where_failure']['error'],
            'format' => $format
        );
        \app\func\common::common($common_data);
        $result = \app\func\common::data_back($result);
