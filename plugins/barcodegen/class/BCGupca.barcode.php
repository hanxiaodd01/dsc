...
class BCGupca extends BCGean13
{
    ...
    protected function addDefaultLabel()
    {
        if ($this->isDefaultEanLabelEnabled()) {
            ...
            $this->labelCenter1 = new BCGLabel(substr($label, 1, 5), $font, BCGLabel::POSITION_BOTTOM,
                BCGLabel::ALIGN_LEFT);
            ...
            $this->labelCenter2 = new BCGLabel(substr($label, 6, 5), $font, BCGLabel::POSITION_BOTTOM,
                BCGLabel::ALIGN_LEFT);
