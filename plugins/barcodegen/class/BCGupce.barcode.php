...
class BCGupce extends BCGBarcode1D
{
    ...
    public function draw($im)
    {
        ...
        for ($i = 0; $i < $c; $i++) {
            $this->drawChar($im, self::inverse($this->findCode($this->upce[$i]),
                $this->codeParity[intval($this->text[0])][$this->checksumValue][$i]), false);
        }
    ...
    protected function addDefaultLabel()
    {
        if ($this->isDefaultEanLabelEnabled()) {
            ...
            $font = $this->font;
            $this->labelLeft = new BCGLabel(substr($this->text, 0, 1), $font, BCGLabel::POSITION_LEFT,
            ...
            $this->labelRight = new BCGLabel($this->keys[$this->checksumValue], $font, BCGLabel::POSITION_RIGHT,
                BCGLabel::ALIGN_BOTTOM);
