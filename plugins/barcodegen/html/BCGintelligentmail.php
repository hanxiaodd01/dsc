...
echo getInputTextHtml('barcodeIdentifier', $barcodeIdentifier,
    array('type' => 'text', 'maxlength' => 2, 'required' => 'required'));
...
echo getInputTextHtml('mailerIdentifier', $mailerIdentifier,
    array('type' => 'text', 'maxlength' => 9, 'required' => 'required'));
echo "        </div>\r\n    </li>\r\n    <li class=\"option\">\r\n        <div class=\"title\">\r\n            <label for=\"serialNumber\">Serial Number</label>\r\n        </div>\r\n        <div class=\"value\">\r\n            ";
echo getInputTextHtml('serialNumber', $serialNumber,
    array('type' => 'text', 'maxlength' => 9, 'required' => 'required'));
