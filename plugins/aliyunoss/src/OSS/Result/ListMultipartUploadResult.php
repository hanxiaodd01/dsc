...
class ListMultipartUploadResult extends Result
{
    protected function parseDataFromResponse()
    {
        ...
        return new \OSS\Model\ListMultipartUploadInfo($bucket, $keyMarker, $uploadIdMarker, $nextKeyMarker,
            $nextUploadIdMarker, $delimiter, $prefix, $maxUploads, $isTruncated, $listUpload);
    }
}
