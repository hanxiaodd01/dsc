...
?>
                                ...
                                <div class="imitate_select w90">
                                    ...
                                    <ul>
                                        <?php $_from = $this->_var['select_date']['day']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'data_0_18449300_1553581984');if (count($_from)):
    foreach ($_from AS $this->_var['data_0_18449300_1553581984']):
?>
                                        <li><a href="javascript:void(0);" data-value="<?php echo $this->_var['data_0_18449300_1553581984']; ?>"><?php echo $this->_var['data_0_18449300_1553581984']; ?></a></li>
                                        <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
                                    </ul>
                            ...
                            <div class="value">
                                <div class="imitate_select w200">
                                    ...
                                    <ul>
                                        ...
                                        <?php $_from = $this->_var['passwd_questions']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'data_0_18449300_1553581984');if (count($_from)):
    foreach ($_from AS $this->_var['data_0_18449300_1553581984']):
?>
                                        <li><a href="javascript:void(0);" data-value="<?php echo $this->_var['data_0_18449300_1553581984']; ?>"><?php echo $this->_var['data_0_18449300_1553581984']; ?></a></li>
                                        <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
...
?>
                            ...
                            <dl class="mod-select mod-select-small fl" ectype="smartdropdown">
                                ...
                                <dd ectype="layer">
                                    ...
                                    <?php $_from = $this->_var['province_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'province_0_19749400_1553581984');if (count($_from)):
    foreach ($_from AS $this->_var['province_0_19749400_1553581984']):
?>
                                    <div class="option" data-value="<?php echo $this->_var['province_0_19749400_1553581984']['region_id']; ?>" data-text="<?php echo $this->_var['province_0_19749400_1553581984']['region_name']; ?>" data-type="2" ectype="ragionItem"><?php echo $this->_var['province_0_19749400_1553581984']['region_name']; ?></div>
                                    <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
                                </dd>
                            </dl>
                            <dl class="mod-select mod-select-small fl" ectype="smartdropdown">
                            ...
                            <div class="lists" ectype="return_lists">
                                ...
                                <div class="return_div" ectype="return_div" style="display:none;">
                                    <div class="type_box1" name="type_box1" id="returnid_<?php echo $this->_var['goods_return']['rec_id']; ?>">
                                        ...
                                        <div class="type_con">
                                            <a onclick="buyNumber.minus(this, 1)" href="javascript:;" id="decrease" class="plus_minus"><i class="iconfont icon-reduce"></i></a>
                                            <input type="text" class="return_num" defaultnumber="1" value="1" id="returnid_<?php echo $this->_var['goods_return']['rec_id']; ?>" name="attr_num" onblur="check_return_num(this,<?php echo $this->_var['goods_return']['goods_number']; ?> ,<?php echo $this->_var['goods_return']['rec_id']; ?>, 2)" />
                                            <a onclick="buyNumber.plus(this, 1)" href="javascript:;" id="increase" class="plus_minus"><i class="iconfont icon-plus"></i></a>
                                ...
                                <div class="return_div" ectype="return_div" style="display:none;">
                                    <div class="type_box1" name="type_box1" id="changeid_<?php echo $this->_var['goods_return']['rec_id']; ?>">
                                        <div class="type_item"><?php echo $this->_var['lang']['return_g_number']; ?>：</div>
                                        <div class="type_con">
                                            <a onclick="buyNumber.minus(this, 1)" href="javascript:;" id="decrease" class="plus_minus"><i class="iconfont icon-reduce"></i></a>
                                            <input type="text" class="return_num" defaultnumber="1" value="1" id="returnid_<?php echo $this->_var['goods_return']['rec_id']; ?>" name="only_return_number" onblur="check_return_num(this,<?php echo $this->_var['goods_return']['goods_number']; ?> ,<?php echo $this->_var['goods_return']['rec_id']; ?>, 2)" />
                                            <a onclick="buyNumber.plus(this, 1)" href="javascript:;" id="increase" class="plus_minus"><i class="iconfont icon-plus"></i></a>
                                            <div class="return_sm">(<?php echo $this->_var['lang']['return_one']; ?><span><?php echo $this->_var['goods_return']['goods_number']; ?></span><?php echo $this->_var['lang']['return_two']; ?><span id="retired_<?php echo $this->_var['goods_return']['rec_id']; ?>" name="retired">1</span><?php echo $this->_var['lang']['jian']; ?>)</div>
                                        </div>
                                    </div>
...
?>
                                        ...
                                        <dl class="mod-select mod-select-small" ectype="smartdropdown">
                                            ...
                                            <dd ectype="layer">
                                                <div class="option" data-value="0"><?php echo $this->_var['lang']['please_select']; ?><?php echo $this->_var['name_of_region']['1']; ?></div>
                                                <?php $_from = $this->_var['province_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'province_0_19949400_1553581984');if (count($_from)):
    foreach ($_from AS $this->_var['province_0_19949400_1553581984']):
?>
                                                <div class="option" data-value="<?php echo $this->_var['province_0_19949400_1553581984']['region_id']; ?>" data-text="<?php echo $this->_var['province_0_19949400_1553581984']['region_name']; ?>" data-type="2" ectype="ragionItem"><?php echo $this->_var['province_0_19949400_1553581984']['region_name']; ?></div>
                                                <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
                                            </dd>
                                        </dl>
                                        <dl class="mod-select mod-select-small" ectype="smartdropdown">
...
?>
								...
								<dl class="mod-select mod-select-small" ectype="smartdropdown">
									...
									<dd ectype="layer">
										<div class="option" data-value="0"><?php echo $this->_var['lang']['please_select']; ?><?php echo $this->_var['name_of_region']['1']; ?></div>
										<?php $_from = $this->_var['province_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'province_0_20049400_1553581984');if (count($_from)):
    foreach ($_from AS $this->_var['province_0_20049400_1553581984']):
?>
										<div class="option" data-value="<?php echo $this->_var['province_0_20049400_1553581984']['region_id']; ?>" data-text="<?php echo $this->_var['province_0_20049400_1553581984']['region_name']; ?>" data-type="2" ectype="ragionItem"><?php echo $this->_var['province_0_20049400_1553581984']['region_name']; ?></div>
										<?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
									</dd>
								</dl>
								<dl class="mod-select mod-select-small" ectype="smartdropdown">
...
?>
                        <div class="coupons-item <?php if ($this->_foreach['cou']['iteration'] % 2 == 0): ?>coupons-item-double<?php endif; ?>" >
                            <div class="c-type">
                                ...
                                <div class="c-t-cont">
                                    <div class="c-t-c-top">
                                        <?php if ($this->_var['vo']['cou_type'] != 5): ?><strong><em>￥</em><?php if ($this->_var['vo']['order_sn'] != ''): ?><?php echo $this->_var['vo']['order_coupons']; ?><?php else: ?><?php if ($this->_var['vo']['uc_money'] != 0): ?><?php echo $this->_var['vo']['uc_money']; ?><?php else: ?><?php echo $this->_var['vo']['cou_money']; ?><?php endif; ?><?php endif; ?></strong><?php else: ?><i class="icon-my"></i><?php endif; ?>
...
?>
                                ...
                                <dl class="mod-select mod-select-small fl" ectype="smartdropdown">
                                    ...
                                    <dd ectype="layer">
                                        <div class="option" data-value="0"><?php echo $this->_var['lang']['please_select']; ?><?php echo $this->_var['name_of_region']['1']; ?></div>
                                        <?php $_from = $this->_var['province_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'province_0_21349500_1553581984');if (count($_from)):
    foreach ($_from AS $this->_var['province_0_21349500_1553581984']):
?>
                                        <div class="option" data-value="<?php echo $this->_var['province_0_21349500_1553581984']['region_id']; ?>" data-text="<?php echo $this->_var['province_0_21349500_1553581984']['region_name']; ?>" data-type="2" ectype="ragionItem"><?php echo $this->_var['province_0_21349500_1553581984']['region_name']; ?></div>
                                        <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
                                    </dd>
                                </dl>
                                <dl class="mod-select mod-select-small fl" ectype="smartdropdown">
...
?>
                                ...
                                <dl class="mod-select mod-select-small" ectype="smartdropdown">
                                    ...
                                    <dd ectype="layer">
                                        <div class="option" data-value="0"><?php echo $this->_var['lang']['please_select']; ?><?php echo $this->_var['name_of_region']['1']; ?></div>
                                        <?php $_from = $this->_var['province_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'province_0_21449500_1553581984');if (count($_from)):
    foreach ($_from AS $this->_var['province_0_21449500_1553581984']):
?>
                                        <div class="option" data-value="<?php echo $this->_var['province_0_21449500_1553581984']['region_id']; ?>" data-text="<?php echo $this->_var['province_0_21449500_1553581984']['region_name']; ?>" data-type="2" ectype="ragionItem"><?php echo $this->_var['province_0_21449500_1553581984']['region_name']; ?></div>
                                        <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
                                    </dd>
                                </dl>
                                <dl class="mod-select mod-select-small" ectype="smartdropdown">
...
?>
                                        ...
                                        <dl class="mod-select mod-select-small" ectype="smartdropdown">
                                            ...
                                            <dd ectype="layer">
                                                <div class="option" data-value="0"><?php echo $this->_var['lang']['please_select']; ?><?php echo $this->_var['name_of_region']['1']; ?></div>
                                                <?php $_from = $this->_var['province_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'province_0_21749500_1553581984');if (count($_from)):
    foreach ($_from AS $this->_var['province_0_21749500_1553581984']):
?>
                                                <div class="option" data-value="<?php echo $this->_var['province_0_21749500_1553581984']['region_id']; ?>" data-text="<?php echo $this->_var['province_0_21749500_1553581984']['region_name']; ?>" data-type="2" ectype="ragionItem"><?php echo $this->_var['province_0_21749500_1553581984']['region_name']; ?></div>
                                                <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
                                            </dd>
                                        </dl>
                                        <dl class="mod-select mod-select-small" ectype="smartdropdown">
