...
if (empty($keyword)) {
    ...
    while ($row = $db->FetchRow($result)) {
        ...
        $keyword_style = preg_replace('/(' . $keyword . ')/i',
            '<font style=\'font-weight:normal;color:#ec5151;\'>$1</font>', $row['keyword']);
    ...
    if ($res_num < 10) {
        ...
        for ($i = 0; $i < $len; $i++) {
            ...
            $keyword_style = preg_replace('/(' . $keyword . ')/i',
                '<font style=\'font-weight:normal;color:#ec5151;\'>$1</font>', $keyword_new_name);
